// ============================================================================
// E2E INGEST WRITEPAYLOAD - RunId: e2e-20260619T010852Z-ecb425m
// ============================================================================

MERGE (n:Paragraph {name: '000-0000-INICIO', programName: 'ECB425M'})
SET n += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [140], executionOrder: 600, executionPhase: 'PROCESSING', ingestion: 'auto', layer: 'execution', name: '000-0000-INICIO', nodeType: 'process-step', programName: 'ECB425M', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m', sourceFile: 'src/ECB425M.cbl', summary: 'Inicializa el flujo operativo de ECB425M, preparando contexto y validaciones de arranque.', viewTag: 'execution'};
...
SET n += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [153], executionOrder: 800, executionPhase: 'PROCESSING', ingestion: 'auto', layer: 'execution', name: '110-ABRE-ARCHIVOS', nodeType: 'process-step', programName: 'ECB425M', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m', sourceFile: 'src/ECB425M.cbl', summary: 'Orquesta una fase funcional de ECB425M, encadenando validaciones y transformaciones del proceso principal.', viewTag: 'execution'};
...
SET n += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [205], executionOrder: 1500, executionPhase: 'PROCESSING', ingestion: 'auto', layer: 'execution', name: '300-TERMINA', nodeType: 'process-step', programName: 'ECB425M', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m', sourceFile: 'src/ECB425M.cbl', summary: 'Cierra la ejecucion de ECB425M, consolidando trazas y terminacion funcional del proceso.', viewTag: 'execution'};
...
SET n += {ingestion: 'auto', layer: 'program', name: 'ECB425M', nodeType: 'program', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m', sourceFile: 'src/ECB425M.cbl', viewTag: 'program'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '000-0000-INICIO', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [140], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '100-INICIO', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [147], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '110-ABRE-ARCHIVOS', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [153], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '200-PROCESO-ACUSE', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [161], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '250-CARGA-ARREGLO', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [184], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '250-LEE-ARCHIVO-CTAHOJA', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [176], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '255-LEE-REPO-R3-ACUSE', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [190], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '260-ESCRIBE-ACUSE6', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [197], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '265-ESCRIBE-ACUSE7', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [201], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '300-TERMINA', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [205], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: '990-CIF-CTL', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [213], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: 'CONFIGURATION', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [22], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: 'FILE', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [43], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: 'FILE-CONTROL', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [27], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: 'INPUT-OUTPUT', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [26], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};

MATCH (a:Program {name: 'ECB425M'}), (b:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB425M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB425M.cbl', evidenceLines: [97], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010852Z-ecb425m'};
