// ============================================================================
// E2E INGEST WRITEPAYLOAD - RunId: e2e-20260619T004838Z-ecb439m
// ============================================================================

MERGE (n:Copybook {name: 'DSVCTOCB'})
SET n += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [138], ingestion: 'auto', layer: 'dependency', name: 'DSVCTOCB', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m', sourceFile: 'src/ECB439M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SI2CM026'})
SET n += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [250], ingestion: 'auto', layer: 'dependency', name: 'SI2CM026', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m', sourceFile: 'src/ECB439M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SI2FH027'})
SET n += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [131], ingestion: 'auto', layer: 'dependency', name: 'SI2FH027', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m', sourceFile: 'src/ECB439M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SIC005'})
SET n += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [121], ingestion: 'auto', layer: 'dependency', name: 'SIC005', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m', sourceFile: 'src/ECB439M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SQLCA'})
SET n += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [125], ingestion: 'auto', layer: 'dependency', name: 'SQLCA', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m', sourceFile: 'src/ECB439M.cbl', viewTag: 'dependency'};

MERGE (n:DBTable {name: 'SVCTOCB'})
SET n += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [204, 205, 206, 207, 208, 209], ingestion: 'auto', layer: 'data-access', name: 'SVCTOCB', nodeType: 'physical-table', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m', sourceFile: 'src/ECB439M.cbl', viewTag: 'data-access'};

MERGE (n:Paragraph {name: '000-0100-INICIO', programName: 'ECB439M'})
SET n += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [145], executionOrder: 1600, executionPhase: 'PROCESSING', ingestion: 'auto', layer: 'execution', name: '000-0100-INICIO', nodeType: 'process-step', programName: 'ECB439M', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m', sourceFile: 'src/ECB439M.cbl', summary: 'Inicializa el flujo operativo de ECB439M, preparando contexto y validaciones de arranque.', viewTag: 'execution'};

MERGE (n:Paragraph {name: '000-0200-PROCESO', programName: 'ECB439M'})
SET n += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [155], executionOrder: 1700, executionPhase: 'PROCESSING', ingestion: 'auto', layer: 'execution', name: '000-0200-PROCESO', nodeType: 'process-step', programName: 'ECB439M', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m', sourceFile: 'src/ECB439M.cbl', summary: 'Orquesta una fase funcional de ECB439M, encadenando validaciones y transformaciones del proceso principal.', viewTag: 'execution'};

MERGE (n:Paragraph {name: '000-0300-TERMINA', programName: 'ECB439M'})
SET n += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [159], executionOrder: 1800, executionPhase: 'PROCESSING', ingestion: 'auto', layer: 'execution', name: '000-0300-TERMINA', nodeType: 'process-step', programName: 'ECB439M', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m', sourceFile: 'src/ECB439M.cbl', summary: 'Cierra la ejecucion de ECB439M, consolidando trazas y terminacion funcional del proceso.', viewTag: 'execution'};
...
SET n += {ingestion: 'auto', layer: 'program', name: 'ECB439M', nodeType: 'program', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m', sourceFile: 'src/ECB439M.cbl', viewTag: 'program'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '000-0100-INICIO', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [145], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '000-0200-PROCESO', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [155], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '000-0300-TERMINA', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [159], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '000-9900-FIN', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [166], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '000-CONTROL', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [144], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '035-LEE-CUENTAS', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [172], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '035-LEE-CUENTAS-FIN', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [197], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '040-LEE-SVCTOCB-IPOSP', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [203], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '040-LEE-SVCTOCB-IPOSP-FIN', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [220], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '980-0100-INICIO', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [228], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '980-9900-FIN', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [232], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '980-ABORTA', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [227], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '990-0100-INICIO', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [236], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '990-9900-FIN', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [244], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: '990-CIF-CTL', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [235], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'AUTHOR', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [4], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'CONFIGURATION', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [16], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'DATE-WRITTEN', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [8], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'ECB439M', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [3], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'FILE', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [35], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'FILE-CONTROL', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [23], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'IBM-9121', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [20], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'INPUT-OUTPUT', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [22], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'INSTALLATION', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [6], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'OBJECT-COMPUTER', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [19], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'PROGRAM-ID', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [2], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'SOURCE-COMPUTER', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [17], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Program {name: 'ECB439M'}), (b:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB439M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [90], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Paragraph {name: '990-9900-FIN', programName: 'ECB439M'}), (b:Copybook {name: 'SI2CM026'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [250], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB439M'}), (b:Copybook {name: 'DSVCTOCB'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [138], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB439M'}), (b:Copybook {name: 'SI2FH027'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [131], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB439M'}), (b:Copybook {name: 'SIC005'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [121], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};

MATCH (a:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB439M'}), (b:Copybook {name: 'SQLCA'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [125], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};
...
SET r += {evidenceFile: 'src/ECB439M.cbl', evidenceLines: [204, 205, 206, 207, 208, 209], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004838Z-ecb439m'};
