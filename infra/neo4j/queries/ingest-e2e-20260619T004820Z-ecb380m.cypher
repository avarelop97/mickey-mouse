// ============================================================================
// E2E INGEST WRITEPAYLOAD - RunId: e2e-20260619T004820Z-ecb380m
// ============================================================================

MERGE (n:Copybook {name: 'DAGPOCTA'})
SET n += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [169], ingestion: 'auto', layer: 'dependency', name: 'DAGPOCTA', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'DEDDESOP'})
SET n += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [163], ingestion: 'auto', layer: 'dependency', name: 'DEDDESOP', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'DEDMOVED'})
SET n += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [157], ingestion: 'auto', layer: 'dependency', name: 'DEDMOVED', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'DPARAM'})
SET n += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [151], ingestion: 'auto', layer: 'dependency', name: 'DPARAM', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SICCM026'})
SET n += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [455], ingestion: 'auto', layer: 'dependency', name: 'SICCM026', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SICFH027'})
SET n += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [138], ingestion: 'auto', layer: 'dependency', name: 'SICFH027', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SQLCA'})
SET n += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [145], ingestion: 'auto', layer: 'dependency', name: 'SQLCA', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', viewTag: 'dependency'};

MERGE (n:DBTable {name: 'EDMOVED'})
SET n += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [219, 220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 235], ingestion: 'auto', layer: 'data-access', name: 'EDMOVED', nodeType: 'physical-table', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', viewTag: 'data-access'};

MERGE (n:DBTable {name: 'PARAM'})
SET n += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [248, 249, 250, 251, 252, 253], ingestion: 'auto', layer: 'data-access', name: 'PARAM', nodeType: 'physical-table', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', viewTag: 'data-access'};

MERGE (n:Paragraph {name: '000-RUTINA-PRINCIPAL', programName: 'ECB380M'})
SET n += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [176], executionOrder: 700, executionPhase: 'PROCESSING', ingestion: 'auto', layer: 'execution', name: '000-RUTINA-PRINCIPAL', nodeType: 'process-step', programName: 'ECB380M', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', summary: 'Orquesta una fase funcional de ECB380M, encadenando validaciones y transformaciones del proceso principal.', viewTag: 'execution'};
...
SET n += {ingestion: 'auto', layer: 'program', name: 'ECB380M', nodeType: 'program', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m', sourceFile: 'src/ECB380M.cbl', viewTag: 'program'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '000-RUTINA-PRINCIPAL', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [176], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '010-INICIO', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [199], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '100-ABRE-ARCHIVOS', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [212], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '110-DECLARA-CURSOR-EDMOVED', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [218], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '120-DECLARA-CURSOR-PARAM', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [247], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '130-ABRE-CURSOR-PARAM', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [265], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '140-PROCESA-REGISTROS-PARAM', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [281], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '150-CIERRA-CURSOR-PARAM', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [298], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '160-ABRE-CURSOR-EDMOVED', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [312], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '170-PROCESA-REGISTROS-EDMOVED', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [328], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '175-REGISTROS-EDMOVED', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [338], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '180-CIERRA-CURSOR-EDMOVED', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [369], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '190-CIERRA-ARCHIVOS', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [383], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '200-SORT-ARCHIVOS', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [389], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '500-LEE-CURSOR-PARAM', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [399], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: '510-LEE-CURSOR-EDMOVED', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [421], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: 'COMP-3', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [103], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: 'CONFIGURATION', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [30], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: 'FILE', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [39], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: 'FILE-CONTROL', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [34], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: 'INPUT-OUTPUT', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [33], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB380M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [83], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Paragraph {name: '010-INICIO', programName: 'ECB380M'}), (b:Copybook {name: 'SICCM026'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [200], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Paragraph {name: '510-LEE-CURSOR-EDMOVED', programName: 'ECB380M'}), (b:Copybook {name: 'SICCM026'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [455], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Paragraph {name: 'COMP-3', programName: 'ECB380M'}), (b:Copybook {name: 'DAGPOCTA'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [169], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Paragraph {name: 'COMP-3', programName: 'ECB380M'}), (b:Copybook {name: 'DEDDESOP'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [163], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Paragraph {name: 'COMP-3', programName: 'ECB380M'}), (b:Copybook {name: 'DEDMOVED'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [157], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Paragraph {name: 'COMP-3', programName: 'ECB380M'}), (b:Copybook {name: 'DPARAM'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [151], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Paragraph {name: 'COMP-3', programName: 'ECB380M'}), (b:Copybook {name: 'SICFH027'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [138], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Paragraph {name: 'COMP-3', programName: 'ECB380M'}), (b:Copybook {name: 'SQLCA'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [145], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};
...
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [219, 220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 235], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};

MATCH (a:Program {name: 'ECB380M'}), (b:DBTable {name: 'PARAM'})
MERGE (a)-[r:READS_TABLE]->(b)
SET r += {evidenceFile: 'src/ECB380M.cbl', evidenceLines: [248, 249, 250, 251, 252, 253], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T004820Z-ecb380m'};
