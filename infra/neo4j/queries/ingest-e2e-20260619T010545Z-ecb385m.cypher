// ============================================================================
// E2E INGEST WRITEPAYLOAD - RunId: e2e-20260619T010545Z-ecb385m
// ============================================================================

MERGE (n:Copybook {name: 'DPARAM'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [455], ingestion: 'auto', layer: 'dependency', name: 'DPARAM', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SI2CM026'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [953], ingestion: 'auto', layer: 'dependency', name: 'SI2CM026', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SI2FH027'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [235], ingestion: 'auto', layer: 'dependency', name: 'SI2FH027', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SIC004'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [948], ingestion: 'auto', layer: 'dependency', name: 'SIC004', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SIC005'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [242], ingestion: 'auto', layer: 'dependency', name: 'SIC005', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SICAM029'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [229], ingestion: 'auto', layer: 'dependency', name: 'SICAM029', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SIXAB001'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [239], ingestion: 'auto', layer: 'dependency', name: 'SIXAB001', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SIXAB002'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [934], ingestion: 'auto', layer: 'dependency', name: 'SIXAB002', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'dependency'};

MERGE (n:Copybook {name: 'SQLCA'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [449], ingestion: 'auto', layer: 'dependency', name: 'SQLCA', nodeType: 'copybook', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'dependency'};

MERGE (n:DBTable {name: 'PARAM'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [908, 909, 910, 911, 912, 913], ingestion: 'auto', layer: 'data-access', name: 'PARAM', nodeType: 'physical-table', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'data-access'};

MERGE (n:Paragraph {name: '980-ABORTA', programName: 'ECB385M'})
SET n += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [931], executionOrder: 4400, executionPhase: 'PROCESSING', ingestion: 'auto', layer: 'execution', name: '980-ABORTA', nodeType: 'process-step', programName: 'ECB385M', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', summary: 'Gestiona contingencias en ECB385M, concentrando el manejo de error y salida controlada.', viewTag: 'execution'};
...
SET n += {ingestion: 'auto', layer: 'program', name: 'ECB385M', nodeType: 'program', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m', sourceFile: 'src/ECB385M.cbl', viewTag: 'program'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: '980-ABORTA', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [931], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: '990-CIF-CTL', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [937], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'ABRE-ARCHIVOS', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [479], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'ARMA-E-IMPRIME-REP2', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [720], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'ARMA-E-IMPRIME-TOT-MES', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [700], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'ARMA-REGISTRO-E-IMPRIME', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [673], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'CIERRA-ARCHIVOS', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [488], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'CONFIGURATION', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [30], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'DESPLIEGA-FH-DE-PROCESO', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [496], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'FILE', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [40], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'FILE-CONTROL', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [34], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'FIN-ARCHIVO-ECB385I', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [471], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'IMPRIME-ENCABEZADOS-REPORTE1', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [849], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'IMPRIME-ENCABEZADOS-REPORTE2', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [878], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'INPUT-OUTPUT', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [33], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'LEE-REGISTRO-ECB385I', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [524], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'MUEVE-E-IMPRIME-TOT-GRALS', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [824], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'PROCESA-D1', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [660], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'PROCESA-REGISTRO-FECHA', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [562], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'PROCESA-REGISTROS-EDMOVED', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [532], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'PROCESA-REGISTROS-MES', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [547], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'REPO-R2-CONSLDDO', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [491], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'RUTINA-PRINCIPAL', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [462], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'SUMA-TOTALES-INSTRUMENTO', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [779], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'SUMARIZA-TOTALES-DEL-MES', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [790], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'TOMA-FECHA-PARAMETRO-4', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [907], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'TOTLS-CONSLDDO', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [745], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'TOTLS-CONSLDO', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [763], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'TOTLS-INSTRMNTO', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [785], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Program {name: 'ECB385M'}), (b:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB385M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [64], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: '980-ABORTA', programName: 'ECB385M'}), (b:Copybook {name: 'SIXAB002'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [934], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: '990-CIF-CTL', programName: 'ECB385M'}), (b:Copybook {name: 'SI2CM026'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [953], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: '990-CIF-CTL', programName: 'ECB385M'}), (b:Copybook {name: 'SIC004'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [948], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: 'DESPLIEGA-FH-DE-PROCESO', programName: 'ECB385M'}), (b:Copybook {name: 'SI2CM026'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [497], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: 'TOMA-FECHA-PARAMETRO-4', programName: 'ECB385M'}), (b:Copybook {name: 'SIC004'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [924], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB385M'}), (b:Copybook {name: 'DPARAM'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [455], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB385M'}), (b:Copybook {name: 'SI2FH027'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [235], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB385M'}), (b:Copybook {name: 'SIC005'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [242], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB385M'}), (b:Copybook {name: 'SICAM029'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [229], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB385M'}), (b:Copybook {name: 'SIXAB001'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [239], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};

MATCH (a:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB385M'}), (b:Copybook {name: 'SQLCA'})
MERGE (a)-[r:IMPLEMENTED_BY]->(b)
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [449], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};
...
SET r += {evidenceFile: 'src/ECB385M.cbl', evidenceLines: [908, 909, 910, 911, 912, 913], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010545Z-ecb385m'};
