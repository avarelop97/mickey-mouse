...
SET n += {ingestion: 'auto', layer: 'program', name: 'ECB415M', nodeType: 'program', reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m', sourceFile: 'src/ECB415M.cbl', viewTag: 'program'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: '000-0000-INICIO', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [143], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: '100-INICIO', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [149], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: '110-ABRE-ARCHIVOS', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [154], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: '200-PROCESO', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [162], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: '250-LEE-ARCHIVO-FISICAS', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [207], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: '255-LEE-REPORTE-ECBANCF', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [215], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: '300-TERMINA', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [222], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: '990-CIF-CTL', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [230], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: 'CONFIGURATION', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [22], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: 'FILE', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [43], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: 'FILE-CONTROL', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [27], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: 'INPUT-OUTPUT', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [26], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};

MATCH (a:Program {name: 'ECB415M'}), (b:Paragraph {name: 'WORKING-STORAGE', programName: 'ECB415M'})
MERGE (a)-[r:HAS_PARAGRAPH]->(b)
SET r += {evidenceFile: 'src/ECB415M.cbl', evidenceLines: [102], reviewRequired: true, reviewSource: 'auto-ingestion', reviewStatus: 'pending_human_review', runId: 'e2e-20260619T010759Z-ecb415m'};
