...
//*
//SYSREC   DD DSN=MXCP.ZM.FIX.CBJCLO00.ZMDT834,
...
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXCP.ZM.FIX.CBJCLO00.ZMDT852,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(RECFM=FB,BLKSIZE=0,DSORG=PS),
...
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXCP.ZM.FIX.CBJCLO00.ZMDT701,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(RECFM=FB,BLKSIZE=0,DSORG=PS),
//            SPACE=(CYL,(80,40),RLSE)
//*
...
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.CBJCLO00.ZMDT834,DISP=SHR
//         DD DSN=MXCP.ZM.FIX.CBJCLO00.ZMDT852,DISP=SHR
//         DD DSN=MXCP.ZM.FIX.CBJCLO00.ZMDT701,DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.FIX.CBJCLO00.GTIAS,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
