...
//*--------------------------------------------------------------------*
//PWL44P02 EXEC  PGM=ZM3DG001,PARM=('&EMP','&SUC','BCM000','     ',)    00230008
//PI601765 DD DUMMY                                                     00240005
//*                                                                     00240005
//ZMG001A1  DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMWEPL44,              00250007
...
//*--------------------------------------------------------------------*
//PWL44P01 EXEC  PGM=IKJEFT01,COND=(4,LT)                               00230008
//*                                                                     00240005
//ZMWL44A1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMWEPL44,DISP=SHR       00250007
//*                                                                     00240005
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZWL44T01),DISP=SHR                   00370007
//*                                                                     00370008
//*--------------------------------------------------------------------*
