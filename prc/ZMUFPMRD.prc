...
//*            CUENTA.                                                 *
//*--------------------------------------------------------------------*
//PUF01P99 EXEC PGM=ADUUMAIN,
//         PARM='MXP1,PUF01P99,NEW,,MSGLEVEL(1)'
//*
//STEPLIB  DD DSN=BMC.DB2.LOAD,DISP=SHR
//         DD DSN=LDB2MXP1.DBP1.SDSNEXIT,DISP=SHR
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXCP.ZM.FIX.ZMDT769.REPRO,
...
//* CONTROL :
//**********************************************************************
//PUF01P98 EXEC PGM=ICEMAN,COND=(4,LT)
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.GDGD.SIE.EBCM.ACUTENV2.G0059V00,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.FIX.SIE.SALDOS.SORTTEN.DICIEMB,
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.FIX.SIE.SALDOS.SORTTEN.DICIEMB,
//            DISP=SHR
...
//*
//**********************************************************************
//*           FINAL DE ZMUFPMRD  MES DE DICIEMBRE                      *
//**********************************************************************
