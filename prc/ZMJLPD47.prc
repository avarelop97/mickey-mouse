...
//*  PROGRAMA:   SORT                                                  *
//**********************************************************************
//PJD47P04 EXEC PGM=ICEMAN,PARM=('&INT1','&INT2')
//SYSOUT   DD SYSOUT=*
...
//ZMH00GA2 DD DSN=MXCP.ZM.TMP.MIG.A&INT2..SORTED,DISP=SHR
//ZMH00GA3 DD DSN=MXCP.ZM.TMP.MIG.M&INT1..SORTED,DISP=SHR
...
//**********************************************************************
//PJD47P01 EXEC  PGM=CTMCND,PARM='ADD COND  SIVAMG47_IN_SEP_OK WDATE',
//         COND=(4,LT)
