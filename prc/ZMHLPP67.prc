//ZMHLPP67 PROC                                                         00010000
//**********************************************************************00020000
//* PROGRAMA: ZM3DG001                                                * 00030000
//* FUNCION:  RECIBE LOS PARAMETROS ENVIADOS POR EL SUBMITIDOR        * 00040000
//* NO ACTUALIZA TABLAS.                                              * 00050000
//**********************************************************************00051000
//PHL67P02 EXEC PGM=ZM3DG001,                                           00070001
//         PARM=('&EMP','&SUC','&INT1','&INT2',)                        00080000
//PI601765 DD DUMMY                                                     00090000
//ZMG001A1 DD DSN=MXCP.ZM.WKF.EMP.SUC.ZMHLPE67.BXICO.OPC,               00100000
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,                        00110000
//            SPACE=(CYL,(20,10),RLSE),                                 00120000
//            DCB=(RECFM=FB,DSORG=PS,LRECL=96,BLKSIZE=0)                00130000
//SYSTSPRT DD SYSOUT=*,DCB=BLKSIZE=0                                    00140000
...
//****************************************************************      00240000
//PHL67P01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXBX8_IN_OK WDATE',       00250000
//         COND=(4,LT)                                                  00260000
...
//DACNDIN  DD DDNAME=SYSIN                                              00360000
//*                                                                     00370000
//****************************************************************      00380000
//*        TERMINA PROCESO  Z M H L P P 6 7                      *      00390000
//****************************************************************      00400000
