...
//* PROCESO  : ZMJLPF12.                                               *
//* OBJETIVO : SUBMITIDOR PARA RECIBIR ARCHIVO DE CONFIRMACION DE LA   *
//*            CANCELACION                                             *
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLPF12,
...
//*---------------------------------------------------------------------
//ZMPF1201 EXEC PGM=CTMCND,PARM='ADD COND SIVAXCRC_IN_OK WDATE',
//         COND=(4,LT)
