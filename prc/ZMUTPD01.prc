...
//*                                                                    *
//* PERIODICIDAD   :  DIARIO A LAS 16:00                               *
//*                                                                    *
//* REALIZO        :  SALVADOR PLASCENCIA HDEZ.                        *
//* FECHA          :  AGOSTO  2006                                     *
//*                                                                    *
//**********************************************************************
...
//*--------------------------------------------------------------------*
//*AZERT 15-ENE-06  IDCEX52 PUT01P03 CAMBIA LONG. DEL ARCHIVO A  264   *
//**********************************************************************
//*      ³          ³       ³        ³                                 *
//*-------------------------------------------------------------------**
//*                          -- ZM3DG001 --                            *
...
//*-------------------------------------------------------------------**
//PUT01P04 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','    ','     ','     ',)
//ZMG001A1 DD DSN=MXCP.ZM.WKF.PLZ.E&EMP..ZMUTPD01,
...
//*-------------------------------------------------------------------**
//PUT01P03 EXEC PGM=IKJEFT01,COND=(4,LT)
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZUT01T03),DISP=SHR
//*
//*-------------------------------------------------------------------**
...
//*-------------------------------------------------------------------**
//PUT01P02 EXEC PGM=DMBATCH,PARM=(YYSLYNN),COND=(4,LT)
//*
...
//SYSDUMP   DD SYSOUT=*
//SYSPRINT  DD SYSOUT=*
//SYSIN     DD DSN=ZIVA.ZME.CONTROL(ZUT01T02),DISP=SHR
//*
