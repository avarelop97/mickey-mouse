...
//**********************************************************************
//ZMLO4150  EXEC PGM=ADUUMAIN,                                          00022900
//          PARM='MXP1,ZMLO4150,NEW,,MSGLEVEL(1)'                       00023000
//*                                                                     00023400
//STEPLIB  DD DISP=SHR,DSN=BMC.DB2.MXP1.LOAD                            00023400
//         DD DISP=SHR,DSN=LDB2MXP1.DBP1.SDSNEXIT
//         DD DISP=SHR,DSN=LDB2MXP1.DBP1.SDSNLOAD                       00023400
//*                                                                     00023400
//SYSREC   DD DSN=MXCP.ZM.FIX.BCM.CBJCLO41.UNLOAD.ZMDT645,              00023800
//            UNIT=3390,                                                00023900
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZMLO4150),DISP=SHR                   00024800
//*
//**********************************************************************
//* PASO     : ZMLO4145                                                *
//* UTILERIA : ICEMAN                                                  *
...
//**********************************************************************
//ZMLO4145 EXEC PGM=ICEMAN,COND=(4,LT)                                  0920002
//SORTIN   DD DSN=MXCP.ZM.FIX.BCM.CBJCLO41.UNLOAD.ZMDT645,DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.FIX.BCM.CBJCLO41.FORMATO.K,
...
//**********************************************************************
//ZMLO4140 EXEC PGM=ICEMAN,COND=(4,LT)                                  0920002
//SORTIN   DD DSN=MXCP.ZM.FIX.BCM.CBJCLO41.UNLOAD.ZMDT645,DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.FIX.BCM.CBJCLO41.FORMATO.P,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(100,500),RLSE),
//            DCB=(LRECL=255,RECFM=FB,BLKSIZE=0,DSORG=PS)
//SYSPRINT DD SYSOUT=*
...
//**********************************************************************
//ZMLO4135 EXEC PGM=ICEMAN,COND=(4,LT)                                  0920002
//SORTIN   DD DSN=MXCP.ZM.FIX.BCM.CBJCLO41.UNLOAD.ZMDT645,DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.FIX.BCM.CBJCLO41.FORMATO.IV,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(100,500),RLSE),
//            DCB=(LRECL=255,RECFM=FB,BLKSIZE=0,DSORG=PS)
//SYSPRINT DD SYSOUT=*
