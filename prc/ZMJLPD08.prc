...
//*                                                                   * 00080000
//*   JCL              :  SIVAXRBP                                    * 00090004
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXRBP -> PRC ZMJLPD08  * 00110004
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE        3.-  LIQUIDACION A 48 HRS DE LOS DIF. INT DE CB. * 00170003
//*                       (ZM4DHW65)                                  * 00180002
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("C").                            * 00210002
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD08P03 EXEC PGM=ZM3DG001,                                           00390005
...
//*  PJD08P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD08P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD08T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  GENERAR REPORTE DE LIQUIDACION DE INTERMEDIARIOS  A     *00740003
//*            48 HRS.                                                 *00750003
//*  PJD08P01                                               ZM4DHW65   *00760000
//**********************************************************************00770000
//PJD08P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZM4D65A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00800000
//*                                                                     00810000
//ZM4D65R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00820005
//*                                                                     00830000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD08T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920006
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930006
//*            REPORTE DE LIQUIDACION DE INTERMEDIARIOS A 48 HRS.      *00940006
//*                                                                    *00941006
//**********************************************************************00950006
//PJD08P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP08_IN_SEP_OK WDATE',  00960008
//         COND=(4,LT)                                                  00961008
//STEPLIB  DD DISP=SHR,DSN=SYS3.IOAO.SYSZBBV.TGT.LOAD                   00970007
//DAPARM   DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.PARM                   00980007
//         DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.IOAENV                 00990007
//DALOG    DD DISP=SHR,DSN=SYS3.IOAD.SYSZBBV.DATA.LOG                   01000007
//DARESF   DD DISP=SHR,DSN=SYS3.IOAD.SYSZBBV.DATA.NRS                   01010007
//*                                                                     01020006
//PRTDBG   DD SYSOUT=*                                                  01030006
//SYSPRINT DD DUMMY                                                     01040006
//SYSUDUMP DD DUMMY                                                     01050006
//DAPRINT  DD SYSOUT=*                                                  01060006
//DACNDIN  DD DDNAME=SYSIN                                              01070006
//*                                                                     01080006
