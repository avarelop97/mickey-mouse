...
//*   PROCEDIM. :  ZMLLPE38                                            *
//*                                                                    *
//*   OBJETIVO  :  AMORTIZACIONES PARCIALES MDD                        *
//*                                                                    *
//*   CORRE     :  SIVAXRRA                                            *
//*                                                                    *
//*   CORRE ANTES DE  :                                                *
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//ZMG001A1 DD DSN=MXCP.ZM.FIX.MDD.E&EMP..S&SUC..ZMLLPE38,
...
//**********************************************************************00410000
//*                         -- CTMCND --                               *00420000
//* OBJETIVO: ACTIVA CONDICION EN CONTROL-M "BCLCCD41_IN" PARA QUE SE  *00430000
//*           EJECUTE LA FUNCION DE AMORTIZACION PARCIAL .             *00440000
//*                                                                    *00450000
//* PASO REINICIABLE POR RESTART                                       *00460000
//**********************************************************************00470000
//PLL39P01 EXEC PGM=CTMCND,                                             00480000
//         PARM='ADD COND BCLCCD41_IN_PR_OK WDATE',COND=(4,LT)          00490000
