...
//*
//SYSREC1  DD DSN=MXCP.ZM.FIX.UNLOAD.ZMDT705.UNLD.M&FECHA,
...
//*--------------------------------------------------------------------*
//PUF01P75 EXEC PGM=ICEMAN,COND=(4,LT)
//SORTIN   DD DSN=MXCP.ZM.FIX.UNLOAD.ZMDT705.UNLD.M&FECHA.,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.FIX.UNLOAD.ZMDT705.M&FECHA.,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=3390,BUFNO=30,
//            SPACE=(CYL,(100,50),RLSE),
