...
//            DISP=SHR
//ZM4EH4S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.INDEVA2C,
...
//PI601765 DD DUMMY
//ZM3EH1A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN2,DISP=SHR
//ZM3EH1S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.TCONCIL2,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//PI601765 DD DUMMY
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.INDEVA2C,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.INDEVA2C.MDD,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=170,BLKSIZE=0)
//SYSIN    DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.TCONCIL2,DISP=SHR           00183716
//*                                                                     00183716
//*-------------------------------------------------------------------*
//* PROGRAMA: ZM4EH009                                                *
...
//PI601765 DD DUMMY
//ZM4EH0S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.TRASANT,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//PI601765 DD DUMMY
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.GDGD.VAL.EBCM.SCTD.REPORTO(0),DISP=SHR
//         DD DSN=MXCP.ZM.GDGD.VAL.EBCM.SCTD.LIQNOHOY(0),DISP=SHR
//         DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.TRASANT,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.LIQNOHOY.OPERCAP,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//PI601765 DD DUMMY
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.GDGD.VAL.EBCM.SCTD.CARTERA(0),DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CARTERA.OPERCAP,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//PI601765 DD DUMMY
//ZM3EH0A1 DD DSN=MXCP.ZM.GDGD.VAL.EBCM.SCTD.CONEMIS(0),DISP=SHR
//ZM3EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CARTERA.OPERCAP,
//            DISP=SHR
//ZM3EH0S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.TITULOS.OPERCAP,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=80,BLKSIZE=0)
//SYSTSPRT DD SYSOUT=*
...
//PI601765 DD DUMMY
//ZM4EH0A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.TITULOS.OPERCAP,
//            DISP=SHR
//ZM4EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.LIQNOHOY.OPERCAP,
//            DISP=SHR
//ZM4EH0S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CAPSI.OPERCAP,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//PI601765 DD DUMMY
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CAPSI.OPERCAP,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.MOVTOS.OPERSORT,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=162,BLKSIZE=0)
...
//PI601765 DD DUMMY
//ZM3EH0A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.MOVTOS.OPERSORT,
//            DISP=SHR
//ZM3EH0S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.MOVTOS.OPERCAP,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=162,BLKSIZE=0)
//SYSTSPRT DD SYSOUT=*
...
//PI601765 DD DUMMY
//ZM4EH7A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.INDEVA2C.MDD,
//            DISP=SHR
//ZM4EH7S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.EMISINDE.OPERCAP,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//PI601765 DD DUMMY
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.EMISINDE.OPERCAP,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.EMISINDE.SORT,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=90,BLKSIZE=0)
...
//PI601765 DD DUMMY
//ZM4EH8A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.MOVTOS.OPERCAP,
//            DISP=SHR
//ZM4EH8A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.EMISINDE.SORT,
//            DISP=SHR
//ZM4EH8S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONCIL.OPERCAP,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//PI601765 DD DUMMY
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONCIL.OPERCAP,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONSIVA.CAPITAL,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=120,BLKSIZE=0)
...
//SORTIN   DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONCIL.OPERCAP,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONSIVA.OPERAT,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=120,BLKSIZE=0)
...
//ZM3EH0A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONSIVA.CAPITAL,
//            DISP=SHR
//ZM3EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN2,DISP=SHR
//ZM3EH0A3 DD DSN=MXCP.ZM.FIX.VAL.EBCM.ZMHLBZ08.DIFCON.CAP,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//ZM3EH0A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONSIVA.OPERAT,
//            DISP=SHR
//ZM3EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN2,DISP=SHR
//ZM3EH0A3 DD DSN=MXCP.ZM.FIX.VAL.EBCM.ZMHLBZ08.DIFCON.OPE,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=105,BLKSIZE=0)
//ZM3EH0R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')
