...
//*                                                                   * 00080000
//*   JCL              :  SIVAXRBP                                    * 00090000
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXRBP -> PRC ZMJLPD26  * 00110000
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE       21.-  REPORTE DE HECHOS DE M.C. BCA. PAT.         * 00170000
//*                       (ZM4DHW49)                                  * 00180000
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("U").                            * 00210000
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD26P03 EXEC PGM=ZM3DG001,                                           00390000
...
//*  PJD26P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD26P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD26T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  REPORTE DE ASIGNACION DEFINITIVA DE B.P.                *00740000
//*                                                                    *00750000
//*  PJD26P01                                               ZM4DU505   *00760000
//**********************************************************************00770000
//PJD26P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZMU505R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00800014
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD26T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920015
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930015
//*            REPORTE DE ASIGNACION DEFINITIVA DE B.P.                *00940015
//**********************************************************************00950015
//PJD26P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP26_IN_SEP_OK WDATE',  00960018
//         COND=(4,LT)                                                  00961017
//STEPLIB  DD DISP=SHR,DSN=SYS3.IOAO.SYSZBBV.TGT.LOAD                   00970016
//DAPARM   DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.PARM                   00980016
//         DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.IOAENV                 00990016
//DALOG    DD DISP=SHR,DSN=SYS3.IOAD.SYSZBBV.DATA.LOG                   01000016
//DARESF   DD DISP=SHR,DSN=SYS3.IOAD.SYSZBBV.DATA.NRS                   01010016
//*                                                                     01020015
//PRTDBG   DD SYSOUT=*                                                  01030015
//SYSPRINT DD DUMMY                                                     01040015
//SYSUDUMP DD DUMMY                                                     01050015
//DAPRINT  DD SYSOUT=*                                                  01060015
//DACNDIN  DD DDNAME=SYSIN                                              01070015
//*                                                                     01080015
