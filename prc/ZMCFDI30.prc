...
//*
//FDSALIDA DD DSN=MXCP.ZM.FIX.EBCM.CFDI.PIPMEDC.PREV,
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHCF1T33),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : PHCFDI11                                              *
...
//*
//ENTRADA  DD DSN=MXCP.ZM.FIX.EBCM.CFDI.PIPMEDC.PREV,DISP=SHR
//*
//SALIDA   DD DSN=MXCP.ZM.FIX.EBCM.CFDI.PIPMEDC,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(500,300),RLSE),
//            DCB=(RECFM=FB,LRECL=1000,BLKSIZE=0,DSORG=PS)
//*
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHCFIR15),DISP=SHR
//*
