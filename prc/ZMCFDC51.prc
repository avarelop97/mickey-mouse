...
//*--------------------------------------------------------------------*
//ZMDC5102 EXEC PGM=ADUUMAIN,                                           00385600
//         PARM='MXP1,ZMDC5102,NEW,,MSGLEVEL(1)'                        00385700
//*                                                                     00385800
...
//*                                                                     00386200
//SYSREC   DD DSN=MXCP.ZM.FIX.ECBP.ZMDTCFI.SELLOS,                      00386300
...
//*--------------------------------------------------------------------*
//ZMDC5101 EXEC PGM=ICEMAN,COND=(04,LT)
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.ECBP.ZMDTCFI.SELLOS,DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECBP.ZMDTCFI.SELLOSU,
//            DISP=(NEW,PASS),
...
//*--------------------------------------------------------------------*
// IF  ZMDC5101.RC EQ 00 THEN
//ZMDC5100 EXEC PGM=CTMCND,PARM='ADD COND CBCFDI51_SUS_OK WDATE',       00395100
//         COND=(4,LT)                                                  00395200
//*                                                                     00395300
