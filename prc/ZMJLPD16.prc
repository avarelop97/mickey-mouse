...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXRBP -> PRC ZMJLPD16  * 00110011
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE       11.-  LIQUIDACION DE OPERACIONES DE M. CAPITALES  * 00170000
//*                       (ZM4DHW47)                                  * 00180000
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("K").                            * 00210000
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD16P03 EXEC PGM=ZM3DG001,                                           00390013
...
//*  PJD16P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD16P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD16T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  LIQUIDACION DE OPERACIONES DE M.C.                      *00740000
//*                                                                    *00750000
//*  PJD16P01                                               ZM4DHW47   *00760000
//**********************************************************************00770000
//PJD16P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZMHW47A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00820000
//*                                                                     00830000
//ZMHW47R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00831012
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD16T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920014
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930014
//*            LIQUIDACION DE OPERACIONES DE M.C.                      *00940014
//**********************************************************************00950014
//PJD16P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP16_IN_SEP_OK WDATE',  00960016
//         COND=(4,LT)                                                  00961016
