...
//*  PROGRAMA:   SORT                                                  *
//**********************************************************************
//PJD42P04 EXEC PGM=ICEMAN
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.FIX.MIG061.ACOPOSI,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.MIG.ACOPOSI.SORTED,
//         DISP=(NEW,CATLG,DELETE),
//         DCB=(DSORG=PS,RECFM=FB,LRECL=180,BLKSIZE=0),
//         UNIT=3390,SPACE=(CYL,(10,5),RLSE)
//SYSPRINT DD SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZJD42T01),DISP=SHR
//*
//**********************************************************************
//*  PASO: 03    ORDENA ARCHIVO DE MUV                                 *
//*  PROGRAMA:   SORT                                                  *
//**********************************************************************
//PJD42P03 EXEC PGM=ICEMAN,COND=(4,LT)
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.FIX.MIG.CNTL.MPOSICI,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.MIG.MPOSICI.SORTED,
//         DISP=(NEW,CATLG,DELETE),
//         DCB=(DSORG=PS,RECFM=FB,LRECL=107,BLKSIZE=0),
//         UNIT=3390,SPACE=(CYL,(10,5),RLSE)
//SYSPRINT DD SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZJD42T02),DISP=SHR
//*
//**********************************************************************
//*  PASO: 02  CONCILIA LOS 2 ARCHIVOS Y GENERA REPORTE DE DIFERENCIAS *
//*  PROGRAMA: ZM4DH042                                                *
//**********************************************************************
//PJD42P02 EXEC PGM=IKJEFT01,COND=(4,LT)
//ZMH00BA2 DD DSN=MXCP.ZM.TMP.MIG.ACOPOSI.SORTED,DISP=SHR
//ZMH00BA3 DD DSN=MXCP.ZM.TMP.MIG.MPOSICI.SORTED,DISP=SHR
//*ZMH00BR1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')
//ZMH00BR1 DD SYSOUT=*
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
...
//SYSABOUT DD SYSOUT=*
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD42T03),DISP=SHR
//*
