...
//*   PROCEDIM. :  ZXLLDLX2                                            *
//*                                                                    *
//*   OBJETIVO  :  GENERA ARCHIVO DE PARAMETROS PARA CORTE DE CUPON    *
//*                SORPRESIVO Y ADICIONA CONDICION DE ARRANQUE.        *
//*                ARRANQUE.                                           *
//*   CORRE DESPUES DE:  SIVAXCSC                                      *
//*                                                                    *
//*   CORRE ANTES DE  :                                                *
//*                                                                    *
//*   PERIODICIDAD    :  DIARIO                                        *
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//ZMG001A1 DD DSN=MXCP.ZM.FIX.MDD.E&EMP..S&SUC..ZXLLDLX2,
...
//**********************************************************************00410000
//*                         -- CTMCND --                               *00420000
//* OBJETIVO: ACTIVA CONDICION EN CONTROL-M "BCLLDLX2_IN" PARA QUE SE  *00430000
//*           EJECUTE LA FUNCION DE CORTE DE CUPON SORPRESIVO.         *00440000
//*                                                                    *00450000
//* PASO REINICIABLE POR RESTART                                       *00460000
//**********************************************************************00470000
//PLLX2P01 EXEC PGM=CTMCND,                                             00480000
//         PARM='ADD COND BCLLDLX2_IN_OK WDATE',COND=(4,LT)             00490000
