...
//SYSUT2   DD DSN=MXCP.ZM.FIX.ECBP.CFDI.ACCMEDC.CORR,
...
//SYSUT1   DD DSN=NULLFILE,UNIT=3390,
//            DCB=(RECFM=FB,LRECL=551)
//SYSUT2   DD DSN=MXCP.ZM.FIX.ECBP.CFDI.ACCMEDC.PRES,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(300,150),RLSE),
//            DCB=(DSORG=PS,LRECL=551,RECFM=FB,BLKSIZE=0),
//            UNIT=3390
...
//SYSUT2   DD DSN=MXCP.ZM.FIX.ECBP.CFDI.ADMMEDC.CORR,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(300,150),RLSE),
...
//SYSUT1   DD DSN=NULLFILE,UNIT=3390,
//            DCB=(RECFM=FB,LRECL=3247)
//SYSUT2   DD DSN=MXCP.ZM.FIX.ECBP.CFDI.ADMMEDC.PRES,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(300,150),RLSE),
//            DCB=(DSORG=PS,LRECL=3247,RECFM=FB,BLKSIZE=0),
//            UNIT=3390
...
//SYSUT2   DD DSN=MXCP.ZM.FIX.ECBP.CFDI.DIVMEDC.CORR,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(300,150),RLSE),
...
//SYSUT1   DD DSN=NULLFILE,UNIT=3390,
//            DCB=(RECFM=FB,LRECL=336)
//SYSUT2   DD DSN=MXCP.ZM.FIX.ECBP.CFDI.DIVMEDC.PRES,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(300,150),RLSE),
//            DCB=(DSORG=PS,LRECL=336,RECFM=FB,BLKSIZE=0),
//            UNIT=3390
...
//SYSUT2   DD DSN=MXCP.ZM.FIX.ECBP.CONTROL,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(300,150),RLSE),
