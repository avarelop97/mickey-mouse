...
//*--------------------------------------------------------------------*
//ZFM22T10 EXEC PGM=IKJEFT01
//*
//ZM10FMS1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML24.MEN,
...
//SYSDBOUT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZFM22T10),DISP=SHR
//*@DGCM01-I
//*--------------------------------------------------------------------*
//* PASO       : ZFM22T09.                                             *
//* UTILERIA   : ADUUMAIN                                              *
...
//*--------------------------------------------------------------------*
//ZFM22T09 EXEC PGM=ADUUMAIN,COND=(4,LT),
//         PARM='MXP1,ZFM22T09,NEW,,MSGLEVEL(1)'
//STEPLIB  DD DSN=BMC.DB2.MXP1.LOAD,DISP=SHR
//         DD DSN=LDB2MXP1.DBP1.SDSNEXIT,DISP=SHR
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXCP.ZM.FIX.BCFMLD22.UNLOAD.PARAM,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
...
//*--------------------------------------------------------------------*
//ZFM22T08 EXEC PGM=ZM3FML43,COND=(4,LT)
//*
//E1DQENT1 DD DSN=MXCP.ZM.FIX.BCFMLD22.UNLOAD.PARAM,
//            DISP=SHR
//*
//*
