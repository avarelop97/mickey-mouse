...
//         DD DSN=SYSC.CSP330.ADLOAD,DISP=SHR                           00190009
//DCAHECD  DD DSN=SYSC.CSP330.FZEMSG,DISP=SHR                           00200010
...
//ALFA     DD DSN=SOPPROD.DB2P.ALFPT80,DISP=SHR                         00240000
...
//SYSUT1   DD DSN=SOPPROD.DB2P.ALFPT80,DISP=SHR                         00470000
//SYSUT2   DD DSN=&COPYCSP(&APLICG.&AMB),DISP=SHR                       00480002
//SYSIN    DD DUMMY                                                     00490000
//ASMH   EXEC  PGM=IEV90,PARM='OBJECT,NOALIGN,LIST',REGION=4M,          00530000
//       COND=(4,LT)                                                    00540000
//SYSLIB   DD  DSN=SYS1.MACLIB,DISP=SHR                                 00550000
//         DD  DSN=SYSC.CSP330.CSPDB2,DISP=SHR                          00560009
...
//SYSIN    DD  DSN=&COPYCSP(&APLICG.&AMB),DISP=SHR                      00620002
...
//SYSLIB   DD  DSN=SYSC.CSP330.CSPDB2,DISP=SHR                          00730009
//*        DD  DISP=SHR,DSN=SYSP.DSN220.SRCLIB.DATA                     00740008
...
//ASM1   EXEC  PGM=IEV90,PARM='OBJECT,NOALIGN,LIST',REGION=4M,          00830000
//           COND=(4,LT)                                                00840000
//SYSLIB   DD  DSN=SYS1.MACLIB,DISP=SHR                                 00850000
//         DD  DSN=SYSC.CSP330.CSPDB2,DISP=SHR                          00860009
...
//SYSIN    DD  DSN=SYS2.PARMLIB(NPUTGENB),DISP=SHR                      01060002
//*******************************************
//*        TRANSFIERE OBJETO A ALF CORRESPONDIENTE
//*******************************************
//TRALFCGA EXEC PGM=DCGBINIT,REGION=4M,COND=(4,LT)
//STEPLIB DD DSN=SYSC.CSP330.AELOAD,DISP=SHR                                0018
//DCADZGD DD DSN=SYSC.CSP330.DZGMSG,DISP=SHR                                0021
//UTILALF DD DSN=SYSC.CSP330.UTILALF.ALF,DISP=SHR                           0022
//TRGTALF DD DSN='SOPPROD.DPPASOC.LOADNP.KC',DISP=SHR                       0097
//SECNALF DD DSN='@DEST',DISP=SHR                                           0023
//EZEPRINT DD SYSOUT=*,DCB=(RECFM=VBA,LRECL=650,BLKSIZE=0)                  0037
//SYSPRINT DD SYSOUT=*                                                      0038
//SYSOUT     DD SYSOUT=*
//SYSCOUNT DD SYSOUT=*
//ALFL       DD SYSOUT=*,DCB=(RECFM=FBA,LRECL=121,BLKSIZE=0)                0039
//DCAPARM DD DUMMY                                                          0040
//ALFC       DD DUMMY                                                       0041
//*******************************************
//*        PONE RESIDENTE LA APLICACION
//*******************************************
//RESID EXEC PGM=DCGBINIT,REGION=4M,COND=(4,LT)                             0004
//STEPLIB DD DSN=SYSC.CSP330.AELOAD,DISP=SHR                                0004
//DCADZGD DD DSN=SYSC.CSP330.DZGMSG,DISP=SHR                                0004
//UTILALF DD DSN=SYSC.CSP330.UTILALF.ALF,DISP=SHR                           0004
//TRGTALF DD DSN=&DEST,DISP=SHR,                                            0004
//             AMP=('BUFSP=40960')                                          0004
//SECNALF DD DSN=&DEST,DISP=SHR,                                            0004
//             AMP=('BUFSP=40960')                                          0004
//EZEPRINT DD SYSOUT=*,DCB=(RECFM=VBA,LRECL=133,BLKSIZE=0)                  0004
//SYSPRINT DD SYSOUT=*                                                      0004
//SYSOUT        DD SYSOUT=*
//SYSCOUNT DD SYSOUT=*
//ALFL DD SYSOUT=*,DCB=(RECFM=FBA,LRECL=121,BLKSIZE=0)                      0004
//DCAPARM DD DSN=SYS2.PARMLIB(DCAPARM),DISP=SHR                             0004
//ALFC         DD DUMMY                                                     0004
//*******************************************
//*        BIND
//*******************************************
//BIND        EXEC PGM=IKJEFT01,DYNAMNBR=20,REGION=4M,
//             COND=(4,LT)
...
//SYSOUT        DD SYSOUT=*
//SYSCOUNT DD SYSOUT=*
//SYSTSIN       DD  DSN=SIVA.BINDSVN(&APLICG.&AMB),DISP=SHR
