...
//*                     -- ZM4CFD05 --                                 *
//*--------------------------------------------------------------------*
//ZMDB4201 EXEC PGM=IKJEFT01
//*
//CONFIRM  DD DSN=MXCP.ZM.FIX.EBCM.CONFIRM.INGRESO,
//            DISP=SHR
//*
//SALIDA   DD DSN=MXCP.ZM.FIX.EBCM.RECHAZA.INGRESO,
...
//SYSUDUMP DD DUMMY
//*
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZMDB4201),DISP=SHR
//*
