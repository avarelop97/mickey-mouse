...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXLPR -> PRC ZMJLPD21  * 00110000
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE       16.-  TITULOS OPERADOS POR C.B.                   * 00170000
//*                       (ZM4DHW48)                                  * 00180000
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("P").                            * 00210000
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD21P03 EXEC PGM=ZM3DG001,                                           00390013
...
//*  PJD21P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD21P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD21T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  REPORTE DE TITULOS OPERADOS POR CASA DE BOLSA.          *00740000
//*                                                                    *00750000
//*  PJD21P01                                               ZM4DHW48   *00760000
//**********************************************************************00770000
//PJD21P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZMHW48A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00800000
//*                                                                     00810000
//ZMHW48R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00820013
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD21T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920014
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930014
//*            REPORTE DE TITULOS OPERADOS POR CASA DE BOLSA.          *00940014
//**********************************************************************00950014
//PJD21P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP21_IN_SEP_OK WDATE',  00960017
//         COND=(4,LT)                                                  00961016
