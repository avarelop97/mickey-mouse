...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXRBP -> PRC ZMJLPD30  * 00110003
//*                                                                   * 00120000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD30P03 EXEC PGM=ZM3DG001,                                           00390003
...
//*  PJD30P02                                               ZM4DHW28   *00560003
//**********************************************************************00570000
//PJD30P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580003
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD30T02),DISP=SHR                   00710003
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  LIQUIDACION DE OPERACIONES DE M.C.                      *00740000
//*                                                                    *00750000
//*  PJD30P01                                               ZM4EHU47   *00760003
//**********************************************************************00770000
//PJD30P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780003
//*                                                                     00790000
//ZMHW47A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00820000
//*                                                                     00830000
//ZMHW47R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00831002
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD30T01),DISP=SHR                   00900003
//*                                                                     00910000
//**********************************************************************00920002
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930002
//*            LIQUIDACION DE OPERACIONES DE M.C.                      *00940002
//**********************************************************************00950002
//PJD30P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP30_IN_SEP_OK WDATE',  00960003
//         COND=(4,LT)                                                  00961002
