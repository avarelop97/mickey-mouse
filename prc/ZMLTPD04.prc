...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMLTPD04,
...
//*               SIVA.MDD.FIX.ECBP.AUD.CLIENTE                        *00020000
//*               AL SERVIDOR PLANAS1F1                                *00020000
//*-------------------------------------------------------------------**
//PLT04P01 EXEC PGM=DMBATCH,PARM=(YYSLYNQ),COND=(4,LT)
//*
...
//NDMCMDS   DD SYSOUT=*
//SYSUDUMP  DD DUMMY
//SYSIN     DD DSN=ZIVA.ZME.CONTROL(ZLT04T01),DISP=SHR
//*
//****************************************************************
//*                SE ADICIONA CONDICION                         *
//*                PARA QUE SEA TOMADA POR CTL-D                 *
//****************************************************************
//PLT04P00 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXQZ4_IN_SEP_OK WDATE',
//         COND=(5,LT)
...
//*
//*--------------------------------------------------------------------*00010000
//*                 F I N   Z M L T P D 0 4                            *00020000
//*--------------------------------------------------------------------*00010000
