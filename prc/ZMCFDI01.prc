...
//*                               DE ADMITIVOS DE 2850 A 3246 Y EL     *
//*                               ARCHIVO DE DIVIDENDOS DE 325 A 336   *
...
//*
//SYSUT1   DD DSN=MXCP.ZM.FIX.EBCM.CFDI.DIVMEDC.CORR,DISP=SHR
//*        DD DSN=MXCP.ZM.FIX.EBCM.CFDI.DIVMEDC.PRES,DISP=SHR
//SYSUT2   DD DSN=MXCP.ZM.FIX.EBCM.CFDI.DIVMEDC.F,
...
//*
//SYSUT1   DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ACCMEDC.CORR,DISP=SHR
//*        DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ACCMEDC.PRES,DISP=SHR
//SYSUT2   DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ACCMEDC.F,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(300,150),RLSE),
...
//SYSUT1   DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ADMMEDC.CORR,DISP=SHR
//*        DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ADMMEDC.PRES,DISP=SHR
//SYSUT2   DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ADMMEDC.F,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(300,150),RLSE),
...
//*
//ZMCFDIA1 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.DIVMEDC.F,DISP=SHR
//ZMCFDIA2 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ACCMEDC.F,DISP=SHR
//ZMCFDIA3 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ADMMEDC.F,DISP=SHR
//*
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
...
//SORTIN   DD DSN=MXCP.ZM.FIX.EBCM.CFDI.DIVMEDC.F,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.FIX.EBCM.CFDI.DIVMEDC.FS,
//            DISP=(NEW,CATLG,DELETE),
...
//SORTIN   DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ACCMEDC.F,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ACCMEDC.FS,
//            DISP=(NEW,CATLG,DELETE),
...
//SORTIN   DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ADMMEDC.F,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ADMMEDC.FS,
//            DISP=(NEW,CATLG,DELETE),
...
//*
//ZM3ECE01 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ADMMEDC.FS,DISP=SHR
//ZM3ECE02 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ACCMEDC.FS,DISP=SHR
//FDSALIDA DD DSN=MXCP.ZM.FIX.EBCM.CFDI.XMLMEDC,
//            DISP=(NEW,CATLG,DELETE),
...
//*
//ZMCFDIA1 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.DIVMEDC.FS,DISP=SHR
//ZMCFDIA2 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.XMLMEDC,DISP=SHR
//ZMCFDIA3 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.XMLMEDC.FS,
//            DISP=(NEW,CATLG,DELETE),
...
//*
//ZM4ECE01 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ADMMEDC.FS,DISP=SHR
//ZM4ECE02 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.DIVMEDC.FS,DISP=SHR
//ZM4ECE03 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.ACCMEDC.FS,DISP=SHR
//ZM4ECE04 DD DSN=MXCP.ZM.FIX.EBCM.CFDI.XMLMEDC.FS,DISP=SHR
//*
//FDSALIDA DD DSN=MXCP.ZM.FIX.EBCM.CFDI.PIPMEDC,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(500,300),RLSE),
//            DCB=(RECFM=FB,LRECL=1000,BLKSIZE=0,DSORG=PS)
//*
//FDCIFRAS DD DSN=MXCP.ZM.FIX.EBCM.CFDI.CON08,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(300,150),RLSE),
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHCF1T10),DISP=SHR
//*ACC-INI
//*--------------------------------------------------------------------*
//* PASO       : PHCFDI10                                              *
//* OBJETIVO   : GENERACION ARCHIVO DE PIPES BCM                       *
//*                         -- ZM4CFDI7 --                             *
//*--------------------------------------------------------------------*
//* IF (PHCFDI10.RC = 3) THEN
//*PHCFDI11 EXEC PGM=CTMCND,
