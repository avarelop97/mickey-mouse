...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXLPR -> PRC ZMJLPD20  * 00110000
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE       15.-  CPAS. VTAS. DE M. CAPITALES 48 HORAS        * 00170000
//*                       (ZM4DHW61)                                  * 00180000
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("O").                            * 00210000
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD20P03 EXEC PGM=ZM3DG001,                                           00390011
...
//*  PJD20P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD20P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD20T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  LIQUIDACION DE OPERACIONES DE M. CAPITALES DE CASA DE   *00740000
//*            BOLSA 48 HORAS.                                         *00750000
//*  PJD20P01                                               ZM4DHW61   *00760000
//**********************************************************************00770000
//PJD20P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZMHV61A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00831000
//*                                                                     00831100
//ZM4V61R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00831211
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD20T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920012
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930012
//*            LIQUIDACION DE OPERACIONES DE M. CAPITALES DE CASA DE   *00940012
//*            BOLSA 48 HORAS.                                         *00941012
//**********************************************************************00950012
//PJD20P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP20_IN_SEP_OK WDATE',  00960015
//         COND=(4,LT)                                                  00961014
//STEPLIB  DD DISP=SHR,DSN=SYS3.IOAO.SYSZBBV.TGT.LOAD                   00970013
//DAPARM   DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.PARM                   00980013
//         DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.IOAENV                 00990013
//DALOG    DD DISP=SHR,DSN=SYS3.IOAD.SYSZBBV.DATA.LOG                   01000013
//DARESF   DD DISP=SHR,DSN=SYS3.IOAD.SYSZBBV.DATA.NRS                   01010013
//*                                                                     01020012
//PRTDBG   DD SYSOUT=*                                                  01030012
//SYSPRINT DD DUMMY                                                     01040012
//SYSUDUMP DD DUMMY                                                     01050012
//DAPRINT  DD SYSOUT=*                                                  01060012
//DACNDIN  DD DDNAME=SYSIN                                              01070012
//*                                                                     01080012
