...
//*   PROCEDIM. :  ZMJLPE31  (OPC. 671)                                *00110000
//*                                                                    *00120000
...
//********************************************************************* 00250000
//PJL31P04  EXEC PGM=ZM3DG001,REGION=0M,                                00260000
...
//ZMG001A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLPE31,               00350000
...
//*            PENDIENTES.                                          *   00421000
//*******************************************************************   00430000
//PJL31P03 EXEC PGM=IKJEFT01,REGION=0M,COND=(4,LT)                      00440000
//*                                                                     00450000
//ZMJ589AP DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLPE31,DISP=SHR       00460000
//*                                                                     00470000
...
//********************************************************************* 01290000
//PJL31P02 EXEC PGM=MAILOPER,COND=(4,GE),                               01300000
//         PARM=('/ATENCION.AVISAR A PRODUCCION QUE EL PROCESO ',       01310000
//             'SIVAXDMP (ZMJLPE31) TERMINO MAL Y FINALIZAR ')          01320000
//*                                                                     01340000
//****************************************************************      01350000
//*                SE ADICIONA CONDICION                         *      01360000
//*                PARA QUE SEA TOMADA POR CTL-D                 *      01370000
//****************************************************************      01380000
//PJL31P01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXDMP_IN_SEP_OK WDATE',   01390000
//         COND=(4,LT)                                                  01400000
...
//*                                                                     01510000
//**********************************************************************01520000
//*        TERMINA PROCESO ZMJLPE31 SIVA MULTIEMPRESA                  *01530000
//**********************************************************************01540000
