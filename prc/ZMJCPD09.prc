...
//*                                                                    *00044000
//* PROCESO        :  SIVAXVDF (SUBMITIDOR)                            *00045000
//*                   ZMJCPD09 (PROCEDIMIENTO)                         *00046000
//*                                                                    *00047000
//* OBJETIVO       :  VALUACION DEFINITIVA DE OPERACIONES DE SOC. INV. *00048000
//*                   ENVIADO POR EL USUARIO (FONDOS DE FONDOS)        *00049000
//*                                                                    *00049100
//* CORRE                                                              *00049200
...
//**********************************************************************00055500
//PJC09P12 EXEC PGM=IDCAMS                                              00055600
//*                                                                     00055700
//SYSPRINT DD SYSOUT=*                                                  00055800
//*                                                                     00055900
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZJC09T01),DISP=SHR                   00056000
//*                                                                     00056100
//**********************************************************************00056200
//*                        == ZM3DG001 ==                              *00056300
//*                                                                    *00056400
//* OBJETIVO : GRABA LOS PARAMETROS PARA LA VALUACION PRELIMINAR       *00056500
//*            DE BANCA PATRIMONIAL (FONDOS DE FONDOS)                 *00056600
//**********************************************************************00056700
//PJC09P11 EXEC PGM=ZM3DG001,COND=(4,LT),                               00056800
//         PARM=('BCM','000','BCM000JR82644 PSI9SS',' ',)               00056900
//*                                                                     00057000
//PI601765 DD DUMMY                                                     00057100
//*                                                                     00057200
//ZMG001A1 DD DSN=MXCP.ZM.FIX.SIN.D1.EBCM.ZMJCPD09,                     00057300
...
//*            PARA BANCA PATRIMONIAL (FONDOS DE FONDOS)               *00059000
//**********************************************************************00059100
//PJC09P10 EXEC PGM=ZM4DJ193,COND=(4,LT),                               00059200
//         PARM=('BCM','000','BCM000JR82644 PSI9SS',' ',)               00059300
//*                                                                     00059320
//PI601765 DD DUMMY                                                     00059330
//*                                                                     00059400
//ZMJ193P1 DD DSN=MXCP.ZM.FIX.SIN.D2.EBCM.ZMJCPD09,                     00059500
...
//**********************************************************************00061400
//PJC09P09 EXEC PGM=IKJEFT01,COND=(4,LT)                                00061500
//*                                                                     00061600
//PI601765 DD DUMMY                                                     00061700
//*                                                                     00061800
//ZMJ194P1 DD DSN=MXCP.ZM.FIX.SIN.D2.EBCM.ZMJCPD09,DISP=SHR             00061900
//ZMJ274P1 DD DSN=MXCP.ZM.FIX.SIN.D1.EBCM.ZMJCPD09,DISP=SHR             00062000
...
//ZMJ274R1 DD DSN=MXCP.ZM.FIX.SIN.DF.EBCM.ZMJ274R1,                     00062600
...
//*                                                                     00063700
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJC09T02),DISP=SHR                   00063800
//*                                                                     00065400
//**********************************************************************00065500
//*                        == ZM3DG001 ==                              *00065600
//*                                                                    *00065700
...
//*            EN ARCHIVO                                              *00065900
//**********************************************************************00066000
//PJC09P08 EXEC PGM=ZM3DG001,COND=(4,LT),                               00066100
//         PARM=('&EMP','&SUC','&INT1','&INT2',)                        00066200
//*                                                                     00066300
//PI601765 DD DUMMY                                                     00066400
//*                                                                     00066500
//ZMG001A1 DD DSN=MXCP.ZM.FIX.SIN.D1.ECBP.ZMJCPD09,                     00066600
...
//*                                                                    *00183000
//* OBJETIVO : GRABA LOS PARAMETROS REQUERIDOS EN EL PROGRAMA ZM4DJ194 *00058900
//*            PARA CASA DE BOLSA     (FONDOS DE FONDOS)               *00059000
//**********************************************************************00185000
//PJC09P07 EXEC PGM=ZM4DJ193,COND=(4,LT),                               00220000
//         PARM=('&EMP','&SUC','&INT1','&INT2',)                        00221000
//*                                                                     00221100
//PI601765 DD DUMMY                                                     00221200
//*                                                                     00240000
//ZMJ193P1 DD DSN=MXCP.ZM.FIX.SIN.D2.ECBP.ZMJCPD09,                     00340000
...
//**********************************************************************00391400
//*                        == ZM4DJ194 ==                              *00391500
//*                    (FONDOS DE FONDOS)                              *00391600
//* OBJETIVO : EJECUCION DEL PROGRAMA DE VALUACION DE CASA DE BOLSA    *00391700
//**********************************************************************00391800
//PJC09P06 EXEC PGM=IKJEFT01,COND=(4,LT)                                00391900
//*                                                                     00392000
//PI601765 DD DUMMY                                                     00392100
//*                                                                     00392200
//ZMJ194P1 DD DSN=MXCP.ZM.FIX.SIN.D2.ECBP.ZMJCPD09,DISP=SHR             00392300
//ZMJ274P1 DD DSN=MXCP.ZM.FIX.SIN.D1.ECBP.ZMJCPD09,DISP=SHR             00392400
...
//ZMJ274R1 DD DSN=MXCP.ZM.FIX.SIN.DF.ECBP.ZMJ274R1,                     00393001
...
//*                                                                     00394100
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJC09T02),DISP=SHR                   00394200
//*                                                                     00394300
//**********************************************************************
//*                    -- ICEGENER  --                                 *
//*                (FONDOS DE FONDOS)                                  *
...
//*            BANCA PATRIMONIAL (FONDOS DE FONDOS)                    *
//**********************************************************************
//PJC09P04 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMJ203P1 DD DSN=MXCP.ZM.FIX.SIN.D1.EBCM.ZMJCPD09,DISP=SHR
...
//*                        (FONDOS NORMALES)                           *
//**********************************************************************
//PJC09P03 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMJ202P1 DD DSN=MXCP.ZM.FIX.SIN.D1.ECBP.ZMJCPD09,DISP=SHR
...
//****************************************************************
//PJC09P01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXVDF_IN_SEP_OK WDATE',
//         COND=(4,LT)
...
//*                                                                     00394300
//********************************************************************* 00379900
//** PEND         FIN DEL PROCEDIMIENTO ZMJCPD09                       *00380000
//********************************************************************* 00390000
