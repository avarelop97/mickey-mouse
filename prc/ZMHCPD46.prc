...
//*                                                                    *00140000
//* PROCESO        :  CBHCND46 EJECUTA AFECTACION DEL BLOQUE 6         *00150025
...
//*  PHC46P03     GRABA EN UN ARCHIVO SECUENCIAL.                      *00489127
//**********************************************************************00489300
//*                     ====  INICIO DE    ====                        *00489400
//*                     ====  CAPITALES    ====                        *00489500
//**********************************************************************00489600
...
//*                                                                     00490000
//ZMG001A1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMHCPD46,               00491038
...
//**********************************************************************
//PHC46P02 EXEC PGM=IEFBR14,COND=(4,LT)
//ARCHIVO   DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMHCPD46.LOG,
...
//*                -- ZM4DH516 -- BLOQUE 6 --                          *
//**********************************************************************
//PHC46P01 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMH516A1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMHCPD46,DISP=SHR
//ZMH516L1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMHCPD46.LOG,DISP=MOD
//ZMH516E1 DD DSN=SIVA.MDC.FIX.E&EMP..BLOQUE6,DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//SYSDBOUT DD SYSOUT=*
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHC46T01),DISP=SHR
//*
