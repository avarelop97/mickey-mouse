...
//*                                                                    *00009000
//*   PROCEDIMIENTO    : ZMULPE13                                      *00009100
//*                                                                    *00009200
//*   OBJETIVO         : REPORTE DE BAJAS DEL MES                      *00009300
//*                      ( OPCION 225 )                                *00009400
//*                                                                    *00009500
...
//*--------------------------------------------------------------------*00010900
//PUL13P04 EXEC PGM=ZM3DG001,                                           00011000
...
//*                                                                     00011900
//ZMG001A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMULPE13,               00012000
...
//*                                                                     00014100
//*--------------------------------------------------------------------*00014200
//* PROGRAMA: ZM4MGE67                                                 *00014300
//* FUNCION:  REPORTE DE BAJAS DEL MES                                 *00014400
//*--------------------------------------------------------------------*00014500
//PUL13P03 EXEC PGM=IKJEFT01,COND=(4,LT)                                00014600
//*                                                                     00014700
//ZMGE67A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMULPE13,DISP=SHR       00012000
//*                                                                     00014900
//ZMGE67R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00015000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZUL13T01),DISP=SHR                   00015800
//*
//*--------------------------------------------------------------------*00020200
//*               AVISO EN CASO DE ERROR A LA CONSOLA                  *00020300
//*--------------------------------------------------------------------*00020400
//PUL13P02 EXEC PGM=MAILOPER,COND=(4,GE,PUL13P03),                      00020500
//         PARM=('/ATENCION.AVISAR A PRODUCCION QUE PROCESO ',          00020600
//             'SIVAXAUT(ZMULPE13)TERMINO MAL.CONTESTAR SI',            00020700
//             'PARA TERMINAR')                                         00020800
//*                                                                     00018400
//*--------------------------------------------------------------------*00021000
//*            CONDICION PARA SER TOMADA POR CONTROL-D                 *00021100
//*--------------------------------------------------------------------*00021200
//PUL13P01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXAUT_IN_OK WDATE',       00021300
//         COND=(4,LT)                                                  00021400
