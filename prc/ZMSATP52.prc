...
//** PROCESO        :  ZMSATP52
//**
//** OBJETIVO       :  FORMATEA KARDEX OTROS SI MES DICIEMBRE SAT MUV.
//**
...
//ZMG001A1 DD DSN=MXCP.ZM.FIX.EBCM.ZMSATP52,
...
//ARCHIVO   DD DSN=MXCP.ZM.FIX.MIS.MUVMD.DIC,
...
//****************************************************************
//ZMSATP01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXS52_IN_OK WDATE',
//         COND=(5,LT)
