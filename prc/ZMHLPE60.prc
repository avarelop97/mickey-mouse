...
//*                RIAS  PARA BANXICO DIA OPERACION P04 - 1            *
//*                                                                    *
...
//*  PHL60P29     EN ARCHIVO SECUENCIAL.                               *
//*                                                         ZM3DG001   *
//*-------------------------------------------------------------------**
//PHL60P29 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//*
//ZMG001A1 DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZMHLPE60,
...
//*  PHL60P28     MERCADO.                                             *00040000
//*                                                         ZM4DHB01   *00040000
//**********************************************************************00060000
//PHL60P28 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMHB01A1 DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZMHLPE60,DISP=SHR
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL60T28),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO:  3     GENERA ARCHIVO CON LAS OPERACIONES AUTOMATICAS DE    *00030000
//*  PHL60P27     COMPRAS Y VENTAS DE MERCADO DE DINERO.               *00040000
//*                                                         ZM4DHB02   *00040000
//**********************************************************************00060000
//PHL60P27 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMHB02A1 DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZMHLPE60,DISP=SHR
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL60T27),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO:  4     GENERA ARCHIVO DE OPERACIONES DE COMPRAS Y VENTAS.   *00030000
//*  PHL60P26     CONTRATOS DE SOCIEDADES DE INV.           ZM4DHB03   *00040000
//**********************************************************************00060000
//PHL60P26 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMHB03A1 DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZMHLPE60,DISP=SHR
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL60T26),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 5   SORT QUE REALIZA LA ELIMINACIóN DE LO ENCABEZADOS DEL   *00030000
//*            ARCHIVO DE OPERACIONES PENDIENTES A PLAZO             *
//*  PHL60P25                                                ICEMAN    *00040000
//**********************************************************************00060000
//PHL60P25 EXEC PGM=ICEMAN,COND=(4,LT)
//SORTIN   DD DSN=MXCP.ZM.GDGD.VAL.PZODEP(-1),DISP=SHR
...
//*
//SYSOUT   DD SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL60T25),DISP=SHR                   00183716
//*
//**********************************************************************00010000
...
//*  PHL60P24                                                          *00040000
//**********************************************************************00060000
//PHL60P24 EXEC PGM=IKJEFT01,COND=(4,LT)                                00070000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL60T24),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO:  7     DEPURA ARCHIVO DE OPERACIONES DE COMPRAS Y VENTAS, Y *00030000
//*  PHL60P23     ORDENA POR SERIE Y NO. TITULOS.           SORT       *00040000
//*                            ( CONCATENA ) ORDENA POR DEP            *00040000
//**********************************************************************00060000
//PHL60P23 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL60T23),DISP=SHR
//*
//**********************************************************************
//*  PASO:  8     REALIZA FORMATEO DE ARCHIVO INDEVAL PARA LA COLUMNA  *
//*  PHL60P22     DE TITULOS.                               ZM3DHB01   *
//**********************************************************************
//PHL60P22 EXEC PGM=ZM3DHB01,COND=(4,LT)
//*
...
//*  PHL60P21     ORDENA POR SERIE Y NO. TITULOS.           ICEMAN     *00040000
//*                            ( CONCATENA )                           *00040000
//**********************************************************************00060000
//PHL60P21 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL60T21),DISP=SHR
//*
//**********************************************************************
//*  PASO: 10     REALIZA FORMATEO DE ARCHIVO INDEVAL AGRUPANDO POR NO.*
//*  PHL60P20     DE TAREA(V) DEJANDO UN SOLO REGISTRO CON LA SUMARTORIA
//*                                                         ZM3DHB02   *
//**********************************************************************
//PHL60P20 EXEC PGM=ZM3DHB02,COND=(4,LT)
//*
...
//*  PHL60P19     ORDENA POR SERIE Y NO. TITULOS.            ICEMAN    *00040000
//*                            ( CONCATENA )                           *00040000
//**********************************************************************00060000
//PHL60P19 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL60T19),DISP=SHR
//*
//**********************************************************************
//*  PASO:  12    REALIZA FORMATEO DE ARCHIVO INDEVAL PARA LOS CASOS X *
//*  PHL60P18     RALIZANDO SUMATORIA Y DEJANDOLA EN UN RGISTRO.       *
//*                                                         ZM3DHB03   *
//**********************************************************************
//PHL60P18 EXEC PGM=ZM3DHB03,COND=(4,LT)
//*
...
//*  PHL60P17     TULOS.                                     ICEMAN    *00040000
//*                         ( DEPOSITOS  INDEVAL )                     *00020000
//**********************************************************************00060000
//PHL60P17 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL60T17),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 14     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00030000
//*  PHL60P16     OPERACIONES.                              ZM4DHB04   *00040000
//*                               ( DEPOSITOS )                        *00020000
//**********************************************************************00060000
//PHL60P16 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL60T16),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 15     REALIZA ORDENAMIENTO DEL REPORTE POR SERIE Y NO. TI- *00030000
//*  PHL60P15     TULOS.                                     ICEMAN    *00040000
//*                         ( DEPOSITOS  INDEVAL )                     *00020000
//**********************************************************************00060000
//PHL60P15 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL60T15),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 16     GENERA ARCHIVO CON REGISTROS QUE NO TIENEN CONTRAPAR-*00030000
//*  PHL60P14     TE, PARA INICIAR UNA NUEVA BUSQUEDA.       ICEMAN    *00040000
//*                               ( RETIROS )                          *00020000
//**********************************************************************00060000
//PHL60P14 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL60T14),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 17     REALIZA ORDENAMIENTO DE ARCHIVO YA FORMATEADO PARA   *00030000
//*  PHL60P13     RETIROS.                                   ICEMAN    *00040000
//*                           ( RETIROS INDEVAL )                      *00020000
//**********************************************************************00060000
//PHL60P13 EXEC PGM=ICEMAN,COND=(4,LT)
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.VAL.MOVTOS1.INDEVALZ,DISP=SHR
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL60T13),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 18     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00030000
//*  PHL60P12     OPERACIONES.                              ZM4DHB04   *00040000
//*                              ( RETIROS )                           *00020000
//**********************************************************************00060000
//PHL60P12 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL60T12),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 19     GENERA ARCHIVO CON REGISTROS QUE NO TIENEN CONTRAPAR-*00030000
//*  PHL60P11     TE, PARA UNA SEGUNDA PASADA                ICEMAN    *00040000
//**********************************************************************00060000
//PHL60P11 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL60T11),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 20     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00030000
//*  PHL60P10     OPERACIONES.                              ZM4DHB06   *00040000
//*                              ( DEPOSITOS )                         *00020000
//**********************************************************************00060000
//PHL60P10 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL60T10),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 21     GENERA ARCHIVO CON REGISTROS QUE SI TIENEN CONTRAPAR-*00030000
//*  PHL60P09     TE.                                                  *00040000
//*                                                          ICEMAN    *00020000
//**********************************************************************00060000
//PHL60P09 EXEC PGM=ICEMAN,COND=(4,LT)
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZM4DHB04.DEPRET,DISP=SHR
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL60T09),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 22     GENERA ARCHIVO CON REGISTROS QUE NO TIENEN CONTRAPAR-*00030000
//*  PHL60P08     TE, PARA UNA SEGUNDA PASADA                ICEMAN    *00040000
//*                            ( RETIROS )                             *00020000
//**********************************************************************00060000
//PHL60P08 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL60T08),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 23     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00030000
//*  PHL60P07     OPERACIONES.                              ZM4DHB06   *00040000
//*                              ( RETIROS )                           *00020000
//**********************************************************************00060000
//PHL60P07 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL60T07),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 24     CONCATENA ARCHIVOS PARA ENVIAR A BANXICO.            *00030000
//*  PHL60P06                                                ICEMAN    *00040000
//**********************************************************************00060000
//PHL60P06 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL60T06),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 25  CONCATENA ARCHIVOS PARA ENVIAR A BANXICO.               *00030000
//*  PHL60P05                                                          *00040000
//**********************************************************************00060000
//PHL60P05 EXEC PGM=IEBGENER,COND=(4,LT)                                00100800
...
//**********************************************************************00010000
//PHL60P04 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMLE11A1 DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZMHLPE60,DISP=SHR
//*
//SYSTSPRT DD  SYSOUT=*
//SYSPRINT DD  SYSOUT=*
//SYSOUT   DD  SYSOUT=*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD  DSN=ZIVA.ZME.CONTROL(ZHL60T04),DISP=SHR
//**********************************************************************00060000
