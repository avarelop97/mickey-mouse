//ZMPECN11  PROC                                                        00010000
//**********************************************************************00020000
//* SISTEMA        :  SISTEMA INTEGRAL DE VALORES (S.I.V.A.).          *00030000
//* OBJETIVO       :  GENERA ARCHIVO MENSUAL DE VALORES EN GARANTIA.   *00040000
//* JCL            :  CBHECN11.                                        *00070000
//* CORRE ANTES DE :  SIVAXC11 (OPCION EN LINEA H51-11).               *00080000
...
//*                                                                     00300000
//**********************************************************************00620000
//*  PASO: 01  GENERA ARCHIVO MENSUAL DE VALORES EN GARANTIA.          *00630000
//*  PROGRAMA: ZM4MH014                                                *00640000
//**********************************************************************00650000
//PHC11P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00660000
//*SWF@01-INI                                                           00670000
//*ZMH00AR1 DD SYSOUT=*                                                 00671000
//ZMFH0101 DD DSN=MXCP.ZM.FIX.CNBV.GARANTIA,                            00672000
//            DISP=(NEW,CATLG,DELETE),                                  00673000
//            SPACE=(CYL,(20,10),RLSE),                                 00674000
//            DCB=(DSORG=PS,RECFM=FB,LRECL=146,BLKSIZE=0),              00675000
//            UNIT=3390                                                 00676000
//*SWF@01-FIN                                                           00677000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHECNT11),DISP=SHR                   00740000
//*                                                                     00750000
//*********** FIN ******************************************************00760000
