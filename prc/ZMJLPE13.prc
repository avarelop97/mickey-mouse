...
//*  PJL13P03     EN ARCHIVO SECUENCIAL.                               *00040000
//*                                                         ZM3DG001   *00020000
//**********************************************************************00060000
//PJL13P03 EXEC PGM=ZM3DG001,REGION=0M,
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLPE13,
...
//**********************************************************************00060000
//PJL13P02 EXEC PGM=IKJEFT01,REGION=0M,COND=(4,LT)
//*
//PI601765  DD DUMMY
//*
//ZMGG86A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLPE13,DISP=SHR
//*
...
//*                                                       ZM4DG001     *00020000
//**********************************************************************00060000
//PJL13P01 EXEC PGM=IKJEFT01,REGION=0M,
//         COND=(20,NE,PJL13P02)
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLPE13,DISP=SHR
//*
//SYSTSPRT DD SYSOUT=*,DCB=BLKSIZE=0
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
...
//****************************************************************
//PJL13P00 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXGT1_IN_SEP_OK WDATE',
//         COND=(4,LT)
...
//**********************************************************************00010000
//*                  F I N   Z M J L P E 1 3                           *00040000
//**********************************************************************00060000
