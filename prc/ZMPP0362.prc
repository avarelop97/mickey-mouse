...
//*--------------------------------------------------------------------*
//ZMP36290 EXEC PGM=IEFBR14
//*
//S1000001 DD DSN=MXCP.ZM.FIX.HORIZON.SZMDT623.SAL.D&FECHA,
...
//*--------------------------------------------------------------------*
//ZMP36280 EXEC PGM=ZM3CG362,COND=(4,LT)
//*
//ENTRADA1 DD DSN=MXCP.ZM.FIX.HORIZON.SZMDT623.SAL.D&FECHA,
//            DISP=SHR
//*
//SALIDA01 DD DSN=MXCP.ZM.FIX.GEVE.F&FECHA..E3621823,
...
//*--------------------------------------------------------------------*
//ZMP36270 EXEC PGM=ICEMAN,COND=(4,LT)
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.HORIZON.SZMDT623.SAL.D&FECHA,
//            DISP=SHR
//*
//ARCH1    DD DSN=MXCP.ZM.FIX.SORT.SZMDT623.SAL.F&FECHA,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(1000,500),RLSE),UNIT=3390,
//            DCB=(LRECL=133,RECFM=FB,BLKSIZE=0,DSORG=PS)
//*
//ARCH2    DD DSN=MXCP.ZM.FIX.BCJP0362.CIFRAS.F&FECHA,
...
//*--------------------------------------------------------------------*
//ZMP36260 EXEC PGM=ZM3C0362,COND=(4,LT)
//*
//ENTRADA1 DD DSN=MXCP.ZM.FIX.SORT.SZMDT623.SAL.F&FECHA,
//            DISP=SHR
//*
//SALIDA01 DD DSN=MXCP.ZM.FIX.FORM.SZMDT623.SAL.F&FECHA,
//            DISP=(NEW,CATLG,DELETE),
...
//* CIFRAS DE CONTROL
//*
//SALIDA02 DD DSN=MXCP.ZM.FIX.BCJP0362.CCTRL.F&FECHA,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(500,250),RLSE),UNIT=3390,
...
//*--------------------------------------------------------------------*
//ZMP36250 EXEC PGM=ICEMAN,COND=(4,LT)
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.FORM.SZMDT623.SAL.F&FECHA,
//           DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.FIX.HORIZON1.SZMDT623.SAL.D&FECHA,
//            DISP=(NEW,CATLG,DELETE),
...
//*
//SYSOUT   DD SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZMP36200),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO    : ZMP36240.                                                *
//* PROGRAMA: IOACND.                                                  *
...
//*--------------------------------------------------------------------*
//ZMP36240 EXEC  PGM=IOACND,COND=(4,LT),
//         PARM='ADD COND MX2CRX_BCJP036200 &FEC'
