...
//*                                                                    *
//**********************************************************************
//PHL77P03 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..COLOCDE,
...
//*                                                                    *
//**********************************************************************
//PHL77P02 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMHW72A1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..COLOCDE,DISP=SHR
//*
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
...
//*
//ZMHW71A1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..COLOCDE,DISP=SHR
...
//*            DE COLOCACIONES.                                        *
//**********************************************************************
//PHL77P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVAXCED_IN_SEP_OK  WDATE',
//         COND=(4,LT)
//PI601765  DD DUMMY
//*
