...
//SYSUT2   DD DSN=MXCP.ZM.FIX.EBCM.SALDOS.FATDIVS,
...
//*
//ZMCFDIA1 DD DSN=MXCP.ZM.FIX.EBCM.SALDOS.FATDIVS,DISP=SHR
//*
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
...
//SYSUDUMP DD DUMMY
//*
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHCFAT12),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : PHA02P04.                                             *
...
//SORTIN   DD DSN=MXCP.ZM.FIX.EBCM.SALDOS.FATDIVS,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.FIX.EBCM.SALDOS.FATDIVS.FS,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=325,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,SPACE=(CYL,(300,150),RLSE)
//SYSOUT   DD SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHCFAT13),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : PHA02P03.                                             *
...
//SORTIN   DD DSN=MXCP.ZM.FIX.EBCM.SALDOS.FATCTOS,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.FIX.EBCM.SALDOS.FATCTOS.FS,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=34,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,SPACE=(CYL,(300,150),RLSE)
//SYSOUT   DD SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHCFAT14),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : PHA02P02.                                             *
//* UTILERIA   :                                                       *
//* OBJETIVO   : GENERA ARCHIVO FATCA SAFATCPR. PAGOS REPORTADOS.      *
//*--------------------------------------------------------------------*
//PHA02P02 EXEC PGM=ZM3EFA22,COND=(4,LT)
//*
//ZM3ECE01 DD DSN=MXCP.ZM.FIX.EBCM.SALDOS.FATCTOS.FS,DISP=SHR
//ZM3ECE02 DD DSN=MXCP.ZM.FIX.EBCM.SALDOS.FATDIVS.FS,DISP=SHR
//FDSALIDA DD DSN=MXCP.ZM.FIX.EBCM.SALDOS.SFATCPR,
//            DISP=(NEW,CATLG,DELETE),
...
//            UNIT=3390,SPACE=(CYL,(300,150),RLSE)
//SYSOUT   DD SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHCFAT16),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : PHA02P00.                                             *
//* UTILERIA   : IEBGENER.                                             *
