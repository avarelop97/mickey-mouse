...
//* PROCESO  : ZMJLPC46.                                               *
//* OBJETIVO : SUBMITIDOR OPC 5 REPROCESO COSTO FISCAL BP (SOCIEDADES) *
//* REALIZO  : GESFOR.                                                 *
//* FECHA    : ENERO 2015.                                             *
//*--------------------------------------------------------------------*
//*--------------------------------------------------------------------*
...
//*---------------------------------------------------------------------
//ZMPC4602 EXEC PGM=ZM3DG001,PARM=('&EMP','&SUC','&INT1','&INT2',)
//*
//PI601765  DD DUMMY
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMJLPC46,
...
//*           EN ARCHIVO SECUENCIAL.                                   *
//*---------------------------------------------------------------------
//ZMPC4601 EXEC PGM=CTMCND,PARM='ADD COND CBHCND39_IN_OK WDATE',
//         COND=(4,LT)
