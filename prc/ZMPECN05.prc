//ZMPECN05  PROC                                                        00010000
//**********************************************************************00020000
//* SISTEMA        :  SISTEMA INTEGRAL DE VALORES (S.I.V.A.).          *00030000
//* OBJETIVO       :  GENERA ARCHIVO MENSUAL DE CLIENTES VIGENTES.     *00040000
//* JCL            :  CBHECN05.                                        *00070000
//* CORRE ANTES DE :  SIVAXCN5 (OPCION EN LINEA H51-5).                *00080000
...
//* ------- ------- ---------- ----------------------------------------*00124000
//* SWF@01  XM09412 21-12-2010 SE MODIFICA LA SALIDA DEL PASO PHC05P01 *00125000
...
//*                                                                     00300000
//**********************************************************************00620000
//*  PASO: 01  GENERA ARCHIVO MENSUAL DE CLIENTES VIGENTES.            *00630000
//*  PROGRAMA: ZM4MH008                                                *00640000
//**********************************************************************00650000
//PHC05P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00660000
//*SWF@01-INI                                                           00670000
//*ZMH00AR1 DD SYSOUT=*                                                 00671000
//ZMFH0107 DD DSN=MXCP.ZM.FIX.CNBV.CTESVIGE,                            00672000
//            DISP=(NEW,CATLG,DELETE),                                  00673000
//            SPACE=(CYL,(20,10),RLSE),                                 00674000
//* FS-1.0.0-01-I                                                       00674100
//*********** DCB=(DSORG=PS,RECFM=FB,LRECL=446,BLKSIZE=0),              00675000
//*           DCB=(DSORG=PS,RECFM=FB,LRECL=479,BLKSIZE=0),              00675010
//*@DGCM01-->I                                                          00674100
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHECNT05),DISP=SHR                   00740000
//*                                                                     00750000
//*********** FIN ******************************************************00760000
