//ZMUEPE03 PROC EMP=,SUC=,INT1=,INT2=
//**********************************************************************
...
//*                                                                    *
//* PROCESO        :  SIVAXA03 (SUBMITIDOR)                            *
//*                   ZMUEPE03 (PROCEDIMIENTO)                         *
//*                                                                    *
...
//*                        == CTMCND   ==                              *
//*                                                                    *
//*OBJETIVO : ACTIVA LA CONDICION EN CONTROLM PARA QUE CORRA CBUFCM05  *
//*********************************************************************
//PUE03P01 EXEC PGM=CTMCND,COND=(4,LT),
//         PARM='ADD COND    SIVAXA03_IN     &INT2'
//*
...
//*
//*********************************************************************
//** PEND         FIN DEL PROCEDIMIENTO ZMUEPE03                       *
//*********************************************************************
