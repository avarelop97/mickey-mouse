...
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.EBTR.SELLOMDC.REP,DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.FIX.EBTR.CFDI.SELLOS.REP,
...
//*                                                                     01153001
//SELLOS   DD DSN=MXCP.ZM.FIX.EBTR.CFDI.SELLOS.REP,DISP=SHR
//*
...
//*                                                                     01155001
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHCBTR2A),DISP=SHR                   01230041
//*
//*====================================================================*
//* PASO     : ZHDI2701                                                *
//* PROGRAMA : IKJEFT01/ZM4CFI05                                       *
...
//SELLOS   DD DSN=MXCP.ZM.FIX.EBTR.CFDI.SELLOS.REP,DISP=SHR
//*
//ADMITIVO DD DSN=MXCP.ZM.FIX.EBTR.CFDI.ADMMEDC.REPR,DISP=SHR
//*
//SYSTSPRT DD SYSOUT=*                                                  01170038
//SYSPRINT DD SYSOUT=*                                                  01180038
//SYSOUT   DD SYSOUT=*                                                  01190038
...
//SYSUDUMP DD DUMMY                                                     01220000
//*                                                                     01155001
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHCBTR27),DISP=SHR                   01230041
//*
