...
//* ----------- --------- ------- ------------------------------------ *
//*   @DGCM01    XMZ8533  12OCT18 SE AGREGA DESCARGA PARAM P/REPORTE   *
...
//*--------------------------------------------------------------------*
//ZFM21T10 EXEC PGM=IKJEFT01
//*
//ZM10FMS1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML24.QUI,
...
//SYSDBOUT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZFM21T10),DISP=SHR
//*
//*@DGCM01-I
//*--------------------------------------------------------------------*
//* PASO       : ZFM21T09.                                             *
...
//*--------------------------------------------------------------------*
//ZFM21T09 EXEC PGM=ADUUMAIN,COND=(4,LT),
//         PARM='MXP1,ZFM21T09,NEW,,MSGLEVEL(1)'
//STEPLIB  DD DSN=BMC.DB2.MXP1.LOAD,DISP=SHR
//         DD DSN=LDB2MXP1.DBP1.SDSNEXIT,DISP=SHR
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXCP.ZM.FIX.BCFMLD21.UNLOAD.PARAM,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
...
//*--------------------------------------------------------------------*
//ZFM21T08 EXEC PGM=ZM3FML43,COND=(4,LT)
//*
//E1DQENT1 DD DSN=MXCP.ZM.FIX.BCFMLD21.UNLOAD.PARAM,
//            DISP=SHR
//*
