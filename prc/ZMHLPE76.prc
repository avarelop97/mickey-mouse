...
//* NO ACTUALIZA TABLAS.                                              *
//*-------------------------------------------------------------------*
//PHL76P12 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//ZMG001A1 DD DSN=MXCP.ZM.TMP.VAL.E&EMP..S&SUC..OPC957,
...
//*-------------------------------------------------------------------*
//PHL76P11 EXEC PGM=IKJEFT01,COND=(4,LT)
...
//             ' PROCESO CBHLNE76 TERMINO MAL.CONTESTAR SI',            00680000
...
//**********************************************************************
//PHL76P01 EXEC PGM=CTMCND,PARM='ADD COND SIVAXVA1_IN_PR_OK WDATE',
//         COND=(4,LT)
