...
//*--------------------------------------------------------------------*
//ZFM12T10 EXEC PGM=IKJEFT01
//*
//ZM10FMS1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML10.MEN,
...
//SYSDBOUT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZFM12T10),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : ZFM12T15.                                             *
...
//*--------------------------------------------------------------------*
//ZFM12T15 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZM15FME1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML10.MEN,
//            DISP=SHR
//*
...
//*--------------------------------------------------------------------*
//ZFM12T20 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZM20FME1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML10.MEN,
//            DISP=SHR
//*
//ZM20FMS1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML20.REPTXS.MEN,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
