...
//*--------------------------------------------------------------------*
//ZMNE1902 EXEC PGM=ADUUMAIN,                                           00385600
//         PARM='MXP1,ZMNE1902,NEW,,MSGLEVEL(1)'                        00385700
//*                                                                     00385800
...
//*                                                                     00386200
//SYSREC   DD DSN=MXCP.ZM.FIX.EBCM.ZMDT884.SELLOS,                      00386300
...
//*                                                                     00387200
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZMNE1902),DISP=SHR                   00387300
//*--------------------------------------------------------------------*
//*   OBJETIVO: VALIDA SI LA DESCARGA SE GENERO EN VACIO               *
//*--------------------------------------------------------------------*
//ZMNE1901 EXEC PGM=ICEMAN,COND=(04,LT)
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.EBCM.ZMDT884.SELLOS,DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.TMP.EBCM.ZMDT884.SELLOS,
//            DISP=(NEW,PASS),
...
//*--------------------------------------------------------------------*
// IF  ZMNE1901.RC EQ 00 THEN
//ZMDB5100 EXEC PGM=CTMCND,PARM='ADD COND BCUENE09_SUS_OK WDATE',       00395100
//         COND=(4,LT)                                                  00395200
//*                                                                     00395300
