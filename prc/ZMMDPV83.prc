...
//SORTOUT  DD DSN=MXCP.ZM.TMP.ZM4DU852.POZOBG.SORT,
...
//SYSTSPRT DD SYSOUT=*
//ZMPOZO02 DD DSN=MXCP.ZM.TMP.ZM4DU852.POZOBG.SORT,DISP=SHR
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//SYSDBOUT DD SYSOUT=*
//SYSABOUT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.FIX.ZM4DU852.POZOBG,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECO.INTFAZ.POZOS1.F&FECHA,
//        DISP=(NEW,CATLG,DELETE),
//        SPACE=(CYL,(40,20),RLSE),
...
//ZMU856T1 DD DSN=MXCP.ZM.TMP.ECO.INTFAZ.POZOS1.F&FECHA,DISP=SHR
