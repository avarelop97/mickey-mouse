...
//* PROCESO      : ZMPDREPA.                                           *
//*                                                                    *00070001
//* PERIODICIDAD : PROCESO DIARIO APETICION DE USUARIO.                *
//*                                                                    *00070001
...
//*
//SYSREC   DD DSN=MXC&AMB..ZM.FIX.BCJDREPA.DESCA622.F&FECHA.,
...
//*
//SORTIN   DD DSN=MXC&AMB..ZM.FIX.BCJDREPA.DESCA622.F&FECHA.,
//            DISP=SHR
//*
//SORTOUT  DD DSN=MXC&AMB..ZM.FIX.BCJDREPA.ORDEN622.F&FECHA.,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=3390,SPACE=(CYL,(100,50),RLSE),
...
//*
//ZME533E1 DD DSN=MXC&AMB..ZM.FIX.BCJDREPA.DESCA622.F&FECHA.,
//            DISP=SHR
//*
//ZME533S1 DD DSN=MXC&AMB..ZM.FIX.BCJDREPA.REPOP533,
//            DISP=(NEW,CATLG,DELETE),
...
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXC&AMB..ZM.FIX.BCJDREPA.DESCASIM.F&FECHA.,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,SPACE=(CYL,(100,50),RLSE)
//*
...
//*
//ZME533E1 DD DSN=MXC&AMB..ZM.FIX.BCJDREPA.DESCASIM.F&FECHA.,
//            DISP=SHR
//*
//ZME533S1 DD DSN=MXC&AMB..ZM.FIX.BCJDREPA.REPOP534,
//            DISP=(NEW,CATLG,DELETE),
...
//*
//E1ZM622  DD DSN=MXC&AMB..ZM.FIX.BCJDREPA.ORDEN622.F&FECHA.,
//            DISP=SHR
//*
//S1ZMUS1  DD DSN=MXC&AMB..ZM.FIX.BCJDREPA.REPOP218,
//            DISP=(NEW,CATLG,DELETE),
