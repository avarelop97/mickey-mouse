...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//ZMG001A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..ZMJFPD08,
...
//ZMHA28P1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..ZMJFPD08,DISP=SHR
...
//ZMJ803A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..ZMJFPD08,DISP=SHR
//SYSTSPRT DD SYSOUT=*,DCB=BLKSIZE=0
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//SYSDBOUT DD SYSOUT=*
