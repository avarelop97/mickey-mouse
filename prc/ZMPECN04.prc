//ZMPECN04  PROC                                                        00010000
//**********************************************************************00020000
//* SISTEMA        :  SISTEMA INTEGRAL DE VALORES (S.I.V.A.).          *00030000
//* OBJETIVO       :  GENERA ARCHIVO MENSUAL DE MOVIMIENTOS NO AFECTA  *00040000
//*                   BANCOS.                                          *00050000
//* JCL            :  CBHECN04.                                        *00070000
//* CORRE ANTES DE :  SIVAXCN4 (OPCION EN LINEA H51-4).                *00080000
...
//* ------- ------- ---------- ----------------------------------------*00124000
//* SWF@01  XM09412 21-12-2010 SE MODIFICA LA SALIDA DEL PASO PHC04P01 *00125000
...
//**********************************************************************00150000
//PHC04P02 EXEC PGM=ZM3DG001,                                           00160000
...
//*                                                                     00300000
//**********************************************************************00620000
//*  PASO: 01  GENERA ARCHIVO MENSUAL DE MOVIMIENTOS NO AFECTA BANCOS. *00630000
//*  PROGRAMA: ZM4MH007                                                *00640000
//**********************************************************************00650000
//PHC04P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00660000
//*SWF@01-INI                                                           00670000
//*ZMH00AR1 DD SYSOUT=*                                                 00671000
//ZMFH0108 DD DSN=MXCP.ZM.FIX.CNBV.NOAFBCO,                             00672000
//            DISP=(NEW,CATLG,DELETE),                                  00673000
//            SPACE=(CYL,(20,10),RLSE),                                 00674000
//            DCB=(DSORG=PS,RECFM=FB,LRECL=130,BLKSIZE=0),              00675000
//            UNIT=3390                                                 00676000
//*SWF@01-FIN                                                           00677000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHECNT04),DISP=SHR                   00740000
//*                                                                     00750000
//*********** FIN ******************************************************00760000
