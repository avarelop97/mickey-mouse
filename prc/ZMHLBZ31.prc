...
//ZMH981A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.ZMHLPE31,DISP=SHR
//*
//ZMH981A2 DD DSN=MXCP.ZM.WKF.VAL.EBCM.SCTD.ARCH,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(DSORG=PS,RECFM=FB,LRECL=80,BLKSIZE=0),
//            UNIT=3390,
//            SPACE=(CYL,(2,1),RLSE)
//ZMH981A3 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.ZM6RG075,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=569,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
//ZMH981A4 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.ZM6RH978,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=143,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
//ZMH981A5 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.ZM6RH979,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=440,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
//ZMH981A6 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.ZM6RH995,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=584,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
//ZMH981A7 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.ISRBON,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=020,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
//ZMH981A8 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.VARCOMP,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=044,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
//ZMH981A9 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.DIVEFE,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=440,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
//*
//ZMH981AA DD DSN=MXCP.ZM.FIX.EBCM.DEFI.DIVIDEN,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=955,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
//*
//ZMH981S1 DD DSN=MXCP.ZM.FIX.EBCM.REPD01,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=132,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
//ZMH981S2 DD DSN=MXCP.ZM.FIX.EBCM.REPD02,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=132,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
...
//ZMH980A0 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.ZMHLPE31,DISP=SHR
//ZMH980A1 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.ZM6RG075,DISP=SHR
//ZMH980A2 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.ZM6RH978,DISP=SHR
//ZMH980A3 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.ZM6RH979,DISP=SHR
//ZMH980A4 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.ZM6RH995,DISP=SHR
//ZMH980A5 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.ISRBON,DISP=SHR
//ZMH980A6 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.VARCOMP,DISP=SHR
//ZMH980A7 DD DSN=MXCP.ZM.FIX.EBCM.ARCH.DIVEFE,DISP=SHR
//*
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
...
//*
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.FIX.EBCM.REPD02,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.WKF.EBCM.REPD03,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=132,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,
//            SPACE=(CYL,(4,2),RLSE)
...
//*
//ZMH981A3 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.ZMHLPE31,DISP=SHR
//ZMH981A4 DD DSN=MXCP.ZM.WKF.EBCM.REPD03,DISP=SHR
//ZMH981A5 DD DSN=MXCP.ZM.FIX.EBCM.REPD01,DISP=SHR
//*
...
//ZMH982A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.ZMHLPE31,DISP=SHR
...
//ZMH983A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.ZMHLPE31,DISP=SHR
