...
//** PROCESO        :  ZMSATP37
//**
//** OBJETIVO       :  FORMATEA KARDEX SI MES SEPTIEMBRE SAT MUV.
//**
...
//ZMG001A1 DD DSN=MXCP.ZM.FIX.EBCM.ZMSATP37,
...
//ARCHIVO   DD DSN=MXCP.ZM.FIX.MIS.MUVFI.SEP,
...
//****************************************************************
//ZMSATP01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXS37_IN_OK WDATE',
//         COND=(5,LT)
