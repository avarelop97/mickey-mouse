//ZMLPCD06 PROC                                                         00010001
//**********************************************************************00020000
//* OBJETIVO : GENERA EL ARCHIVO CORRESPONDIENTE A US PERSON           *00060001
...
//*                                                                     00191000
//**********************************************************************00200000
//* PASO     : PHF06P01                                                 00220001
//* PROGRAMA : ZM4DFA02 / IKJEFT01                                      00230001
//* DESCRIPC : GENERA ARCHIVO CON LOS REGISTROS US PERSON               00240001
//**********************************************************************00270000
//PHF06P01 EXEC PGM=IKJEFT01                                            00490001
//*                                                                     00500000
//ZMOH76A1 DD  DSN=MXCP.ZM.FIX.FAT.USPER.D&FECHA,                       00501001
//             DISP=(NEW,CATLG,DELETE),                                 00501100
//             DCB=(LRECL=272,RECFM=FB,BLKSIZE=0,DSORG=PS),             00501200
//*            DCB=(LRECL=256,RECFM=FB,BLKSIZE=0,DSORG=PS),             00501210
...
//*                                                                     00509000
//SYSTSIN  DD  DSN=ZIVA.ZME.CONTROL(ZHC06P01),DISP=SHR                  00510001
//*                                                                     00520000
