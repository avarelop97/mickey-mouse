...
//**********************************************************************00180007
//* PASO       : PNC01P01                                              *00180008
//* OBJETIVO   : COPIA ARCHIVO CARGA DE TABLA YHDTBAN (PDV) PARA       *00180009
//*              OBTENER NIVEL DE CERTIFICACION DE BANQUEROS.          *00180010
//**********************************************************************00180020
//PNC01P01 EXEC PGM=ICEMAN                                              00180030
//SYSPRINT DD SYSOUT=*                                                  00180040
//SYSOUT   DD SYSOUT=*                                                  00180050
//SORTIN   DD DSN=MXBP.YH.FIX.F&FECHA..CARGA.OK,DISP=SHR                00180060
//SORTOUT  DD DSN=MXCP.ZM.FIX.NIVCERT.CARGA.OK,                         00180080
//            DISP=(NEW,CATLG,DELETE),                                  00180090
//            UNIT=3390,                                                00180100
//            DCB=(RECFM=FB,LRECL=070,BLKSIZE=0),                       00180200
//            SPACE=(CYL,(10,5),RLSE)                                   00180300
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZLC01CE1),DISP=SHR                   00180400
//*                                                                     00180500
//**********************************************************************00181600
//*  PASO:  1     ACTUALIZA NIVEL DE CERTIFICACION                     *00380100
//*               ZM4DCE01                                             *00380206
//**********************************************************************00380300
//PNC01P02 EXEC PGM=IKJEFT01                                            00380408
//*                                                                     00380500
//ZMDCE1E1 DD DSN=MXCP.ZM.FIX.NIVCERT.CARGA.OK,DISP=SHR                 00380520
//*                                                                     00380521
//ZMMWC0A1 DD DSN=MXCP.ZM.FIX.NIVCERT.LOGRESP,                          00380608
//            DISP=(NEW,CATLG,DELETE),                                  00380700
//            DCB=(DSORG=PS,LRECL=147,RECFM=FB,BLKSIZE=0),              00380807
...
//SYSTSIN  DD  DSN=ZIVA.ZME.CONTROL(ZLC01CE0),DISP=SHR                  00382208
//*                                                                     00382300
//**********************************************************************00384100
