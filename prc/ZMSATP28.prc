...
//** PROCESO        :  ZMSATP28
//**
//** OBJETIVO       :  FORMATEA SALDOS PROMEDIO PARA SAT MUV.
//**
...
//ZMG001A1 DD DSN=MXCP.ZM.FIX.EBCM.ZMSATP28,
...
//**********************************************************************
//* PROGRAMA:
//* OBJETIVO: GENERA ARCHIVO DE SALDOS PROMEDIO EN VACIO
//**********************************************************************
//*
//ZMSATP02 EXEC PGM=IEFBR14,COND=(4,LT)
//ARCHIVO   DD DSN=MXCP.ZM.FIX.MIS.MUV.SALPROM,
...
//****************************************************************
//ZMSATP01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXS28_IN_OK WDATE',
//         COND=(5,LT)
