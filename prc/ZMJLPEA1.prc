...
//*********************************************************************
//*   SE AGREGA LA EJECUCION A AS400 DE MUV                           *
//*                                                                   *
//*   SE MUVEN PASOS DEL PROGRAMA ZM4DJA02 AL FINAL CON SUS TRANSFER  *
//*   PJLA1P0A(ZM4DJA02)  PJLA7P0B Y PJLA7P0C(TRANSFER) -- ENERO 2013 *
//*                                                                   *
//*********************************************************************
//*                                                                   *
...
//*
//**********************************************************************
//*  PASO: 02     CARGA DE LA TABLA ZMDT703, INFORMACION DE ACCIONES   *
//*               PROPIAS(MISMO DIA) SOCIEDADES DE INVERSION           *
//*  PJD03P22                          SIVA MUV             ZM4DJA01   *
//**********************************************************************
//PJLA1P02 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//*                                    SIVA MUV             ZM4DJA22   *
//**********************************************************************
//PJLA1P0D EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//*                                    SIVA MUV             ZM4DJA23   *
//**********************************************************************
//PJLA1P0E EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//*                                    SIVA MUV             ZM4DJA24   *
//**********************************************************************
//PJLA1P0F EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//*                                    SIVA MUV             ZM4DJA25   *
//**********************************************************************
//PJLA1P0G EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//*                                    SIVA MUV             ZM4DJA26   *
//**********************************************************************
//PJLA1P0H EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//*                                    SIVA MUV             ZM4DJB10   *
//**********************************************************************
//PJLA1P0I EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//*                                    SIVA MUV             ZM4DJB19   *
//**********************************************************************
//PJLA1P0J EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//****************************************************************
//PJLA1P0K EXEC  PGM=CTMCND,PARM='ADD COND CBJLNEAG_IN_OK WDATE',
//         COND=(4,LT)
...
//*                                    SIVA MUV             ZM4DJA02   *
//**********************************************************************
//PJLA1P0L EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//*                PARA QUE SEA TOMADA POR CTL-D                 *
//****************************************************************
//PJLA1P0M EXEC  PGM=CTMCND,PARM='ADD COND CBJLNEB2_IN_OK WDATE',
//         COND=(4,LT)
//STEPLIB  DD DISP=SHR,DSN=SYS3.IOAO.SYSZBBV.TGT.LOAD
//DAPARM   DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.PARM
//         DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.IOAENV
...
//*                PARA QUE SEA TOMADA POR CTL-D                 *
//****************************************************************
//PJLA1P0N EXEC  PGM=CTMCND,PARM='ADD COND CBJLNEA3_IN_OK WDATE',
//         COND=(4,LT)
//STEPLIB  DD DISP=SHR,DSN=SYS3.IOAO.SYSZBBV.TGT.LOAD
//DAPARM   DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.PARM
//         DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.IOAENV
