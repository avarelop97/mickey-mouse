...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXLPR -> PRC ZMJLPD32  * 00110003
//*                                                                   * 00120000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD32P03 EXEC PGM=ZM3DG001,                                           00390003
...
//*  PJD32P02                                               ZM4DHW28   *00560003
//**********************************************************************00570000
//PJD32P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580003
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD32T02),DISP=SHR                   00710003
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  REPORTE DE TITULOS OPERADOS POR CASA DE BOLSA.          *00740000
//*                                                                    *00750000
//*  PJD32P01                                               ZM4EHU48   *00760003
//**********************************************************************00770000
//PJD32P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780003
//*                                                                     00790000
//ZMHW48A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00800000
//*                                                                     00810000
//ZMHW48R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00820002
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD32T01),DISP=SHR                   00900003
//*                                                                     00910000
//**********************************************************************00920002
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930002
//*            REPORTE DE TITULOS OPERADOS POR CASA DE BOLSA.          *00940002
//**********************************************************************00950002
//PJD32P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP32_IN_SEP_OK WDATE',  00960003
//         COND=(4,LT)                                                  00961002
