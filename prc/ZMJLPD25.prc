...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXLPR -> PRC ZMJLPD25  * 00110000
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE       20.-  HECHOS LIQUIDACION, VALOR HOY, 24 Y 48 HRS. * 00170011
//*                       (ZM4DH021)                                  * 00180011
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("T").                            * 00210011
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD25P03 EXEC PGM=ZM3DG001,                                           00390012
...
//*  PJD25P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD25P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD25T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  GENERAR REPORTE DE HECHOS LIQUIDACION, VALOR HOY, 24 Y  *00740011
//*            48 HRS.                                                 *00750011
//*  PJD25P01                                               ZM4DH021   *00760011
//**********************************************************************00770000
//PJD25P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZM4DH211 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00800011
//*                                                                     00810000
//ZM4DH212 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00820012
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD25T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920013
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930013
//*            GENERAR REPORTE DE HECHOS LIQUIDACION, VALOR HOY, 24 Y  *00940013
//*            48 HRS.                                                 *00941013
//**********************************************************************00950013
//PJD25P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP25_IN_SEP_OK WDATE',  00960016
//         COND=(4,LT)                                                  00961015
