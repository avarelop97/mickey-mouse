...
//*               DE MERCADO DE DINERO EN REPORTOS  SEMESTRAL          *
//*  FECHA      : ENERO 2019.                                          *
//**********************************************************************
...
//*
//SYSREC   DD DSN=MXCP.ZM.FIX.CBGPLD51.DESCA107.CANCELA,
...
//SYSUDUMP DD SYSOUT=*
//*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZGL51T06),DISP=SHR
//*
//*@TMRY-I
// IF (&MES=01) THEN
//*
...
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXCP.ZM.FIX.CBGPLD51.DESCA107.COMPRAS,
//            DISP=(NEW,CATLG,CATLG),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            BLKSIZE=0,DSORG=PS
//*
...
//SYSUDUMP DD SYSOUT=*
//*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZGL51T04),DISP=SHR
//*
//*@TMRY-I
// IF (&MES=01) THEN
//*
...
//ARCHDATE DD DSN=MXCP.ZM.FIX.CBGPLD51.DATE.F&FECHA,
...
//*           DE REPORTOS CORRESPONDIENTES A UN SEMESTRE               *
//**********************************************************************
//PGL50P02 EXEC PGM=ZM3PLD04,COND=(4,LT)
//*
//ENTRADA1 DD DSN=MXCP.ZM.FIX.CBGPLD51.DATE.F&FECHA,
//            DISP=SHR
//ENTRADA2 DD DSN=MXCP.ZM.FIX.CBGPLD51.DESCA107.COMPRAS,
//            DISP=SHR
//ENTRADA3 DD DSN=MXCP.ZM.FIX.CBGPLD51.DESCA107.CANCELA,
//            DISP=SHR
//SALIDA1  DD DSN=MXCP.ZM.FIX.REP.OPER.REPO.REPORTO.MDD,
//            DISP=(NEW,CATLG,CATLG),UNIT=3390,
...
//**********************************************************************
//PGL50P01 EXEC PGM=ZM3PLD04,COND=(4,LT),PARM=('ANUAL')
//*
//ENTRADA1 DD DSN=MXCP.ZM.FIX.CBGPLD51.DATE.F&FECHA,
//            DISP=SHR
