...
//*--------------------------------------------------------------------*
//*   PASO    : PHCFDI00                                               *
//*   OBJETIVO: REEMPLAZA # CON X'69' ZM4ECF20                         *
//*--------------------------------------------------------------------*
//*PHCFDI00 EXEC PGM=IKJEFT01
//*
//*ZMCF20A1 DD DSN=MXCP.ZM.FIX.ECBP.CFDI.DIVMEDC.CORR,DISP=SHR
//*ZMCF20A2 DD DSN=MXCP.ZM.FIX.ECBP.CFDI.DIVMEDC.PRES,DISP=SHR
//*ZMCF20A3 DD DSN=MXCP.ZM.FIX.ECBP.CFDI.ACCMEDC.CORR,DISP=SHR
//*ZMCF20A4 DD DSN=MXCP.ZM.FIX.ECBP.CFDI.ACCMEDC.PRES,DISP=SHR
//*ZMCF20A5 DD DSN=MXCP.ZM.FIX.ECBP.CFDI.ADMMEDC.CORR,DISP=SHR
//*ZMCF20A6 DD DSN=MXCP.ZM.FIX.ECBP.CFDI.ADMMEDC.PRES,DISP=SHR
//*
//*SYSTSPRT DD SYSOUT=*
//*SYSPRINT DD SYSOUT=*
//*SYSOUT   DD SYSOUT=*
...
//*SYSABOUT DD DUMMY
//*SYSUDUMP DD DUMMY
//*SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHCF3T00),DISP=SHR
//*
//*--------------------------------------------------------------------*
//*   PASO    : PHCFDI01                                               *
...
//         DD DSN=MXCP.ZM.FIX.ECBP.CFDI.DIVMEDC.PRES,DISP=SHR
...
//         DD DSN=MXCP.ZM.FIX.ECBP.CFDI.ACCMEDC.PRES,DISP=SHR
...
//         DD DSN=MXCP.ZM.FIX.ECBP.CFDI.ADMMEDC.PRES,DISP=SHR
...
//*
//FDSALIDA DD DSN=MXCP.ZM.FIX.ECBP.CFDI.PIPMEDC,
