...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXRBP -> PRC ZMJLPD31  * 00110003
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE       13.-  CPAS. VTAS. DE M. CAPITALES MISMO DIA.      * 00170000
//*                       (ZM4EHU60)                                  * 00180002
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("M").                            * 00210000
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD31P03 EXEC PGM=ZM3DG001,                                           00390003
...
//*  PJD31P02                                               ZM4DHW28   *00560003
//**********************************************************************00570000
//PJD31P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580003
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD31T02),DISP=SHR                   00710003
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  LIQUIDACION DE OPERACIONES DE M. CAPITALES DE CASA DE   *00740000
//*            BOLSA. 24 HRS.                                          *00750002
//*  PJD31P01                                               ZM4EHU60   *00760003
//**********************************************************************00770000
//PJD31P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780003
//*                                                                     00790000
//ZMHV60A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00831002
//*                                                                     00831100
//ZM4V60R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00831202
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD31T01),DISP=SHR                   00900003
//*                                                                     00910000
//**********************************************************************00920002
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930002
//*            LIQUIDACION DE OPERACIONES DE M. CAPITALES DE CASA DE   *00940002
//*            BOLSA. 24 HRS.                                          *00941002
//**********************************************************************00950002
//PJD31P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP31_IN_SEP_OK WDATE',  00960003
//         COND=(4,LT)                                                  00961002
