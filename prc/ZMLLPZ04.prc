...
//*                                                                    *00003000
//*   PROCEDIM. :  ZMLLPZ04-SIVAXFAX (OPC. 787ZR4)                     *00003000
//*                                                                    *00003000
...
//*                                                                     00130000
//ZMLN60PM DD DSN=MXCP.ZM.TMP.MDD.EMP.SUC.ZMLLPE04,DISP=SHR             00140027
//*ZMLN60A1 DD DSN=GFPP.CB.FIX.VIBN60AX,                                00140027
//ZMLN60A1 DD DSN=SIVA.MDD.FIX.EMP.SUC.VIBN60AX,                        00140027
...
//PI601765 DD DUMMY                                                     00100000
//*                                                                     00130000
//ZMLN76PM DD DSN=MXCP.ZM.TMP.MDD.EMP.SUC.ZMLLPE04,DISP=SHR             00140027
//*ZMLN76A1 DD DSN=GFPP.CB.WKF.CONFIRMA.REPORTO,                        00140027
//ZMLN76A1 DD DSN=SIVA.MDD.FIX.EMP.SUC.CONFIRMA.REPORTO,                00140027
//           DISP=(NEW,CATLG,DELETE),                                   00151028
...
//ZMLN76A2 DD DSN=SIVA.MDD.FIX.EMP.SUC.CONFIRMA.INDEVAL,                00140027
//           DISP=(NEW,CATLG,DELETE),                                   00151028
//           DCB=(DSORG=PS,LRECL=285,RECFM=FB,BLKSIZE=0),               00160026
//           UNIT=3390,                                                 00170028
//           SPACE=(CYL,(10,5),RLSE)                                    00180028
...
//ZMLN76A3 DD DSN=SIVA.MDD.FIX.EMP.SUC.CONFIRMA.DIRECTO,                00140027
//           DISP=(NEW,CATLG,DELETE),                                   00151028
//           DCB=(DSORG=PS,LRECL=285,RECFM=FB,BLKSIZE=0),               00160026
//           UNIT=3390,                                                 00170028
//           SPACE=(CYL,(10,5),RLSE)                                    00180028
...
//ZMLN76A4 DD DSN=SIVA.MDD.FIX.EMP.SUC.CONFIRMA.INDEREP,                00140027
//           DISP=(NEW,CATLG,DELETE),                                   00151028
//           DCB=(DSORG=PS,LRECL=285,RECFM=FB,BLKSIZE=0),               00160026
//           UNIT=3390,                                                 00170028
//           SPACE=(CYL,(10,5),RLSE)                                    00180028
