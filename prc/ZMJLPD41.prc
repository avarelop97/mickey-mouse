...
//*  PROGRAMA:   SORT                                                  *
//**********************************************************************
//PJD41P03 EXEC PGM=ICEMAN,PARM=('&INT1','&INT2')
//SYSOUT   DD SYSOUT=*
...
//ZMH00AA2 DD DSN=MXCP.ZM.TMP.MIG.A&INT2..SORTED,DISP=SHR
//ZMH00AA3 DD DSN=MXCP.ZM.FIX.MIGRA.M&INT1,DISP=SHR
...
//**********************************************************************
//PJD41P01 EXEC  PGM=CTMCND,PARM='ADD COND  SIVAMG41_IN_SEP_OK WDATE',
//         COND=(4,LT)
