...
//*               MV2 Y VALUACION CAPITALES AL SERVIDOR BLADE.         *
//*  TRANSMITE :  &DSN1='\\CBNOCFS03\C_CB003\ZM\CUSTODIA\CMV2EDIT.TXT' *
//*               &DSN2='MXCP.ZM.FIX.ECO.INEDIT.ACECMV2'               *
//*-------------------------------------------------------------------**
...
//SYSDUMP   DD SYSOUT=*
//SYSPRINT  DD SYSOUT=*
//SYSIN     DD DSN=ZIVA.ZME.CONTROL(ZHF06T02),DISP=SHR
//*
//*-------------------------------------------------------------------**
//*  PASO: 1      REALIZA LA TRANSFERENCIA DEL ARCHIVO DE              *
//*               VALUACION CAPITALES AL SERVIDOR BLADE.               *
//*  TRANSMITE :  &DSN1='\\CBNOCFS03\C_CB003\ZM\CUSTODIA\VCAPEDIT.TXT' *
//*               &DSN2='MXCP.ZM.FIX.ECO.INEDIT.VALCTD'                *
//*-------------------------------------------------------------------**
...
//SYSDUMP   DD SYSOUT=*
//SYSPRINT  DD SYSOUT=*
//SYSIN     DD DSN=ZIVA.ZME.CONTROL(ZHF06T01),DISP=SHR
//*
//*--------------------------------------------------------------------*
//*                 F I N   ZMHFPD06                                   *
//*--------------------------------------------------------------------*
