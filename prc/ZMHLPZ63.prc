...
//*
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.WKF.EMP.SUC.ZMHLPE63.BXICO.OPC,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.WKF.EMP.SUC.ZMHLPE63.FECHA0,
...
//*
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.FIX.EMP.SUC.ZMHLPE62.BANXI274,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.EMP.SUC.ZMHLPE62.BANXICO,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=242,BLKSIZE=0)
//*SYSTSPRT DD SYSOUT=*
...
//*
//SYSUT1   DD  DSN=MXCP.ZM.TMP.EMP.SUC.ZMHLPE62.BANXICO,DISP=SHR
//SYSUT2   DD  DSN=MXCP.ZM.FIX.EMP.SUC.ZMHLPE62.BANXICO,
//             DISP=(NEW,CATLG,DELETE),UNIT=3390,
//             SPACE=(CYL,(20,10),RLSE),
//             DCB=(RECFM=FB,DSORG=PS,LRECL=242,BLKSIZE=0)
//SYSPRINT DD  SYSOUT=*
...
//*
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.WKF.EMP.SUC.ZMHLPE63.FECHA0,
//            DISP=SHR
//         DD DSN=MXCP.ZM.FIX.EMP.SUC.ZMHLPE62.BANXICO,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.EMP.SUC.ZMHLPE63.BANCTAS,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=242,BLKSIZE=0)
//*SYSTSPRT DD SYSOUT=*
...
//         DD DSN=MXCP.ZM.FIX.EMP.SUC.ZMHLPE62.BANXICO,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.EMP.SUC.ZMHLPE63.BANGLO,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=242,BLKSIZE=0)
//*SYSTSPRT DD SYSOUT=*
...
//*
//ZME013A1 DD DSN=MXCP.ZM.WKF.EMP.SUC.ZMHLPE63.BXICO.OPC,
//            DISP=SHR
