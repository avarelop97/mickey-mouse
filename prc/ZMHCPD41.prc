...
//*                                                                    *00140000
//* PROCESO        :  CBHCND41 EJECUTA AFECTACION DEL BLOQUE 1         *00150025
...
//*  PHC41P03     GRABA EN UN ARCHIVO SECUENCIAL.                      *00489127
//**********************************************************************00489300
//*                     ====  INICIO DE    ====                        *00489400
//*                     ====  CAPITALES    ====                        *00489500
//**********************************************************************00489600
...
//*                                                                     00490000
//ZMG001A1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMHCPD41,               00491038
...
//**********************************************************************
//PHC41P02 EXEC PGM=IEFBR14,COND=(4,LT)
//ARCHIVO   DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMHCPD41.LOG,
...
//*                -- ZM4DH516 -- BLOQUE 1 --                          *
//**********************************************************************
//PHC41P01 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMH516A1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMHCPD41,DISP=SHR
//ZMH516L1 DD DSN=MXCP.ZM.TMP.MDC.E&EMP..S&SUC..ZMHCPD41.LOG,DISP=MOD
//ZMH516E1 DD DSN=SIVA.MDC.FIX.E&EMP..BLOQUE1,DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//SYSDBOUT DD SYSOUT=*
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHC41T01),DISP=SHR
//*
