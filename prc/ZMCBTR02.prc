...
//SORTIN   DD DSN=MXCP.ZM.FIX.EBTR.SELLOMDC,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.FIX.EBTR.CFDI.SELLOS.FSS,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=1044,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,SPACE=(CYL,(300,150),RLSE)
//SYSOUT   DD SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHCBTR01),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : PHCFDI02                                              *
...
//ZM4ECE02 DD DSN=MXCP.ZM.FIX.EBTR.CFDI.SELLOS.FSS,DISP=SHR
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHCBTR03),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : PHCFDI04                                              *
