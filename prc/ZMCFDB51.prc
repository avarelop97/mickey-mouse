...
//*--------------------------------------------------------------------*
//ZMDB5102 EXEC PGM=ADUUMAIN,                                           00385600
//         PARM='MXP1,ZMDB5102,NEW,,MSGLEVEL(1)'                        00385700
//*                                                                     00385800
...
//*                                                                     00386200
//SYSREC   DD DSN=MXCP.ZM.FIX.EBCM.ZMDTCFI.SELLOS,                      00386300
...
//*--------------------------------------------------------------------*
//ZMDB5101 EXEC PGM=ICEMAN,COND=(04,LT)
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.EBCM.ZMDTCFI.SELLOS,DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.TMP.EBCM.ZMDTCFI.SELLOSU,
//            DISP=(NEW,PASS),
...
//*--------------------------------------------------------------------*
// IF  ZMDB5101.RC EQ 00 THEN
//ZMDB5100 EXEC PGM=CTMCND,PARM='ADD COND BCCFDI51_SUS_OK WDATE',       00395100
//         COND=(4,LT)                                                  00395200
//*                                                                     00395300
