...
//*                                                                     01153001
//ENTRADA  DD DSN=MXCP.ZM.FIX.EBCM.CANCELA.CONFIR.F&FECHA,
//            DISP=SHR
//*
//SALIDA   DD DSN=MXCP.ZM.FIX.EBCM.CANCELA.CONFIR.CUENTAS,
...
//*                                                                     01155001
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHDI2302),DISP=SHR                   01230041
//*
//*====================================================================*
//* PASO     : ZHDI2301                                                *
...
//SYSUDUMP DD DUMMY                                                     01220000
//*                                                                     01155001
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHDI2301),DISP=SHR                   01230041
//*
//*====================================================================*
//* PASO     : ZHDI2300                                                *
//* PROGRAMA : IKJEFT01/ZM4CFI40                                       *
//* OBJETIVO : VALIDA RESPUESTA DE CANCELACION                         *
//*====================================================================*
//ZHDI2300 EXEC PGM=IKJEFT01,COND=(04,LT)                               01151027
//*                                                                     01153001
//SYSTSPRT DD SYSOUT=*                                                  01170038
//SYSPRINT DD SYSOUT=*                                                  01180038
//SYSOUT   DD SYSOUT=*                                                  01190038
...
//SYSUDUMP DD DUMMY                                                     01220000
//*                                                                     01155001
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHDI2300),DISP=SHR                   01230041
//*
//*====================================================================*
