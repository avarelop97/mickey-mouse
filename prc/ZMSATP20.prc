...
//** PROCESO        :  ZMSATP20
//**
//** OBJETIVO       :  FORMATEA KARDEX OTROS MES JUNIO SAT CB.
//**
...
//ZMG001A1 DD DSN=MXCP.ZM.FIX.EBCM.ZMSATP20,
...
//ARCHIVO   DD DSN=MXCP.ZM.FIX.MIS.CBSMD.JUN,
...
//****************************************************************
//ZMSATP01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXS20_IN_OK WDATE',
//         COND=(5,LT)
