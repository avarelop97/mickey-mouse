...
//*   PROCEDIM. :  ZXLLPE42                                            *
//*                                                                    *
//*   OBJETIVO  :  GENERA ARCHIVO DE PARAMETROS PARA AMORTIZACIONES    *
//*                ANTICIPADAS SELECTIVAS Y ADICIONA CONDICION DE      *
//*                ARRANQUE.                                           *
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//ZMG001A1 DD DSN=MXCP.ZM.FIX.MDD.E&EMP..S&SUC..ZXLLPE42,
...
//**********************************************************************00410000
//*                         -- CTMCND --                               *00420000
//* OBJETIVO: ACTIVA CONDICION EN CONTROL-M "BCLCCD42_IN" PARA QUE SE  *00430000
//*           EJECUTE LA FUNCION DE AMORTIZACION ANTICIPADA.           *00440000
//*                                                                    *00450000
//* PASO REINICIABLE POR RESTART                                       *00460000
//**********************************************************************00470000
//PLL39P01 EXEC PGM=CTMCND,                                             00480000
//         PARM='ADD COND BCLCCD42_IN_PR_OK WDATE',COND=(4,LT)          00490000
