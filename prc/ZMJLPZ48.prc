...
//* OPCION LINEA     = 967H, TRANSACCION = ZA33, PREFIJO = SIVAXMIG   *
//* SUBMITIDO POR    : CBJLPZ48                                       *
...
//**********************************************************************00002600
//PJD48P04 EXEC PGM=ICEMAN                                              00002700
//SYSOUT   DD SYSOUT=*                                                  00002800
//SORTIN   DD DSN=MXCP.ZM.FIX.MIG061.ACOMOVI,DISP=SHR                   00002900
//SORTOUT  DD DSN=MXCP.ZM.TMP.MIG.ACOMOVI.SORTED,                       00003000
...
//SORTIN   DD DSN=MXCP.ZM.FIX.MIG.CNTL.MOPXLIQ,DISP=SHR                 00004600
//SORTOUT  DD DSN=MXCP.ZM.TMP.MIG.MOPXLIQ.SORTED,                       00004700
...
//ZMH00HA2 DD DSN=MXCP.ZM.TMP.MIG.ACOMOVI.SORTED,DISP=SHR               00006200
//ZMH00HA3 DD DSN=MXCP.ZM.TMP.MIG.MOPXLIQ.SORTED,DISP=SHR               00006300
