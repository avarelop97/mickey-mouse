...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXRBP -> PRC ZMJLPD28  * 00110003
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE        4.-  LIQUIDACION AGTE. CTE. M. DIA.              * 00170002
//*                       (ZM4EHU17)                                  * 00180002
//*                                                                   * 00190000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD28P03 EXEC PGM=ZM3DG001,                                           00390003
...
//*  PJD28P02                                               ZM4DHW28   *00560003
//**********************************************************************00570000
//PJD28P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580003
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD28T02),DISP=SHR                   00710003
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  GENERAR REPORTE DE LIQUIDACION AGENTE  -  AGENTE        *00740000
//*                                                                    *00750000
//*  PJD28P01                                               ZM4EHU17   *00760003
//**********************************************************************00770000
//PJD28P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780003
//*                                                                     00790000
//ZMHV17A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00800000
//*                                                                     00810000
//ZMHV17C1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00820002
//*                                                                     00830000
//ZMHV17G1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00831002
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD28T01),DISP=SHR                   00900003
//*                                                                     00910000
//**********************************************************************00920002
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930002
//*            REPORTE DE LIQUIDACION AGENTE.                          *00940002
//**********************************************************************00950002
//PJD28P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP28_IN_SEP_OK WDATE',  00960003
//         COND=(4,LT)                                                  00961002
