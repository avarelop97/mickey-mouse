...
//*                                                                    *00003100
//*   PROCEDIMIENTO    : ZMHLPE26                                      *00003200
//*                                                                    *00003600
...
//**********************************************************************00005500
//PHL26P03 EXEC PGM=ZM3DG001,                                           00005600
...
//*                                                                     00006600
//ZMG001A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMHLPE26,               00006801
//            DISP=(NEW,PASS),                                          00006900
...
//**********************************************************************00088800
//PHL26P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00088900
//ZMHA15A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMHLPE26,               00089001
...
//**********************************************************************00094900
//PHL26P01 EXEC PGM=MAILOPER,COND=(4,GE,PHL26P02),                      00095100
//         PARM=('/ATENCION.AVISAR A DESARROLLO QUE PROCESO ',          00095200
//             'SIVAXCVP(ZMHLPE26)TERMINO MAL.CONTESTAR SI',            00095300
//             'PARA TERMINAR')                                         00095400
//****************************************************************      00095500
//*                SE ADICIONA CONDICION                         *      00095600
//*                PARA QUE SEA TOMADA POR CTL-D                 *      00095700
//****************************************************************      00095800
//PHL26P00 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXCVP_IN_SEP_OK WDATE',   00095900
//         COND=(4,LT)                                                  00096000
