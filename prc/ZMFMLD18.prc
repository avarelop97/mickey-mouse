...
//*
//ZM15FME1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML24.QUI,
//            DISP=SHR
//*
//ZM15FMS1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML15.POS.QUI,
...
//*
//ZM20FME1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML24.QUI,
//            DISP=SHR
//*
//ZM20FMS1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML20.TXS.QUI,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
...
//SYSDBOUT DD  SYSOUT=*
//SYSOUT   DD  SYSOUT=*
//SYSTSIN  DD  DSN=ZIVA.ZME.CONTROL(ZFM18T20),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : ZFM10T10.                                             *
...
//*
//ZMFM01A1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML24.QUI,DISP=SHR
//*
//ZMFM01F1 DD DSN=MXCP.ZM.FIX.FAM.CONTROL.POS.QUI,
...
//ZMFM01A1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML24.QUI,DISP=SHR
//*
//ZMFM01F1 DD DSN=MXCP.ZM.FIX.FAM.CONTROL.MOV.QUI,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=072,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,SPACE=(CYL,(20,10),RLSE)
//*
...
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.FAM.ZM4FML15.POS.QUI,
//            DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.WKF.FAM.ZM4FML15.POS.QUI.F,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//*           DCB=(RECFM=FB,LRECL=314,BLKSIZE=0,DSORG=PS)
//*MARP02-INI
...
//*MARP02-FIN
//*
//SYSIN    DD DSN=MXCP.ZM.FIX.FAM.CONTROL.POS.QUI,DISP=SHR
//SYSOUT   DD SYSOUT=*
//*EME001-INI
//*--------------------------------------------------------------------*
//* PASO       : ZFM10TA4.                                             *
...
//*
//SORTIN   DD  DSN=MXCP.ZM.WKF.FAM.ZM4FML15.POS.QUI.F,DISP=SHR
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM3FML43.LEYFAM.POS,DISP=SHR
//*
//SORTOUT  DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML15.POS.QUI.F,
//             DISP=(NEW,CATLG,DELETE),UNIT=3390,
//             SPACE=(CYL,(200,100),RLSE),
//*            DCB=(RECFM=FB,LRECL=314,BLKSIZE=0,DSORG=PS)
//*@MARP02-INI
...
//SYSOUT   DD  SYSOUT=*
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.FAM.ZM4FML15.POS.QUI.F,DISP=SHR
//*
//SALIDA1  DD DSN=MXCP.ZM.FIX.FAM.ZM4FML15.POS.QUI.F&HOR,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=316,BLKSIZE=0,DSORG=PS)
//*
...
//*SYSOUT   DD  SYSOUT=*
//*
//*INPUT    DD DSN=MXCP.ZM.FIX.FAM.ZM4FML15.POS.QUI.F,DISP=SHR
//*
//*OUTPUT   DD DSN=MXCP.ZM.FIX.FAM.ZM4FML15.POS.QUI.F&HOR,
//*            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//*            SPACE=(CYL,(200,100),RLSE),
//*           DCB=(RECFM=FB,LRECL=314,BLKSIZE=0,DSORG=PS)
//*@MARP02-INI
...
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.FAM.ZM4FML20.TXS.QUI,
//            DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.WKF.FAM.ZM4FML20.TXS.QUI.F,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=400,BLKSIZE=0,DSORG=PS)
//*
//SYSIN    DD DSN=MXCP.ZM.FIX.FAM.CONTROL.MOV.QUI,DISP=SHR
//SYSOUT   DD SYSOUT=*
//*EME001-INI
//*--------------------------------------------------------------------*
//* PASO       : ZFM10TE4.                                             *
...
//*
//SORTIN   DD  DSN=MXCP.ZM.WKF.FAM.ZM4FML20.TXS.QUI.F,DISP=SHR
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM3FML43.LEYFAM.TRX,DISP=SHR
//*
//SORTOUT  DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML20.TXS.QUI.F,
//             DISP=(NEW,CATLG,DELETE),UNIT=3390,
//             SPACE=(CYL,(200,100),RLSE),
//             DCB=(RECFM=FB,LRECL=400,BLKSIZE=0,DSORG=PS)
//*
...
//SYSOUT   DD  SYSOUT=*
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.FAM.ZM4FML20.TXS.QUI.F,DISP=SHR
//*
//SALIDA1  DD DSN=MXCP.ZM.FIX.FAM.ZM4FML20.TXS.QUI.F&HOR,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=400,BLKSIZE=0,DSORG=PS)
//*
...
//*SYSOUT   DD  SYSOUT=*
//*
//*INPUT    DD DSN=MXCP.ZM.FIX.FAM.ZM4FML20.TXS.QUI.F,DISP=SHR
//*
//*OUTPUT   DD DSN=MXCP.ZM.FIX.FAM.ZM4FML20.TXS.QUI.F&HOR,
//*            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//*            SPACE=(CYL,(200,100),RLSE),
//*            DCB=(RECFM=FB,LRECL=400,BLKSIZE=0,DSORG=PS)
//*
...
//*
//ZM27FME1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML24.QUI,
//            DISP=SHR
//*
//ZM27FMS1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET1.QUI,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=10,BLKSIZE=0,DSORG=PS)
//ZM27FMS2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET2.QUI,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=10,BLKSIZE=0,DSORG=PS)
//ZM27FMS3 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET3.QUI,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=10,BLKSIZE=0,DSORG=PS)
//ZM27FMS4 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET4.QUI,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=10,BLKSIZE=0,DSORG=PS)
//ZM27FMS5 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET5.QUI,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=10,BLKSIZE=0,DSORG=PS)
//ZM27FMS6 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET6.QUI,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=10,BLKSIZE=0,DSORG=PS)
//ZM27FMS7 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET7.QUI,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=10,BLKSIZE=0,DSORG=PS)
//ZM27FMS8 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET8.QUI,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=10,BLKSIZE=0,DSORG=PS)
//*
...
//SYSDBOUT DD  SYSOUT=*
//SYSOUT   DD  SYSOUT=*
//SYSTSIN  DD  DSN=ZIVA.ZME.CONTROL(ZFM12T27),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : ZFM10T05.                                             *
//* UTILERIA   : IKJEFT01/ZM4FML41                                     *
//* OBJETIVO   : REPORTES                                              *
//*--------------------------------------------------------------------*
//ZFM10T05 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMFM25A1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML24.QUI,
//            DISP=SHR
//*MBE001-INI
//ZMFM25P1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET1.QUI,
//            DISP=SHR
//*
//*ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA1,
//ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET11,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*
//*ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA2,
//ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET21,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*MBE001-FIN
...
//SYSDBOUT DD  SYSOUT=*
//SYSOUT   DD  SYSOUT=*
//SYSTSIN  DD  DSN=ZIVA.ZME.CONTROL(ZFM10T41),DISP=SHR
//*
...
//            DISP=SHR
//*MBE001-INI
//ZMFM25P1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET2.QUI,
//            DISP=SHR
//*
//*ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA1,
//ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET12,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*
//*ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA2,
//ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET22,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*MBE001-FIN
...
//*
//ZMFM25B2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML24.QUI,
//            DISP=SHR
//*
...
//            DISP=SHR
//*MBE001-INI
//ZMFM25P1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET3.QUI,
//            DISP=SHR
//*
//*ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA1,
//ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET13,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*
//*ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA2,
//ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET23,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*MBE001-FIN
...
//            DISP=SHR
//*MBE001-INI
//ZMFM25P1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET4.QUI,
//            DISP=SHR
//*
//*ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA1,
//ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET14,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*
//*ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA2,
//ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET24,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*MBE001-FIN
...
//            DISP=SHR
//*MBE001-INI
//ZMFM25P1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET5.QUI,
//            DISP=SHR
//*
//*ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA1,
//ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET15,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*
//*ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA2,
//ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET25,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*MBE001-FIN
...
//            DISP=SHR
//*MBE001-INI
//ZMFM25P1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET6.QUI,
//            DISP=SHR
//*
//*ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA1,
//ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET16,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*
//*ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA2,
//ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET26,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*MBE001-FIN
...
//            DISP=SHR
//*MBE001-INI
//ZMFM25P1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET7.QUI,
//            DISP=SHR
//*
//*ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA1,
//ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET17,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*
//*ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA2,
//ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET27,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*MBE001-FIN
...
//            DISP=SHR
//*MBE001-INI
//ZMFM25P1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.PARAMET8.QUI,
//            DISP=SHR
//*
//*ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA1,
//ZMFM25F1 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET18,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*
//*ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA2,
//ZMFM25F2 DD DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET28,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(200,100),RLSE),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS)
//*MBE001-FIN
...
//*
//SORTIN   DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET11,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET12,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET13,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET14,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET15,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET16,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET17,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET18,DISP=SHR           04083167
//*
//SORTOUT  DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA1,                   04083267
...
//*
//SORTIN   DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET21,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET22,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET23,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET24,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET25,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET26,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET27,DISP=SHR           04083167
//         DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJET28,DISP=SHR           04083167
//*
//SORTOUT  DD  DSN=MXCP.ZM.FIX.FAM.ZM4FML41.TARJETA2,                   04083267
//             DISP=(NEW,CATLG,DELETE),                                 04083367
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=0,DSORG=PS),              04083467
//             SPACE=(CYL,(50,20),RLSE),UNIT=3390                       04083567
//*
...
//*           Y SE EJECUTE EL PROCESO NAJJQ600.
//*---------------------------------------------------------------------
// IF (ZFM14T00.RC = 4) THEN
//ZFM14TA0 EXEC PGM=IOACND,PARM='ADD COND NAJJQ600_IN_OK &FECH1',
//         COND=(4,LT)
//         INCLUDE MEMBER=IOASET
//         INCLUDE MEMBER=IOAENV
//SYSIN    DD DUMMY
