...
//*                                                                   * 00080000
//*   JCL              :  SIVAXRBP                                    * 00090009
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXRBP -> PRC ZMJLPD14  * 00110009
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE        9.-  LIQUIDACION AGTE. CTE. 48 HRS.              * 00170000
//*                       (ZM4DHW57)                                  * 00180000
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("I").                            * 00210000
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD14P03 EXEC PGM=ZM3DG001,                                           00390010
...
//*  PJD14P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD14P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD14T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  GENERAR REPORTE DE LIQUIDACION AGENTE  -  CLIENTES      *00740000
//*            A 48 HRS.                                               *00750000
//*  PJD14P01                                               ZM4DHW57   *00760000
//**********************************************************************00770000
//PJD14P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZMHW57A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00800000
//*                                                                     00810000
//ZMHW57R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00820010
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD14T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920011
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930011
//*            REPORTE DE LIQUIDACION AGENTE  -  CLIENTES.             *00940011
//**********************************************************************00950011
//PJD14P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP14_IN_SEP_OK WDATE',  00960013
//         COND=(4,LT)                                                  00961013
//STEPLIB  DD DISP=SHR,DSN=SYS3.IOAO.SYSZBBV.TGT.LOAD                   00970012
//DAPARM   DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.PARM                   00980012
//         DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.IOAENV                 00990012
//DALOG    DD DISP=SHR,DSN=SYS3.IOAD.SYSZBBV.DATA.LOG                   01000012
//DARESF   DD DISP=SHR,DSN=SYS3.IOAD.SYSZBBV.DATA.NRS                   01010012
//*                                                                     01020011
//PRTDBG   DD SYSOUT=*                                                  01030011
//SYSPRINT DD DUMMY                                                     01040011
//SYSUDUMP DD DUMMY                                                     01050011
//DAPRINT  DD SYSOUT=*                                                  01060011
//DACNDIN  DD DDNAME=SYSIN                                              01070011
//*                                                                     01080011
