...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXRBP -> PRC ZMJLPD09  * 00110006
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE        4.-  LIQUIDACION AGTE. CTE. M. DIA.              * 00170004
//*                       (ZM4DHV17)                                  * 00180000
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("D").                            * 00210000
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD09P03 EXEC PGM=ZM3DG001,                                           00390007
...
//*  PJD09P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD09P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD09T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  GENERAR REPORTE DE LIQUIDACION AGENTE  -  AGENTE        *00740000
//*                                                                    *00750000
//*  PJD09P01                                               ZM4DHV17   *00760000
//**********************************************************************00770000
//PJD09P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZMHV17A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00800000
//*                                                                     00810000
//ZMHV17C1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00820007
//*                                                                     00830000
//ZMHV17G1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00831007
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD09T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920008
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930008
//*            REPORTE DE LIQUIDACION AGENTE.                          *00940008
//**********************************************************************00950008
//PJD09P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP09_IN_SEP_OK WDATE',  00960010
//         COND=(4,LT)                                                  00961010
