...
//** PROCESO        :  ZMSATP46
//**
//** OBJETIVO       :  FORMATEA KARDEX OTROS MES JUNIO SAT MUV.
//**
...
//ZMG001A1 DD DSN=MXCP.ZM.FIX.EBCM.ZMSATP46,
...
//ARCHIVO   DD DSN=MXCP.ZM.FIX.MIS.MUVMD.JUN,
...
//****************************************************************
//ZMSATP01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXS46_IN_OK WDATE',
//         COND=(5,LT)
