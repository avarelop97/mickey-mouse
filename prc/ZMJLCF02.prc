...
//* PROCESO  : ZMJLCF02.                                               *
//* OBJETIVO : SUBMITIDOR PARA GENERAR REPORTE DE NOMBRE FISCALES SIVA *
//* FECHA    : AGOSTO 2022                                             *
//*--------------------------------------------------------------------*
//*--------------------------------------------------------------------*
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLCF02,
...
//*---------------------------------------------------------------------
//ZMCF0202 EXEC PGM=CTMCND,PARM='ADD COND SIVAXRF4_IN_OK WDATE',
//         COND=(4,LT)
