...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXRBP -> PRC ZMJLPD18  * 00110011
//*                                                                   * 00120000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD18P03 EXEC PGM=ZM3DG001,                                           00390012
...
//*  PJD18P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD18P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD18T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  LIQUIDACION DE OPERACIONES DE M. CAPITALES DE CASA DE   *00740000
//*            BOLSA. 24 HRS.                                          *00750011
//*  PJD18P01                                               ZM4DHW60   *00760011
//**********************************************************************00770000
//PJD18P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZMHV60A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00831011
//*                                                                     00831100
//ZM4V60R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00831212
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD18T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920013
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930013
//*            LIQUIDACION DE OPERACIONES DE M. CAPITALES DE CASA DE   *00940013
//*            BOLSA. 24 HRS.                                          *00941013
//**********************************************************************00950013
//PJD18P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP18_IN_SEP_OK WDATE',  00960016
//         COND=(4,LT)                                                  00961015
