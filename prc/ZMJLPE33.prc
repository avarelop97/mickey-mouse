...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLPE33,
...
//ZMDJ18A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLPE33,DISP=SHR
//*
//ZMDJ18A2 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..JLPE33.ATEMP,
//            DISP=(NEW,PASS),
...
//*
//*
//ZMDJ18A4 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..CTMFOL,
//            DISP=(NEW,CATLG,DELETE),
...
//SORTIN   DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..CTMFOL,DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.WKF.TES.E&EMP..S&SUC..CTMSORT,
//         DISP=(NEW,CATLG,DELETE),
//         DCB=(DSORG=PS,RECFM=FB,LRECL=150,BLKSIZE=0),
//         UNIT=3390,SPACE=(CYL,(6,3),RLSE)
//SYSOUT   DD SYSOUT=*
...
//PI601765 DD DUMMY
//ZMDJ19A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLPE33,DISP=SHR
//*
//ZMDJ19A2 DD DSN=MXCP.ZM.WKF.TES.E&EMP..S&SUC..CTMSORT,
//            DISP=(OLD,PASS)
//*
...
//****************************************************************
//PJL33P00 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXICT_IN_SEP_OK WDATE',
//         COND=(4,LT)
...
//**********************************************************************00010000
//*                   F I N     Z M J L P E 3 3                        *00020000
//**********************************************************************00010000
