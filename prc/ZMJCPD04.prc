...
//*                                                                    *00047000
//* PROCESO        :  SIVAXVSI (SUBMITIDOR)                            *00048000
//*                   ZMJCPD04 (PROCEDIMIENTO)                         *00048100
//*                                                                    *00049000
//* OBJETIVO       :  DISPARO DEL CIERRE DE SOCIEDADES DE INVERSION    *00049200
//*                   ENVIADO POR EL USUARIO                           *00049300
//* CORRE                                                              *00049400
//* ANTES DE       :  FIN DE DIA                                       *00049500
//*                                                                    *00049600
//* DESPUES DE     :  A PETICION DEL USUARIO                           *00049700
//*                                                                    *00049800
...
//*--------------------------------------------------------------------*00051500
//*GESFOR| 05-11-04 |       |        | SE RE-AGRUPA EL CIERRE DE S.I.  *00051600
//*--------------------------------------------------------------------*00051710
//*      |          |       |        |                                 *00051720
//**********************************************************************00051730
//*                                                                     00051800
...
//**********************************************************************00055500
//PJC04P03 EXEC PGM=IDCAMS                                              00055600
//*                                                                     00055700
//SYSPRINT DD SYSOUT=*                                                  00055800
//*                                                                     00055900
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZJC04T04),DISP=SHR                   00056000
//*                                                                     00065400
//**********************************************************************00065500
//*                        == ZM3DG001 ==                              *00065600
//*                                                                    *00065700
...
//**********************************************************************00066000
//PJC04P02 EXEC PGM=ZM3DG001,COND=(4,LT),                               00066100
//         PARM=('&EMP','&SUC','&INT1','&INT2',)                        00066200
//*                                                                     00066300
//PI601765 DD DUMMY                                                     00066400
//*                                                                     00066500
//ZMG001A1 DD DSN=MXCP.ZM.FIX.SIN.C1.ECBP.ZMJCPD04,                     00066600
...
//*                        == CTMCND   ==                              *00394500
//*                                                                    *00394600
//*OBJETIVO : ACTIVA LA CONDICION EN CONTROLM PARA QUE CORRA CBJCCD05  *00395000
//********************************************************************* 00396000
//PJC04P01 EXEC PGM=CTMCND,PARM='ADD COND    SIVAXVSI_IN     WDATE',    00430000
//         COND=(4,LT)                                                  00440000
...
//*                                                                     00540000
//********************************************************************* 00540200
//** PEND         FIN DEL PROCEDIMIENTO ZMJCPD04                       *00540300
//********************************************************************* 00540400
