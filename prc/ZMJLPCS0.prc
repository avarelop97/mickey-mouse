...
//* PROCESO  : ZMJLPCS0.                                               *
//* OBJETIVO : SUBMITIDOR DE OPCION S0 DE REPROCESO FISCAL. (ZIS4)     *
//*                                                                    *
...
//*---------------------------------------------------------------------
//ZMPCS002 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//*
//ZMG001A1 DD DSN=MXCP.ZM.FIX.ECBP.SZPR.ZMJLPCS0,
...
//*           PARA EL PROCESO CBJLPCS0. ARCHIVO RFC DE CAPITALES (S0)  *
//*---------------------------------------------------------------------
//ZMPCS001 EXEC PGM=CTMCND,PARM='ADD COND SIVAXFI0_IN_OK WDATE',
//         COND=(4,LT)
