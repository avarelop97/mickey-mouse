...
//* PROCESO  : ZMJLPC40.                                               *
//* OBJETIVO : SUBMITIDOR DE OPCION C1 DE REPROCESO FISCAL. (ZIS4)     *
//*                                                                    *
...
//*---------------------------------------------------------------------
//ZMPC4002 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//*
//ZMG001A1 DD DSN=MXCP.ZM.FIX.ECBP.SZPR.ZMJLPC40,
...
//*           PARA EL PROCESO CBJLPC41. ARCHIVO CRP DE CAPITALES (C1)  *
//*---------------------------------------------------------------------
//ZMPC4001 EXEC PGM=CTMCND,PARM='ADD COND SIVAXIS1_IN_OK WDATE',
//         COND=(4,LT)
