...
//*           CAPTURADAS POR GLOMO QUE SON DE OTRA LIQUIDEZ (PREAVISOS)
//* REALIZO: RHB
//* FECHA  : JUNIO 2020
//*====================================================================*
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZMTGLO04),DISP=SHR
//*
//*--------------------------------------------------------------------*00075700
//* PROGRAMA: IKJEFT01/ZM4GLO02                                        *00022600
//* OBJETIVO: ARCHIVO CON LAS ALERTAS QUE SE ENVIARAN A LOS CLIENTES   *00022700
//*           CON OPERACIONES DE FONDOS (PREAVISOS)                    *00022700
//*--------------------------------------------------------------------*
//ZMJGLO05 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMALRTE1 DD DSN=MXCP.ZM.FIX.EBCM.OPEGLMO.DESC2,DISP=SHR
//*
//ZMALRTS1 DD DSN=MXCP.ZM.FIX.EBCM.OPEGLMO.PREA,
...
//SYSUDUMP DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZMTGLO02),DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : ZMJGLO00.                                             *
//* UTILERIA   : IOACND.                                               *
...
//         PARM='ADD COND BCJGLO02_OK WDATE'
//*
