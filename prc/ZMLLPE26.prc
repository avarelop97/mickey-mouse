...
//**********************************************************************00003000
//PLL26P07 EXEC PGM=ZM3DG001,REGION=0M,                                 00040000
...
//*                                                                     00130000
//ZMG001A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE26,               00130000
...
//*---------------------------------------------------------------------
//PLL26P06 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M                      00070000
//*
//ZMLN26A1 DD  DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE26,DISP=SHR
//*
...
//*---------------------------------------------------------------------
//PLL26P05 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M
//*
//ZMLD71PM DD  DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE26,DISP=SHR
//*
...
//*---------------------------------------------------------------------
//PLL26P04 EXEC PGM=IKJEFT01,REGION=0M,COND=(4,LT)
//*
//ZMLD83A1 DD  DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE26,DISP=SHR
//*
...
//*                    POSICION DE OFERTA.
//*---------------------------------------------------------------------
//PLL26P03 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M
//*
//ZMLD77A1 DD  DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE26,DISP=SHR
//*
...
//*---------------------------------------------------------------------
//PLL26P02 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M
//*
//ZMLE11A1 DD  DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE26,DISP=SHR
//*
//SYSTSPRT DD  SYSOUT=*,DCB=BLKSIZE=0
//SYSPRINT DD  SYSOUT=*
//SYSOUT   DD  SYSOUT=*
...
//*
//*---------------------------------------------------------------------
//*   ACTIVA LA CONDICION EN CONTROLM QUE YA PUEDE CORRER ASIGNACION
//*      DE MERCADO  POR CONTROL-M (STJGM.JCL.CNTL(CIERRTES))
//*---------------------------------------------------------------------
//PLL26P01 EXEC  PGM=CTMCND,PARM='ADD COND  SIVAXD71_IN_SEP_OK WDATE',
//     COND=(0,NE)
