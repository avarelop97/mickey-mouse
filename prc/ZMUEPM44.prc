...
//* ----------- --------- ------- ------------------------------------ *
//* FS-1.1.0-01  XMBB157  06NOV18 SE INTEGRAN LOS PASOS PREVIOS QUE    *
...
//*                               MXC&AMB..ZM.WKF.CBUENM44.EDIMPUE.CTAS*
...
//**********************************************************************
//PUE44P05 EXEC PGM=IKJEFT01,COND=(4,LT)
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//PRINT    DD SYSOUT=*
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZUE44T05),DISP=SHR
//**********************************************************************
//*                          == ZM4MU240 ==                            *
...
//* PASO REINICIABLE POR RESTART.                                      *
//**********************************************************************
//PUE44P04 EXEC PGM=IKJEFT01,COND=(4,LT)
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//PRINT    DD SYSOUT=*
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZUE44T04),DISP=SHR
//**********************************************************************
//*                          ==  IDCAMS  ==                            *
...
//* PASO REINICIABLE POR RESTART.                                      *
//**********************************************************************
//PUE44P03 EXEC PGM=IDCAMS,COND=(4,LT)
//SYSPRINT DD SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZUE44T03),DISP=SHR
//*                                                                     00007824
//**********************************************************************00007825
//* PROGRAMA   : IKJEFT01/ZM4MSATA                                     *00007826
//* OBJETIVO   : CREA VARIABLES PARA CTC'S DINAMICAS                   *00007827
//**********************************************************************00007828
//PUE44P84 EXEC PGM=IKJEFT01,COND=(4,LT)                                00007829
//*                                                                     00007830
//ZMSATAE1 DD DUMMY                                                     00007831
//*                                                                     00007832
//ZMSATAS1 DD DSN=MXCP.ZM.TMP.ECT.ZMUEPM44.PARMS.CTL,                   00007833
...
//**********************************************************************00007851
//PUE44P82 EXEC PGM=ZM3DG005,COND=(4,LT)                                00007852
//*                                                                     00007853
//E1DQ0001 DD DUMMY                                                     00007854
//E2DQ0002 DD DSN=MXCP.ZM.TMP.ECT.ZMUEPM44.PARMS.CTL,DISP=SHR           00007856
//E3DQ0003 DD DSN=ZIVA.ZME.CONTROL(ZUE44T08),DISP=SHR                   00007858
//*                                                                     00007868
//S1DQ0001 DD DSN=MXCP.ZM.TMP.ECT.ZMUEPM44.CONTROL,                     00007869
...
//**********************************************************************00007882
//PUE44P80 EXEC PGM=ADUUMAIN,COND=(4,LT),                               00007883
//         PARM='MXP1,PUE44P80,NEW,,MSGLEVEL(1)'                        00007884
//*                                                                     00007885
...
//*                                                                     00007889
//SYSREC   DD DSN=MXCP.ZM.TMP.ECT.ZMUEPM44.EDMOVED,                     00007890
...
//SYSIN    DD DSN=MXCP.ZM.TMP.ECT.ZMUEPM44.CONTROL,DISP=SHR             00007898
//*
//**********************************************************************
//*                          == ZM4MU250 ==                            *
...
//* ACTUALIZA: EDMOVED                                                 *
//*                                                                    *
//* PASO -NO- REINICIABLE, REINICIAR DESDE EL PASO ANTERIOR(PUE44P03)  *
//**********************************************************************
//PUE44P02 EXEC PGM=IKJEFT01,COND=(4,LT)
...
//ZMU250E1 DD DSN=MXCP.ZM.TMP.ECT.ZMUEPM44.EDMOVED,DISP=SHR             00007906
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZUE44T02),DISP=SHR
//*FS-1.1.0-01-INI
//*--------------------------------------------------------------------*
//* PASO       : ZME44T20                                              *
//* UTILERIA   : ADUUMAIN                                              *
...
//*
//SYSREC   DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.PARAM.TF9,
...
//*
//S1DQ0001 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.JOB,
...
//*
//E1DQ0001 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.JOB,
//            DISP=SHR
//*
//S1DQ0001 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.RISRSOC.CTL,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1,1),RLSE),
//            DCB=(RECFM=FB,BLKSIZE=0,LRECL=80,DSORG=PS)
//*
//S2DQ0002 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.EDIMPUE.CTL,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1,1),RLSE),
//            DCB=(RECFM=FB,BLKSIZE=0,LRECL=80,DSORG=PS)
//*
//S3DQ0003 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.CONCZ111.CTL,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1,1),RLSE),
//            DCB=(RECFM=FB,BLKSIZE=0,LRECL=80,DSORG=PS)
//*
//S4DQ0004 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.CTASEDIM.CTL,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1,1),RLSE),
//            DCB=(RECFM=FB,BLKSIZE=0,LRECL=80,DSORG=PS)
//*
...
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.RISRSOC,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(BLKSIZE=0,DSORG=PS,RECFM=FB),
//            SPACE=(CYL,(1000,500),RLSE)
//*
...
//SYSCNTL  DD DUMMY
//*
//SYSIN    DD DSN=MXC&AMB..ZM.WKF.CBUENM44.RISRSOC.CTL,
//            DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : ZME44T40                                              *
...
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.EDIMPUE,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(BLKSIZE=0,DSORG=PS,RECFM=FB),
//            SPACE=(CYL,(1000,500),RLSE)
//*
...
//SYSCNTL  DD DUMMY
//*
//SYSIN    DD DSN=MXC&AMB..ZM.WKF.CBUENM44.EDIMPUE.CTL,
//            DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : ZME44T45                                              *
...
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.CONCZ111,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(BLKSIZE=0,DSORG=PS,RECFM=FB),
//            SPACE=(CYL,(1000,500),RLSE)
//*
...
//SYSCNTL  DD DUMMY
//*
//SYSIN    DD DSN=MXC&AMB..ZM.WKF.CBUENM44.CONCZ111.CTL,
//            DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : ZME44T50                                              *
...
//*
//E1DQ0001 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.RISRSOC,
//            DISP=SHR
//*
//E2DQ0002 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.EDIMPUE,
//            DISP=SHR
//*
//E3DQ0003 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.CONCZ111,
//            DISP=SHR
//*
//S1DQ0001 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.RISRSOC,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1000,500),RLSE),
//            DCB=(RECFM=FB,BLKSIZE=0,LRECL=69,DSORG=PS)
//*
//S2DQ0002 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.ZMDT111,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1000,500),RLSE),
...
//*
//SORTIN   DD DSN=MXC&AMB..ZM.WKF.CBUENM44.ZMDT111,
//            DISP=SHR
//*
//SORTOUT  DD DSN=MXC&AMB..ZM.WKF.CBUENM44.ZMDT111.SORT,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=3390,SPACE=(CYL,(1000,500),RLSE),
//            DCB=(RECFM=FB,BLKSIZE=0,LRECL=81,DSORG=PS)
//*
...
//* PASO REINICIABLE POR RESTART.                                      *
//**********************************************************************
//PUE44P01 EXEC PGM=IKJEFT01,COND=(4,LT)
//ZMU255A1 DD DSN=MXCP.ZM.FIX.ECT.MOVTOS.EDC,DISP=SHR
//*FS-1.1.0-01-INI
//E1DQ0001 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.PARAM.TF9,
//            DISP=SHR
//*
//E2DQ0002 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.RISRSOC,
//            DISP=SHR
//*
//E3DQ0003 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.ZMDT111.SORT,
//            DISP=SHR
//*
//S1DQ0001 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.DETALLE.EDIMPUE,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1000,500),RLSE),
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZUE44T01),DISP=SHR
//*
//*FS-1.1.0-01-INI
//*--------------------------------------------------------------------*
//* PASO       : ZME44T60                                              *
...
//            DISP=SHR
//*
//S1DQ0001 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.ZMDT610.CTL,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1,1),RLSE),
//            DCB=(RECFM=FB,BLKSIZE=0,LRECL=80,DSORG=PS)
//*
...
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.ZMDT610,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(BLKSIZE=0,DSORG=PS,RECFM=FB),
//            SPACE=(CYL,(1000,500),RLSE)
//*
...
//SYSCNTL  DD DUMMY
//*
//SYSIN    DD DSN=MXC&AMB..ZM.WKF.CBUENM44.ZMDT610.CTL,
//            DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : ZME44T70                                              *
...
//*
//SORTIN   DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.ZMDT610,
//            DISP=SHR
//*
//SORTOUT  DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.ZMDT610.SORT,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1000,500),RLSE),
...
//*
//E2DQ0002 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.ZMDT610.SORT,
//            DISP=SHR
//*
//S1DQ0001 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.DETALLE.ZMDT610,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1000,500),RLSE),
//            DCB=(RECFM=FB,BLKSIZE=0,LRECL=87,DSORG=PS)
//*
...
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR
//*
//SYSREC   DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.EDIMPUE.ACUM,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(BLKSIZE=0,DSORG=PS,RECFM=FB),
//            SPACE=(CYL,(1000,500),RLSE)
//*
...
//SYSCNTL  DD DUMMY
//*
//SYSIN    DD DSN=MXC&AMB..ZM.WKF.CBUENM44.CTASEDIM.CTL,
//            DISP=SHR
//*
//*--------------------------------------------------------------------*
//* PASO       : ZME44T90                                              *
...
//*
//E2DQ0002 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.UNLOAD.EDIMPUE.ACUM,
//            DISP=SHR
//*
//S1DQ0001 DD DSN=MXC&AMB..ZM.WKF.CBUENM44.DETALLE.EDIMPUE.ACUM,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1000,500),RLSE),
//            DCB=(RECFM=FB,BLKSIZE=0,LRECL=87,DSORG=PS)
//*
...
//*
//SORTIN   DD DSN=MXC&AMB..ZM.WKF.CBUENM44.DETALLE.EDIMPUE,
//            DISP=SHR
//         DD DSN=MXC&AMB..ZM.WKF.CBUENM44.DETALLE.EDIMPUE.ACUM,
//            DISP=SHR
//         DD DSN=MXC&AMB..ZM.WKF.CBUENM44.DETALLE.ZMDT610,
//            DISP=SHR
//*
//SORTOUT  DD DSN=MXC&AMB..ZM.FIX.CBUENM44.DETALLE.EDIMPUE.SORT,
//            DISP=(NEW,CATLG,CATLG),
//            UNIT=3390,SPACE=(CYL,(1000,500),RLSE),
//            DCB=(RECFM=FB,BLKSIZE=0,LRECL=87,DSORG=PS)
//*
