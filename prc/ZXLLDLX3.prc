...
//*                DE CUPON(PREVIO) Y ADICIONA CONDICION DE ARRANQUE.  *
//*                                                                    *
//*   CORRE DESPUES DE:  N/A                                           *
//*                                                                    *
//*   CORRE ANTES DE  :  BCLLDLX3                                      *
//*                                                                    *
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//ZMG001A1 DD DSN=MXCP.ZM.FIX.MDD.E&EMP..S&SUC..ZXLLDLX3,
...
//**********************************************************************00410000
//*                         -- CTMCND --                               *00420000
//* OBJETIVO: ACTIVA CONDICION EN CONTROL-M "BCLLDLX3_IN" PARA QUE SE  *00430000
//*           EJECUTE EL REVERSO DE CORTE DE CUPON.                    *00440000
//*                                                                    *00450000
//* PASO REINICIABLE POR RESTART                                       *00460000
//**********************************************************************00470000
//PLLX3P01 EXEC PGM=CTMCND,                                             00480000
//         PARM='ADD COND BCLLDLX3_IN_OK WDATE',COND=(4,LT)             00490000
