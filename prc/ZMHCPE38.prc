...
//*--------------------------------------------------------------------*
//PHC38P01 EXEC PGM=ZM3DG001,PARM=('&EMP','&SUC','&INT1','&INT2')
//*
//ZMG001A1 DD DSN=MXCP.ZM.FIX.MDC.E&EMP..S&SUC..ZMHCPE38,
...
//*--------------------------------------------------------------------*
//PHC06P02 EXEC PGM=CTMCND,PARM='ADD COND     SIVAXFT1_OK    WDATE',
//         COND=(4,LT)
//*
