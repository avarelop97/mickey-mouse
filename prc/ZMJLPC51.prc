...
//* PROCESO  : CBJLPL51.                                               *
//* OBJETIVO : SUBMITIDOR DE OPCION 8 DE REPROCESO FISCAL.             *
//*                                                                    *
//* REALIZO  :                                                         *
//* FECHA    : 05-07-2023.                                             *
//*--------------------------------------------------------------------*
...
//*---------------------------------------------------------------------
//ZMPC5102 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.ECBP.SZPR.ZMJLPC51,
...
//*---------------------------------------------------------------------
//ZMPC5101 EXEC PGM=CTMCND,PARM='ADD COND SIVAXIS8_IN_OK WDATE',
//         COND=(4,LT)
