...
//** PROCESO        :  ZMSATP50
//**
//** OBJETIVO       :  FORMATEA KARDEX OTROS MES OCTUBRE SAT MUV.
//**
...
//ZMG001A1 DD DSN=MXCP.ZM.FIX.EBCM.ZMSATP50,
...
//ARCHIVO   DD DSN=MXCP.ZM.FIX.MIS.MUVMD.OCT,
...
//****************************************************************
//ZMSATP01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXS50_IN_OK WDATE',
//         COND=(5,LT)
