//ZMTEPD03 PROC EMP=,SUC=,INT1=,FECHA=                                  00010000
//*                                                                     00010100
//**********************************************************************00020000
...
//*                                                                    *00150000
//*   CORRE DESPUES DE: ZMTEPD02                                       *00160000
//*                                                                    *00170000
...
//            DCB=(DSORG=PS,LRECL=1550,RECFM=FB,BLKSIZE=0),             02100000
...
//ZMU022A1 DD DSN=MXCP.ZM.TMP.ECT.EBPATRIM.PF01.MUV,                    02201200
//            DISP=(NEW,DELETE,DELETE),UNIT=3390,                       02201210
//            DCB=(DSORG=PS,LRECL=1486,RECFM=FB,BLKSIZE=0),             02201220
//            SPACE=(CYL,(200,100),RLSE)                                02201230
...
//            UNIT=3390                                                 02203500
//ZMU022A7 DD DSN=MXCP.ZM.GDGD.ECT.EBPATRIM.PF01(+1),                   02203600
//            DISP=(NEW,CATLG,DELETE),                                  02203610
//            SPACE=(CYL,(200,100),RLSE),                               02203620
//            DCB=(BKUP.MODEL,LRECL=1214,RECFM=FB,BLKSIZE=0),           02203630
//            UNIT=3390                                                 02203640
//*                                                                     02203700
//*---- ARCHIVOS SALIDA E.C. BANCA PRIVADA                              02203800
//ZMU022A4 DD DSN=MXCP.ZM.TMP.ECT.EBPRIVAD.PF01.MUV,                    02203900
//            DISP=(NEW,DELETE,DELETE),UNIT=3390,                       02203910
//            DCB=(DSORG=PS,LRECL=1486,RECFM=FB,BLKSIZE=0),             02203920
//            SPACE=(CYL,(200,100),RLSE)                                02203930
...
//            UNIT=3390                                                 02205300
//ZMU022A8 DD DSN=MXCP.ZM.GDGD.ECT.EBPRIVAD.PF01(+1),                   02205400
//            DISP=(NEW,CATLG,DELETE),                                  02205410
//            SPACE=(CYL,(200,100),RLSE),                               02205420
//            DCB=(BKUP.MODEL,LRECL=1214,RECFM=FB,BLKSIZE=0),           02205430
//            UNIT=3390                                                 02205440
//*                                                                     02205500
...
//*                                                                     02207000
//**********************************************************************02210000
//*        TERMINA PROCESO ZMTEPD03 SIVA MULTIEMPRESA                  *02220000
//**********************************************************************02230000
