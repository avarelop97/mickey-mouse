...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXLPR -> PRC ZMJLPD19  * 00110000
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE       14.-  CPAS. VTAS. DE M. CAPITALES 24 HORAS        * 00170000
//*                       (ZM4DHW60)                                  * 00180000
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("N").                            * 00210000
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD19P03 EXEC PGM=ZM3DG001,                                           00390011
...
//*  PJD19P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD19P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD19T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  LIQUIDACION DE OPERACIONES DE M. CAPITALES DE CASA DE   *00740000
//*            BOLSA 24 HORAS.                                         *00750000
//*  PJD19P01                                               ZM4DHW60   *00760000
//**********************************************************************00770000
//PJD19P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZMHV60A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00831000
//*                                                                     00831100
//ZM4V60R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00831211
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD19T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920012
...
//*            BOLSA 24 HORAS.                                         *00941012
//**********************************************************************00950012
//PJD19P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP19_IN_SEP_OK WDATE',  00960015
//         COND=(4,LT)                                                  00961014
