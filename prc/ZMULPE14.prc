...
//*                                                                    *00009000
//*   PROCEDIMIENTO    : ZMULPE14                                      *00009100
//*                                                                    *00009200
...
//*--------------------------------------------------------------------*00010900
//PUL14P04 EXEC PGM=ZM3DG001,                                           00011000
...
//*                                                                     00011900
//ZMG001A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMULPE14,               00012000
...
//*--------------------------------------------------------------------*00014500
//PUL14P03 EXEC PGM=IKJEFT01,COND=(4,LT)                                00014600
//*                                                                     00014700
//ZMG633A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMULPE14,DISP=SHR       00012000
//*                                                                     00014900
//ZMG633R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00015000
...
//*--------------------------------------------------------------------*00020400
//PUL14P02 EXEC PGM=MAILOPER,COND=(4,GE,PUL14P03),                      00020500
...
//*--------------------------------------------------------------------*00021200
//PUL14P01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXPRO_IN_SEP_OK WDATE',   00021300
//         COND=(4,LT)                                                  00021400
