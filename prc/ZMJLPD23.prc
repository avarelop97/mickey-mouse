...
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXLPR -> PRC ZMJLPD23  * 00110000
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE       18.-  TITULOS OPERADOS POR C.B. A 48 HRS.         * 00170011
//*                       (ZM4DHW59)                                  * 00180011
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("R").                            * 00210011
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD23P03 EXEC PGM=ZM3DG001,                                           00390012
...
//*  PJD23P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD23P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD23T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  REPORTE DE TITULOS OPERADOS POR CASA DE BOLSA           *00740011
//*            A 48 HRS.                                               *00750000
//*  PJD23P01                                               ZM4DHW59   *00760011
//**********************************************************************00770000
//PJD23P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZMHW59A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..PATR,DISP=SHR               00800011
//*                                                                     00810000
//ZMHW59R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00820012
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD23T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920013
...
//*            A 48 HRS.                                               *00941013
//**********************************************************************00950013
//PJD23P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP23_IN_SEP_OK WDATE',  00960016
//         COND=(4,LT)                                                  00961015
