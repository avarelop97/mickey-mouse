...
//*--------------------------------------------------------------------*
//*
//PLZ17P02 EXEC PGM=ZM3DG001,PARM=('&EMP','&SUC','&INT1','&INT2')
//*
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.VAL.EMP.SUC.ZMLCPZ17,
...
//*--------------------------------------------------------------------*
//*
//PLZ16P01 EXEC PGM=CTMCND,PARM='ADD COND SIVAXCOM_IN_OK WDATE',
//         COND=(4,LT)
//*
