...
//*                                                         ZM3DG001   *
//*-------------------------------------------------------------------**
//PHL06P29 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//*
//ZMG001A1 DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZMHLPD06,
...
//*  PHL06P28     MERCADO.                                             *00040000
//*                                                         ZM4DHB01   *00040000
//**********************************************************************00060000
//PHL06P28 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMHB01A1 DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZMHLPD06,DISP=SHR
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHD06T28),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO:  3     GENERA ARCHIVO CON LAS OPERACIONES AUTOMATICAS DE    *00030000
//*  PHL06P27     COMPRAS Y VENTAS DE MERCADO DE DINERO.               *00040000
//*                                                         ZM4DHB02   *00040000
//**********************************************************************00060000
//PHL06P27 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMHB02A1 DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZMHLPD06,DISP=SHR
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHD06T27),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO:  4     GENERA ARCHIVO DE OPERACIONES DE COMPRAS Y VENTAS.   *00030000
//*  PHL06P26     CONTRATOS DE SOCIEDADES DE INV.           ZM4DHB03   *00040000
//**********************************************************************00060000
//PHL06P26 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMHB03A1 DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZMHLPD06,DISP=SHR
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHD06T26),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 5   SORT QUE REALIZA LA ELIMINACIóN DE LO ENCABEZADOS DEL   *00030000
//*            ARCHIVO DE OPERACIONES PENDIENTES A PLAZO             *
//*  PHL06P25                                                ICEMAN    *00040000
//**********************************************************************00060000
//PHL06P25 EXEC PGM=ICEMAN,COND=(4,LT)
//SORTIN   DD DSN=MXCP.ZM.GDGD.VAL.PZODEP(-3),DISP=SHR
...
//*
//SYSOUT   DD SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHD06T25),DISP=SHR                   00183716
//*
//**********************************************************************00010000
...
//*  PHL06P24                                                          *00040000
//**********************************************************************00060000
//PHL06P24 EXEC PGM=IKJEFT01,COND=(4,LT)                                00070000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHD06T24),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO:  7     DEPURA ARCHIVO DE OPERACIONES DE COMPRAS Y VENTAS, Y *00030000
//*  PHL06P23     ORDENA POR SERIE Y NO. TITULOS.           SORT       *00040000
//*                            ( CONCATENA ) ORDENA POR DEP            *00040000
//**********************************************************************00060000
//PHL06P23 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHD06T23),DISP=SHR
//*
//**********************************************************************
//*  PASO:  8     REALIZA FORMATEO DE ARCHIVO INDEVAL PARA LA COLUMNA  *
//*  PHL06P22     DE TITULOS.                               ZM3DHB01   *
//**********************************************************************
//PHL06P22 EXEC PGM=ZM3DHB01,COND=(4,LT)
//*
...
//*  PHL06P21     ORDENA POR SERIE Y NO. TITULOS.           ICEMAN     *00040000
//*                            ( CONCATENA )                           *00040000
//**********************************************************************00060000
//PHL06P21 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHD06T21),DISP=SHR
//*
//**********************************************************************
//*  PASO: 10     REALIZA FORMATEO DE ARCHIVO INDEVAL AGRUPANDO POR NO.*
//*  PHL06P20     DE TAREA(V) DEJANDO UN SOLO REGISTRO CON LA SUMARTORIA
//*                                                         ZM3DHB02   *
//**********************************************************************
//PHL06P20 EXEC PGM=ZM3DHB02,COND=(4,LT)
//*
...
//*  PHL06P19     ORDENA POR SERIE Y NO. TITULOS.            ICEMAN    *00040000
//*                            ( CONCATENA )                           *00040000
//**********************************************************************00060000
//PHL06P19 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHD06T19),DISP=SHR
//*
//**********************************************************************
//*  PASO:  12    REALIZA FORMATEO DE ARCHIVO INDEVAL PARA LOS CASOS X *
//*  PHL06P18     RALIZANDO SUMATORIA Y DEJANDOLA EN UN RGISTRO.       *
//*                                                         ZM3DHB03   *
//**********************************************************************
//PHL06P18 EXEC PGM=ZM3DHB03,COND=(4,LT)
//*
...
//*  PHL06P17     TULOS.                                     ICEMAN    *00040000
//*                         ( DEPOSITOS  INDEVAL )                     *00020000
//**********************************************************************00060000
//PHL06P17 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHD06T17),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 14     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00030000
//*  PHL06P16     OPERACIONES.                              ZM4DHB04   *00040000
//*                               ( DEPOSITOS )                        *00020000
//**********************************************************************00060000
//PHL06P16 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHD06T16),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 15     REALIZA ORDENAMIENTO DEL REPORTE POR SERIE Y NO. TI- *00030000
//*  PHL06P15     TULOS.                                     ICEMAN    *00040000
//*                         ( DEPOSITOS  INDEVAL )                     *00020000
//**********************************************************************00060000
//PHL06P15 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHD06T15),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 16     GENERA ARCHIVO CON REGISTROS QUE NO TIENEN CONTRAPAR-*00030000
//*  PHL06P14     TE, PARA INICIAR UNA NUEVA BUSQUEDA.       ICEMAN    *00040000
//*                               ( RETIROS )                          *00020000
//**********************************************************************00060000
//PHL06P14 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHD06T14),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 17     REALIZA ORDENAMIENTO DE ARCHIVO YA FORMATEADO PARA   *00030000
//*  PHL06P13     RETIROS.                                   ICEMAN    *00040000
//*                           ( RETIROS INDEVAL )                      *00020000
//**********************************************************************00060000
//PHL06P13 EXEC PGM=ICEMAN,COND=(4,LT)
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.VAL.MOVTOS1.INDEVALZ,DISP=SHR
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHD06T13),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 18     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00030000
//*  PHL06P12     OPERACIONES.                              ZM4DHB04   *00040000
//*                              ( RETIROS )                           *00020000
//**********************************************************************00060000
//PHL06P12 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHD06T12),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 19     GENERA ARCHIVO CON REGISTROS QUE NO TIENEN CONTRAPAR-*00030000
//*  PHL06P11     TE, PARA UNA SEGUNDA PASADA                ICEMAN    *00040000
//**********************************************************************00060000
//PHL06P11 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHD06T11),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 20     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00030000
//*  PHL06P10     OPERACIONES.                              ZM4DHB06   *00040000
//*                              ( DEPOSITOS )                         *00020000
//**********************************************************************00060000
//PHL06P10 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHD06T10),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 21     GENERA ARCHIVO CON REGISTROS QUE SI TIENEN CONTRAPAR-*00030000
//*  PHL06P09     TE.                                                  *00040000
//*                                                          ICEMAN    *00020000
//**********************************************************************00060000
//PHL06P09 EXEC PGM=ICEMAN,COND=(4,LT)
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZM4DHB04.DEPRET,DISP=SHR
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHD06T09),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 22     GENERA ARCHIVO CON REGISTROS QUE NO TIENEN CONTRAPAR-*00030000
//*  PHL06P08     TE, PARA UNA SEGUNDA PASADA                ICEMAN    *00040000
//*                            ( RETIROS )                             *00020000
//**********************************************************************00060000
//PHL06P08 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHD06T08),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 23     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00030000
//*  PHL06P07     OPERACIONES.                              ZM4DHB06   *00040000
//*                              ( RETIROS )                           *00020000
//**********************************************************************00060000
//PHL06P07 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHD06T07),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 24     CONCATENA ARCHIVOS PARA ENVIAR A BANXICO.            *00030000
//*  PHL06P06                                                ICEMAN    *00040000
//**********************************************************************00060000
//PHL06P06 EXEC PGM=ICEMAN,COND=(4,LT)
//*
...
//*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHD06T06),DISP=SHR
//*
//**********************************************************************00010000
//*  PASO: 25  CONCATENA ARCHIVOS PARA ENVIAR A BANXICO.               *00030000
//*  PHL06P05                                                          *00040000
//**********************************************************************00060000
//PHL06P05 EXEC PGM=IEBGENER,COND=(4,LT)                                00100800
...
//**********************************************************************00010000
//PHL06P04 EXEC PGM=IKJEFT01,COND=(4,LT)
//*
//ZMLE11A1 DD DSN=MXCP.ZM.FIX.VAL.E&EMP..ZMHLPD06,DISP=SHR
//*
//SYSTSPRT DD  SYSOUT=*
//SYSPRINT DD  SYSOUT=*
//SYSOUT   DD  SYSOUT=*
...
//SYSABOUT DD  DUMMY
//SYSUDUMP DD  DUMMY
//SYSTSIN  DD  DSN=ZIVA.ZME.CONTROL(ZHD06T04),DISP=SHR
//*
//*-------------------------------------------------------------------- 00630000
//*        AVISO EN CASO DE ERROR A LA CONSOLA                          00640000
//*-------------------------------------------------------------------- 00650000
//PHL06P03 EXEC PGM=MAILOPER,COND=(4,GE),
//         PARM=('/ATENCION OPERADOR.AVISAR A PRODUCCION QUE',
//             ' PROCESO SIVAXBM3 TERMINO MAL.CONTESTAR SI',
//             'PARA TERMINAR')
//****************************************************************      00700000
//*                SE ADICIONA CONDICION                         *      00710000
//*          PARA EJECUTAR PROCESO CBHTNE59                      *      00720000
//****************************************************************      00730000
//PHL06P01 EXEC PGM=CTMCND,PARM='ADD COND CBHTNE59_IN_PR_OK WDATE',
//         COND=(4,LT)                                                  00750000
