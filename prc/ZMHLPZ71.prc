...
//*                                                                    *00000900
//*   PROCEDIM. :  ZMHLPZ71  CBHLPZ71                                  *00001000
//*                                                                    *00001100
//*   OBJETIVO  :  GENERA ARCHIVO DE OPERACIONES DE COMPRA Y VENTA DIA-*00001200
//*                RIAS  PARA BANXICO DIA OPERACION P04.               *00001300
//*                                                                    *00001400
//*   CORRE ANTES DE  :  CBHTNE59                                      *00001500
//*                                                                    *00001600
//*   CORRE DESPUES DE:  SIVAXBXW                                      *00001700
...
//*  PHL71P28     MERCADO.                                             *00003900
//*                                                         ZM4DHB01   *00004000
//**********************************************************************00004100
//PHL71P28 EXEC PGM=IKJEFT01                                            00004200
//*                                                                     00004300
//ZMHB01A1 DD DSN=MXCP.ZM.FIX.VAL.EMP.ZMHLPE71,DISP=SHR                 00004400
//*                                                                     00004500
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL71T28),DISP=SHR                   00006200
//*                                                                     00006300
//**********************************************************************00006400
//*  PASO:  3     GENERA ARCHIVO CON LAS OPERACIONES AUTOMATICAS DE    *00006500
//*  PHL71P27     COMPRAS Y VENTAS DE MERCADO DE DINERO.               *00006600
//*                                                         ZM4DHB02   *00006700
//**********************************************************************00006800
//PHL71P27 EXEC PGM=IKJEFT01,COND=(4,LT)                                00006900
//*                                                                     00007000
//ZMHB02A1 DD DSN=MXCP.ZM.FIX.VAL.EMP.ZMHLPE71,DISP=SHR                 00007100
//*                                                                     00007200
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL71T27),DISP=SHR                   00008900
//*                                                                     00009000
//**********************************************************************00009100
//*  PASO:  4     GENERA ARCHIVO DE OPERACIONES DE COMPRAS Y VENTAS.   *00009200
//*  PHL71P26     CONTRATOS DE SOCIEDADES DE INV.           ZM4DHB03   *00009300
//**********************************************************************00009400
//PHL71P26 EXEC PGM=IKJEFT01,COND=(4,LT)                                00009500
//*                                                                     00009600
//ZMHB03A1 DD DSN=MXCP.ZM.FIX.VAL.EMP.ZMHLPE71,DISP=SHR                 00009700
//*                                                                     00009800
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL71T26),DISP=SHR                   00011500
//*                                                                     00011600
//**********************************************************************00011700
//*  PASO: 5   SORT QUE REALIZA LA ELIMINACIóN DE LO ENCABEZADOS DEL   *00011800
//*            ARCHIVO DE OPERACIONES PENDIENTES A PLAZO             *  00011900
//*  PHL71P25                                                ICEMAN    *00012000
//**********************************************************************00012100
//PHL71P25 EXEC PGM=SYNCSORT,COND=(4,LT)                                00012200
//SORTIN   DD DSN=MXCP.ZM.GDGD.VAL.PZODEP(0),DISP=SHR                   00012300
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL71T25),DISP=SHR                   00013000
//*                                                                     00013100
//**********************************************************************00013200
...
//*  PHL71P24                                                          *00013500
//**********************************************************************00013600
//PHL71P24 EXEC PGM=IKJEFT01,COND=(4,LT)                                00013700
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL71T24),DISP=SHR                   00015600
//*                                                                     00015700
//**********************************************************************00015800
//*  PASO:  7     DEPURA ARCHIVO DE OPERACIONES DE COMPRAS Y VENTAS, Y *00015900
//*  PHL71P23     ORDENA POR SERIE Y NO. TITULOS.           SORT       *00016000
//*                            ( CONCATENA ) ORDENA POR DEP            *00016100
//**********************************************************************00016200
//PHL71P23 EXEC PGM=SYNCSORT,COND=(4,LT)                                00016300
//*                                                                     00016400
...
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL71T23),DISP=SHR                  00017600
//*                                                                     00017700
//**********************************************************************00017800
//*  PASO:  8     REALIZA FORMATEO DE ARCHIVO INDEVAL PARA LA COLUMNA  *00017900
//*  PHL71P22     DE TITULOS.                               ZM3DHB01   *00018000
//**********************************************************************00018100
//PHL71P22 EXEC PGM=ZM3DHB01,COND=(4,LT)                                00018200
//*                                                                     00018300
...
//*  PHL71P21     ORDENA POR SERIE Y NO. TITULOS.           ICEMAN     *00020000
//*                            ( CONCATENA )                           *00020100
//**********************************************************************00020200
//PHL71P21 EXEC PGM=SYNCSORT,COND=(4,LT)                                00020300
//*                                                                     00020400
...
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL71T21),DISP=SHR                  00021400
//*                                                                     00021500
//**********************************************************************00021600
//*  PASO: 10     REALIZA FORMATEO DE ARCHIVO INDEVAL AGRUPANDO POR NO.*00021700
//*  PHL71P20     DE TAREA(V) DEJANDO UN SOLO REGISTRO CON LA SUMARTORIA00021800
//*                                                         ZM3DHB02   *00021900
//**********************************************************************00022000
//PHL71P20 EXEC PGM=ZM3DHB02,COND=(4,LT)                                00022100
//*                                                                     00022200
...
//*  PHL71P19     ORDENA POR SERIE Y NO. TITULOS.            ICEMAN    *00023900
//*                            ( CONCATENA )                           *00024000
//**********************************************************************00024100
//PHL71P19 EXEC PGM=SYNCSORT,COND=(4,LT)                                00024200
//*                                                                     00024300
...
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL71T19),DISP=SHR                  00025300
//*                                                                     00025400
//**********************************************************************00025500
//*  PASO:  12    REALIZA FORMATEO DE ARCHIVO INDEVAL PARA LOS CASOS X *00025600
//*  PHL71P18     RALIZANDO SUMATORIA Y DEJANDOLA EN UN RGISTRO.       *00025700
//*                                                         ZM3DHB03   *00025800
//**********************************************************************00025900
//PHL71P18 EXEC PGM=ZM3DHB03,COND=(4,LT)                                00026000
//*                                                                     00026100
...
//*  PHL71P17     TULOS.                                     ICEMAN    *00027800
//*                         ( DEPOSITOS  INDEVAL )                     *00027900
//**********************************************************************00028000
//PHL71P17 EXEC PGM=SYNCSORT,COND=(4,LT)                                00028100
//*                                                                     00028200
...
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL71T17),DISP=SHR                  00029200
//*                                                                     00029300
//**********************************************************************00029400
//*  PASO: 14     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00029500
//*  PHL71P16     OPERACIONES.                              ZM4DHB04   *00029600
//*                               ( DEPOSITOS )                        *00029700
//**********************************************************************00029800
//PHL71P16 EXEC PGM=IKJEFT01,COND=(4,LT)                                00029900
//*                                                                     00030000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL71T16),DISP=SHR                   00031600
//*                                                                     00031700
//**********************************************************************00031800
//*  PASO: 15     REALIZA ORDENAMIENTO DEL REPORTE POR SERIE Y NO. TI- *00031900
//*  PHL71P15     TULOS.                                     ICEMAN    *00032000
//*                         ( DEPOSITOS  INDEVAL )                     *00032100
//**********************************************************************00032200
//PHL71P15 EXEC PGM=SYNCSORT,COND=(4,LT)                                00032300
//*                                                                     00032400
...
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL71T15),DISP=SHR                  00033400
//*                                                                     00033500
//**********************************************************************00033600
//*  PASO: 16     GENERA ARCHIVO CON REGISTROS QUE NO TIENEN CONTRAPAR-*00033700
//*  PHL71P14     TE, PARA INICIAR UNA NUEVA BUSQUEDA.       ICEMAN    *00033800
//*                               ( RETIROS )                          *00033900
//**********************************************************************00034000
//PHL71P14 EXEC PGM=SYNCSORT,COND=(4,LT)                                00034100
//*                                                                     00034200
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL71T14),DISP=SHR                   00035200
//*                                                                     00035300
//**********************************************************************00035400
//*  PASO: 17     REALIZA ORDENAMIENTO DE ARCHIVO YA FORMATEADO PARA   *00035500
//*  PHL71P13     RETIROS.                                   ICEMAN    *00035600
//*                           ( RETIROS INDEVAL )                      *00035700
//**********************************************************************00035800
//PHL71P13 EXEC PGM=SYNCSORT,COND=(4,LT)                                00035900
//*                                                                     00036000
...
//SYSIN    DD  DSN=ZIVA.ZME.CONTROL(ZHL71T13),DISP=SHR                  00037000
//*                                                                     00037100
//**********************************************************************00037200
//*  PASO: 18     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00037300
//*  PHL71P12     OPERACIONES.                              ZM4DHB04   *00037400
//*                              ( RETIROS )                           *00037500
//**********************************************************************00037600
//PHL71P12 EXEC PGM=IKJEFT01,COND=(4,LT)                                00037700
//*                                                                     00037800
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL71T12),DISP=SHR                   00039500
//*                                                                     00039600
//**********************************************************************00039700
//*  PASO: 19     GENERA ARCHIVO CON REGISTROS QUE NO TIENEN CONTRAPAR-*00039800
//*  PHL71P11     TE, PARA UNA SEGUNDA PASADA                ICEMAN    *00039900
//**********************************************************************00040000
//PHL71P11 EXEC PGM=SYNCSORT,COND=(4,LT)                                00040100
//*                                                                     00040200
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL71T11),DISP=SHR                   00041200
//*                                                                     00041300
//**********************************************************************00041400
//*  PASO: 20     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00041500
//*  PHL71P10     OPERACIONES.                              ZM4DHB06   *00041600
//*                              ( DEPOSITOS )                         *00041700
//**********************************************************************00041800
//PHL71P10 EXEC PGM=IKJEFT01,COND=(4,LT)                                00041900
//*                                                                     00042000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL71T10),DISP=SHR                   00043700
//*                                                                     00043800
//**********************************************************************00043900
//*  PASO: 21     GENERA ARCHIVO CON REGISTROS QUE SI TIENEN CONTRAPAR-*00044000
//*  PHL71P09     TE.                                                  *00044100
//*                                                          ICEMAN    *00044200
//**********************************************************************00044300
//PHL71P09 EXEC PGM=SYNCSORT,COND=(4,LT)                                00044400
//*                                                                     00044500
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL71T09),DISP=SHR                   00045700
//*                                                                     00045800
//**********************************************************************00045900
//*  PASO: 22     GENERA ARCHIVO CON REGISTROS QUE NO TIENEN CONTRAPAR-*00046000
//*  PHL71P08     TE, PARA UNA SEGUNDA PASADA                ICEMAN    *00046100
//*                            ( RETIROS )                             *00046200
//**********************************************************************00046300
//PHL71P08 EXEC PGM=SYNCSORT,COND=(4,LT)                                00046400
//*                                                                     00046500
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL71T08),DISP=SHR                   00047500
//*                                                                     00047600
//**********************************************************************00047700
//*  PASO: 23     REALIZA MATCH ENTRE ARCHIVO DE INDEVAL Y ARCHIVO DE  *00047800
//*  PHL71P07     OPERACIONES.                              ZM4DHB06   *00047900
//*                              ( RETIROS )                           *00048000
//**********************************************************************00048100
//PHL71P07 EXEC PGM=IKJEFT01,COND=(4,LT)                                00048200
//*                                                                     00048300
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHL71T07),DISP=SHR                   00050000
//*                                                                     00050100
//**********************************************************************00050200
//*  PASO: 24     CONCATENA ARCHIVOS PARA ENVIAR A BANXICO.            *00050300
//*  PHL71P06                                                ICEMAN    *00050400
//**********************************************************************00050500
//PHL71P06 EXEC PGM=SYNCSORT,COND=(4,LT)                                00050600
//*                                                                     00050700
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHL71T06),DISP=SHR                   00051800
//*                                                                     00051900
//**********************************************************************00052000
//*  PASO: 25  CONCATENA ARCHIVOS PARA ENVIAR A BANXICO.               *00052100
//*  PHL71P05                                                          *00052200
//**********************************************************************00052300
//PHL71P05 EXEC PGM=ICEGENER,COND=(4,LT)                                00052400
...
//*  PHL71P04     TAS.                                                 *00053700
//*                           BX2 = I                                  *00053800
//* PASO REINICIABLE POR RESTART                            ZM4DLE11   *00053900
//**********************************************************************00054000
//PHL71P04 EXEC PGM=IKJEFT01,COND=(4,LT)                                00054100
//*                                                                     00054200
//ZMLE11A1 DD DSN=MXCP.ZM.FIX.VAL.EMP.ZMHLPE71,DISP=SHR                 00054300
//*                                                                     00054400
...
//SYSTSIN  DD  DSN=ZIVA.ZME.CONTROL(ZHL71T04),DISP=SHR                  00055100
//*                                                                     00055200
//*-------------------------------------------------------------------- 00055300
//*        AVISO EN CASO DE ERROR A LA CONSOLA                          00055400
//*-------------------------------------------------------------------- 00055500
//PHL71P03 EXEC PGM=MAILOPER,COND=(4,GE),                               00055600
//         PARM=('/ATENCION OPERADOR.AVISAR A PRODUCCION QUE',          00055700
//             ' PROCESO CBHLPZ71 TERMINO MAL.CONTESTAR SI',            00055800
//             'PARA TERMINAR')                                         00055900
//****************************************************************      00056000
//*                SE ADICIONA CONDICION                         *      00056100
//*          PARA EJECUTAR PROCESO CBHTNE59                      *      00056200
//****************************************************************      00056300
//PHL71P01 EXEC PGM=CTMCND,PARM='ADD COND CBHTNE59_IN_PR_OK WDATE',     00056400
//         COND=(4,LT)                                                  00056500
