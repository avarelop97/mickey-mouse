...
//**********************************************************************
//ZMLO5050  EXEC PGM=ADUUMAIN,                                          00022900
//          PARM='MXP1,ZMLO5050,NEW,,MSGLEVEL(1)'                       00023000
//*                                                                     00023400
//STEPLIB  DD DISP=SHR,DSN=BMC.DB2.MXP1.LOAD                            00023400
//         DD DISP=SHR,DSN=LDB2MXP1.DBP1.SDSNEXIT
//         DD DISP=SHR,DSN=LDB2MXP1.DBP1.SDSNLOAD                       00023400
//*                                                                     00023400
//SYSREC   DD DSN=MXCP.ZM.FIX.CBP.CBJCLO50.UNLOAD.CARTAUX,              00023800
//            UNIT=3390,                                                00023900
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZMLO5050),DISP=SHR                   00024800
//*
//**********************************************************************
//* PASO     : ZMLO5045                                                *
//* UTILERIA : AMUUMAIN                                                *
...
//**********************************************************************
//ZMLO5045 EXEC MBMCLOAD,COND=(4,LT),                                   0920002
//         UID=ZMLO5045.LOCAX,
//         CREATOR=PRODUSVP,
//*        CREATOR=PRUEBSVP,
//         NOMTAB=ZMDTCAX,
//         OPTION=REPLACE,
//         INPPUN=DSN=ZIVA.ZME.CONTROL(ZMLO5045),
//         INPREC=DSN=MXCP.ZM.FIX.CBP.CBJCLO50.UNLOAD.CARTAUX
//*
//************************** FIN DE PROCESO ****************************
