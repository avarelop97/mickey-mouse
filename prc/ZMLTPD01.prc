...
//*   PROCEDIM. :  ZMLTPD01                                            *
//*                                                                    *
//*   OBJETIVO  :  REALIZA TRANSFERENCIA DEL ARCHIVO  DE DEMANDAS      *
...
//SYSABOUT DD DUMMY
//SYSUDUMP DD DUMMY
//ZMG001A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMLTPD01,
...
//*               SIVA.MDD.WKF.ECBP.SZPR.DEMANDAS                      *00020000
//*               AL SERVIDOR PLANAS1F1                                *00020000
//*-------------------------------------------------------------------**
//PLT01P01 EXEC PGM=DMBATCH,PARM=(YYSLYNQ),COND=(4,LT)
//*
...
//NDMCMDS   DD SYSOUT=*
//SYSUDUMP  DD DUMMY
//SYSIN     DD DSN=ZIVA.ZME.CONTROL(ZLT01T01),DISP=SHR
//*
//****************************************************************
//*                SE ADICIONA CONDICION                         *
//*                PARA QUE SEA TOMADA POR CTL-D                 *
//****************************************************************
//PLT01P00 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXQZ1_IN_SEP_OK WDATE',
//         COND=(5,LT)
...
//*
//*--------------------------------------------------------------------*00010000
//*                 F I N   Z M L T P D 0 1                            *00020000
//*--------------------------------------------------------------------*00010000
