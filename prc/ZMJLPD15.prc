...
//*                                                                   * 00080000
//*   JCL              :  SIVAXRBP                                    * 00090010
//*                                                                   * 00100000
//*   CADENA           :  OPCION 905 -> JCL SIVAXRBP -> PRC ZMJLPD15  * 00110010
//*                                                                   * 00120000
...
//*                                                                   * 00160000
//*   REPORTE       10.-  LIQUIDACION AGTE. CTE. 48 HRS.              * 00170000
//*                       (ZM4DU506)                                  * 00180000
//*                                                                   * 00190000
//*   CORRE            :  SUBMITIDO DESDE LA OPCION 905 P/USUARIO     * 00200000
//*                       SUBOPCION ("J").                            * 00210000
//*                                                                   * 00220000
...
//*                                                                   * 00370000
//********************************************************************* 00380000
//PJD15P03 EXEC PGM=ZM3DG001,                                           00390011
...
//*  PJD15P02                                               ZM4DHW28   *00560000
//**********************************************************************00570000
//PJD15P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00580000
//*                                                                     00590000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD15T02),DISP=SHR                   00710000
//*                                                                     00720000
//**********************************************************************00730000
//*  PASO: 01  LIQUIDACION DE CENTROS REGIONALES(EFVO).                *00740000
//*                                                                    *00750000
//*  PJD15P01                                               ZM4DU506   *00760000
//**********************************************************************00770000
//PJD15P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00780000
//*                                                                     00790000
//ZMU506R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')                     00820011
//*                                                                     00832000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZJD15T01),DISP=SHR                   00900000
//*                                                                     00910000
//**********************************************************************00920012
//* OBJETIVO : ACTIVA LA CONDICION EN CONTROL-M QUE TERMINO            *00930012
//*            LIQUIDACION DE CENTROS REGIONALES(EFVO).                *00940012
//**********************************************************************00950012
//PJD15P00 EXEC  PGM=CTMCND,PARM='ADD COND  SIVABP15_IN_SEP_OK WDATE',  00960014
//         COND=(4,LT)                                                  00961014
