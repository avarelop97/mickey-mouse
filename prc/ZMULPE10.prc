...
//*                                                                    *00009000
//*   PROCEDIMIENTO    : ZMULPE10                                      *00009100
//*                                                                    *00009200
...
//*                                                                     00011900
//ZMG001A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMULPE10,               00012000
...
//*                                                                     00014700
//ZMUK70A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMULPE10,DISP=SHR       00014800
//*                                                                     00014900
...
//*--------------------------------------------------------------------*00020400
//PUL10P02 EXEC PGM=MAILOPER,COND=(4,GE,PUL10P03),                      00020500
//         PARM=('/ATENCION.AVISAR A PRODUCCION QUE PROCESO ',          00020600
//             'SIVAXNCT(ZMULPE10)TERMINO MAL.CONTESTAR SI',            00020700
...
//*
//****************************************************************
//*        TERMINA PROCESO ZMULPE10 SIVA MULTIEMPRESA            *
//****************************************************************
