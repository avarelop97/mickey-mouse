...
//*--------------------------------------------------------------------*00312004
//ZMPECI65 EXEC PGM=CN3CEXCI,COND=(16,LT),                              00329118
...
//*
//*--------------------------------------------------------------------*00312004
//*               ACTIVACION DE LA TRANSACCION ZZ00                    *00313004
//*--------------------------------------------------------------------*00312004
//ZMPECI10 EXEC PGM=CN3CEXCI,COND=(16,LT),                              00329118
//   PARM='DBDCIP1 -CN1CEXCI-ENABLE  -ZZ00    -                    '    00329119
//SYSIN    DD  DUMMY                                                    00329130
//SYSOUT   DD  SYSOUT=*                                                 00329120
//SYSPRINT DD  SYSOUT=*                                                 00329140
//SYSDUMP  DD  SYSOUT=*                                                 00329150
//*
//*--------------------------------------------------------------------*00312004
//*               ACTIVACION DE LA TRANSACCION ZZ07                    *00313004
//*--------------------------------------------------------------------*00312004
//ZMPECI05 EXEC PGM=CN3CEXCI,COND=(16,LT),                              00329118
//   PARM='DBDCIP1 -CN1CEXCI-ENABLE  -ZZ07    -                    '    00329119
//SYSIN    DD  DUMMY                                                    00329130
//SYSOUT   DD  SYSOUT=*                                                 00329120
//SYSPRINT DD  SYSOUT=*                                                 00329140
//SYSDUMP  DD  SYSOUT=*                                                 00329150
