...
//*                                                                    *
//* OPCION LINEA     = 43, TRANSACCION = ZZ48, PREFIJO = SIVAXQZ5      *
//* SUBMITE A        : CBLTPZ05                                        *
//* CORRE DESPUES DE :                                                 *
//* CORRE ANTES   DE :                                                 *
//* PERIODICIDAD     : DIARIO                                          *
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMLTPP05,
...
//****************************************************************
//PLT05P01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXQZ5_IN_OK WDATE',
//         COND=(5,LT)
...
//*--------------------------------------------------------------------*00010000
//*                 F I N   Z M L T P P 0 5                            *00020000
//*--------------------------------------------------------------------*00010000
