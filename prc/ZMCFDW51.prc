...
//* -----------  ------- -------  -------------------------------------*
//*--------------------------------------------------------------------*
//*   OBJETIVO: DESCARGA SELLOS DEL DIA ANTERIOR DE LA TABLA ZMDTCFI   *
//*--------------------------------------------------------------------*
//ZMDW5102 EXEC PGM=ADUUMAIN,                                           00385600
//         PARM='MXP1,ZMDW5102,NEW,,MSGLEVEL(1)'                        00385700
//*                                                                     00385800
...
//*                                                                     00386200
//SYSREC   DD DSN=MXCP.ZM.FIX.EBTR.ZMDTCFI.SELLOS,                      00386300
...
//*                                                                     00387200
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZMDC5102),DISP=SHR                   00387300
//*--------------------------------------------------------------------*
//*   OBJETIVO: VALIDA SI LA DESCARGA SE GENERO EN VACIO               *
//*--------------------------------------------------------------------*
//ZMDW5101 EXEC PGM=ICEMAN,COND=(04,LT)
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.EBTR.ZMDTCFI.SELLOS,DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.TMP.EBTR.ZMDTCFI.SELLOSU,
//            DISP=(NEW,PASS),
...
//*--------------------------------------------------------------------*
// IF  ZMDW5101.RC EQ 00 THEN
//ZMDW5100 EXEC PGM=CTMCND,PARM='ADD COND BCJWTR51_SUS_OK WDATE',       00395100
//         COND=(4,LT)                                                  00395200
//*                                                                     00395300
