//ZMPECN08  PROC                                                        00010000
//**********************************************************************00020000
//* SISTEMA        :  SISTEMA INTEGRAL DE VALORES (S.I.V.A.).          *00030000
//* OBJETIVO       :  GENERA ARCHIVO MENSUAL DE PROMOTORES Y           *00040000
//*                   OPERADORES DE PISO.                              *00050000
//* JCL            :  CBHECN08.                                        *00070000
//* CORRE ANTES DE :  SIVAXCN8 (OPCION EN LINEA H51-8).                *00080000
...
//* ------- ------- ---------- ----------------------------------------*00124000
//* SWF@01  XM09412 21-12-2010 SE MODIFICA LA SALIDA DEL PASO PHC08P01 *00125000
...
//**********************************************************************00150000
//PHC08P02 EXEC PGM=ZM3DG001,                                           00160000
...
//*                                                                     00300000
//**********************************************************************00620000
//*  PASO: 01  GENERA ARCHIVO MENSUAL DE PROMOTORES Y OPERADORES DE    *00630000
//*            PISO.                                                   *00640000
//*  PROGRAMA: ZM4MH011                                                *00641000
//**********************************************************************00650000
//PHC08P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00660000
//*SWF@01-INI                                                           00670000
//*ZMH00AR1 DD SYSOUT=*                                                 00671000
//ZMFH0104 DD DSN=MXCP.ZM.FIX.CNBV.PROMOPE,                             00672000
//            DISP=(NEW,CATLG,DELETE),                                  00673000
//            SPACE=(CYL,(20,10),RLSE),                                 00674000
//            DCB=(DSORG=PS,RECFM=FB,LRECL=171,BLKSIZE=0),              00675000
//            UNIT=3390                                                 00676000
//*SWF@01-FIN                                                           00677000
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHECNT08),DISP=SHR                   00740000
//*                                                                     00750000
//*********** FIN ******************************************************00760000
