...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.LVH.EMP.SUC.ZMJCPL04,
...
//****************************************************************
//PPL04P02 EXEC PGM=CTMCND,PARM='ADD COND SIVAXRDM_IN_OK WDATE',
//         COND=(4,LT)
