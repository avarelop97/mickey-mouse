...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..ZMUEPM04,
...
//ZMU007A1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..ZMUEPM04,DISP=SHR
...
//            SPACE=(CYL,(6,3),RLSE)
//ZMU007G0 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM00,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU007G1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM01,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU007G2 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM02,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU007G3 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM03,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU007G4 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM04,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU007G5 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM05,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU007G6 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM06,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU007G7 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM07,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU007G8 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM08,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU007G9 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM09,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU007GA DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM10,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*,DCB=BLKSIZE=0
...
//ZMU006A1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..ZMUEPM04,DISP=SHR
//*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM00,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP00,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM01,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP01,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM02,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP02,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM03,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP03,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM04,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP04,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM05,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP05,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM06,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP06,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM07,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP07,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM08,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP08,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM09,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP09,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.TM10,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP10,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=258,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//SYSTSPRT DD SYSOUT=*
...
//*
//ZMU002A1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..ZMUEPM04,DISP=SHR
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP00,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP00,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP01,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP02,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP03,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP04,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP05,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP06,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP07,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP08,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP09,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.IMP.GP10,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
...
//*
//******************************************************************
//******   ESTADOS DE CUENTA PERSONAS FISICAS Y MORALES X GPI ******
//******************************************************************
//SYSUT1   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP00,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP00,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP01,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP01,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP02,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP02,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP03,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP03,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP04,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP04,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP05,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP05,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP06,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP06,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP07,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP07,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP08,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP08,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP09,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP09,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.IMP.GP10,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.IMP.GP10,DISP=SHR
//******************************************************************
//******   ESTADOS DE CUENTA PERSONAS FISICAS Y MORALES IMPR. ******
//******************************************************************
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP00,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP00,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP00,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP00,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP01,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP01,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP01,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP01,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP02,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP02,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP02,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP02,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP03,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP03,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP03,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP03,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP04,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP04,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP04,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP04,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP05,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP05,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP05,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP05,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP06,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP06,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP06,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP06,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP07,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP07,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP07,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP07,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP08,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP08,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP08,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP08,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP09,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP09,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP09,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP09,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//ZMU002E1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..EDOSCTA.GP10,DISP=SHR
//*
//ZMU002C1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..CIFCTL.MIC.GP10,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=80,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(6,3),RLSE)
//ZMU002F1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP10,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//ZMU002M1 DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP10,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            DCB=(DSORG=PS,LRECL=201,RECFM=FBA,BLKSIZE=0),
//            SPACE=(CYL,(400,200),RLSE)
//*
...
//*FS-1.0.0-03 ESTE PASO ES NUEVO EN EL PROCESO                        *
//*--------------------------------------------------------------------*
//PUE04P01 EXEC PGM=ICEGENER,COND=(0,NE)
//*
//******************************************************************
//******   ESTADOS DE CUENTA PERSONAS FISICAS                 ******
//******************************************************************
//SYSUT1   DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP00,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP01,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP02,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP03,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP04,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP05,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP06,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP07,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP08,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP09,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..FISICAS.MIC.GP10,DISP=SHR
//******************************************************************
//******   ESTADOS DE CUENTA PERSONAS MORALES                 ******
//******************************************************************
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP00,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP01,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP02,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP03,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP04,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP05,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP06,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP07,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP08,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP09,DISP=SHR
//         DD DSN=MXCP.ZM.TMP.ECT.E&EMP..MORALES.MIC.GP10,DISP=SHR
//******************************************************************
//******   ESTADOS DE CUENTA PERSONAS FISICAS Y MORALES MICR. ******
//******************************************************************
//*
//SYSUT2   DD DSN=MXCP.ZM.GDGD.ECT.E&EMP..EDOSCTA.DIGIT(+1),
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(450,225),RLSE),
//            LRECL=201,RECFM=FBA,BLKSIZE=0,
//            UNIT=3390,DCB=BKUP.MODEL
...
//*
//**********************************************************************
//*        TERMINA PROCESO ZMUEPM04 SIVA MULTIEMPRESA                  *
//**********************************************************************
