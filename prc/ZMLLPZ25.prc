...
//*                                                                    *00080000
//*   PROCEDIM. :  ZMLLPZ25                                            *00090000
//*                                                                    *00100000
//*   OBJETIVO  :  CARGAR LA MATRIZ DE INVENTARIOS (OPCION: 934)       *00110000
//*                                                                    *00120000
//*   CORRE ANTES DE  :  NINGUNO                                       *00130000
//*                                                                    *00140000
//*   CORRE DESPUES DE:  SIVAXMTV                                      *00150000
//*                                                                    *00160000
//*   PERIODICIDAD    : CORRE A SOLICITUD DEL USUARIO.                 *00170000
//*                                                                    *00180000
//**********************************************************************00190000
//*-------------------------------------------------------------------- 00191000
//* MODIFICA       :  OSCAR URBANO F. (AZERTIA).                        00192000
//* FECHA          :  NOVIEMBRE 2008. CONVERSION DE SUBMITIDORES        00193000
//*-------------------------------------------------------------------* 00194000
//**********************************************************************00400000
//*                   -- ZM4DLE11 --                                    00410000
...
//*                                                                     00440000
//**********************************************************************00450000
//PLL25P03 EXEC PGM=IKJEFT01                                            00470000
//*                                                                     00480000
//ZMLE11A1 DD DSN=MXCP.ZM.TMP.MDD.EMP.SUC.ZMLLPE25,DISP=SHR             00481000
//*                                                                     00482000
...
//*                                                                     00541000
//SYSTSIN  DD  DSN=ZIVA.ZME.CONTROL(ZLL25T03),DISP=SHR                  00560000
//*                                                                     00570000
//**********************************************************************00580000
//*                  --- ZM4DLD30 ---                                   00590000
...
//**********************************************************************00620000
//PLL25P02 EXEC PGM=IKJEFT01,COND=(4,LT)                                00640000
//*                                                                     00650000
//ZMLD30P1 DD DSN=MXCP.ZM.TMP.MDD.EMP.SUC.ZMLLPE25,DISP=SHR             00651000
//*                                                                     00652000
...
//*                                                                     00790000
//**********************************************************************00800000
//PLL25P01 EXEC PGM=IKJEFT01,COND=(4,LT)                                00820000
//*                                                                     00830000
//ZMLE11A1 DD DSN=MXCP.ZM.TMP.MDD.EMP.SUC.ZMLLPE25,DISP=SHR             00831000
//*                                                                     00832000
...
//*                                                                     00891000
//SYSTSIN  DD  DSN=ZIVA.ZME.CONTROL(ZLL25T01),DISP=SHR                  00910000
//*                                                                     00920000
