...
//* PROCESO  : ZMJLPCFA.                                               *
//* OBJETIVO : SUBMITIDOR DE OPCION A DE REPROCESOS SELLOS FISCALES    *
//*                                                                    *
//* REALIZO  : ACCENTURE                                               *
//* FECHA    : MAYO 2021.                                              *
//*--------------------------------------------------------------------*
...
//*---------------------------------------------------------------------
//ZMPCF102 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..ZMJLPCFA,
...
//*           PARA EL PROCESO CBJLPCFA.                                *
//*---------------------------------------------------------------------
//ZMPCF101 EXEC PGM=CTMCND,PARM='ADD COND SIVAXCFA_IN_OK WDATE',
//         COND=(4,LT)
