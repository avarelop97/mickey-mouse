...
//* ELIMINADO POR REPROCESO AL 25-MAYO LE DIO BYPASS A OPERDI-OPERA    *
//**********************************************************************
//**********************************************************************
//* PROGRAMA: ZM3DG001
...
//SYSIN    DD DUMMY
//*
//PUF01P0A EXEC PGM=ICEGENER,COND=(4,LT)
//SYSPRINT DD SYSOUT=*
//SYSUT1   DD DSN=MXCP.ZM.FIX.ECO.INTFAZ.POZOS,DISP=SHR
//*@MEX001-I
//*SYSUT2   DD DSN=MBVP.DS.FIX.BAT1NBAS.MUV1.MODIST.F070524,
//SYSUT2   DD DSN=MXCP.ZM.FIX.BAT1NBAS.MUV1.MODISE.F070524,
//*@MEX001-I
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(40,20),RLSE),
//*@MEX001-I
