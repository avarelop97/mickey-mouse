...
//*--------------------------------------------------------------------*
//*
//PHF54P02 EXEC PGM=ZM3DG001,PARM=('&EMP','&SUC','&INT1','&INT2')
//*
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.FIX.VAL.PARAM.ZMHFPD54,
...
//*--------------------------------------------------------------------*
//*
//PHF54P01 EXEC PGM=CTMCND,PARM='ADD COND SIVAXPA4_IN_OK WDATE',
//         COND=(4,LT)
//*
