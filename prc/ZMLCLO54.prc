...
//*                      TABLA FOLCTRL A LA TABLA  ZMDTFCL.            *00001500
...
//* OBJETIVO: DESCARGA DE TABLA FOLCTRL                                *00022700
//*--------------------------------------------------------------------*00022800
//ZMLO5450  EXEC PGM=ADUUMAIN,                                          00022900
//          PARM='MXP1,ZMLO5450,NEW,,MSGLEVEL(1)'                       00023000
//*                                                                     00023400
//STEPLIB  DD DISP=SHR,DSN=BMC.DB2.MXP1.LOAD                            00023400
//         DD DISP=SHR,DSN=LDB2MXP1.DBP1.SDSNEXIT
//         DD DISP=SHR,DSN=LDB2MXP1.DBP1.SDSNLOAD                       00023400
//*                                                                     00023400
//SYSREC   DD DSN=MXCP.ZM.FIX.CBP.CBJCLO54.UNLOAD.FOLCTRL,              00023800
//            UNIT=3390,                                                00023900
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZMLO5450),DISP=SHR                   00024800
//*--------------------------------------------------------------------*00075700
//* PROGRAMA: AMUUMAIN                                                 *00022600
//* OBJETIVO: CARGA DE TABLA ZMDTFCL                                   *00022700
//*--------------------------------------------------------------------*00022800
//ZMLO5445 EXEC MBMCLOAD,COND=(4,LT),                                   0920002
//         UID=ZMLO5445.LOFCL,
//         CREATOR=PRODUSVP,
//*        CREATOR=PRUEBSVP,
//         NOMTAB=ZMDTFCL,
//         OPTION=REPLACE,
//         INPPUN=DSN=ZIVA.ZME.CONTROL(ZMLO5445),
//         INPREC=DSN=MXCP.ZM.FIX.CBP.CBJCLO54.UNLOAD.FOLCTRL
//*
