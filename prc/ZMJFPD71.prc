...
//* PROCESO     :  ZMJFPD71                                            *
//* PERIODICIDAD:  DIARIO (CIERRE DE MERCADO BANCO)                    *
//* OBJETIVO    :  REALIZA EL NETEO DE LA POSICION Y EFECIVO DE LOS    *
//*                CONTRATOS DE PP BANCO DE LAS OPERACIONES DEL DIA    *
//*--------------------------------------------------------------------*
//*
//*--------------------------------------------------------------------*
...
//**********************************************************************00385500
//PHFPD711 EXEC PGM=ADUUMAIN,                                           00385600
//         PARM='MXP1,PHFPD711,NEW,,MSGLEVEL(1)'                        00385700
//*                                                                     00385800
...
//*                                                                     00386200
//SYSREC   DD DSN=MXCP.ZM.FIX.ZMJFPD71.OPERA.DIA,                       00386300
...
//*          -- ZM4DHU14 --                                            *02323006
//**********************************************************************02324006
//PHFPD712 EXEC PGM=IKJEFT01,COND=(04,LT)                               02325006
//*                                                                     02327006
//ENTRADA  DD DSN=MXCP.ZM.FIX.ZMJFPD71.OPERA.DIA,DISP=SHR
//*
//SALIDA   DD DSN=MXCP.ZM.FIX.ZMJFPD71.OPERA.DIA.REPO,
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHFPD712),DISP=SHR                   02330008
//*                                                                     02330106
// IF  PHFPD712.RC EQ 00 THEN                                           00395000
//**********************************************************************02322306
//* OBJETIVO : GENERA REPORTE DE NETEO DE LA OPERACION DEL DíA PARA    *02322406
//*            SER ENVIADO POR CONTROL D                               *02323006
//*          -- ZM4DHU16 --                                            *02323006
//**********************************************************************02324006
//PHFPD713 EXEC PGM=IKJEFT01,COND=(4,LT)                                02325006
//*                                                                     02327006
//REPORTE  DD DSN=MXCP.ZM.FIX.ZMJFPD71.OPERA.DIA.REPO,DISP=SHR
//*
...
//SYSABOUT DD SYSOUT=*
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHFPD713),DISP=SHR
//*
//**********************************************************************02322306
//* OBJETIVO : PRENDE CONDICION PARA TRANSMITIR REPORTE DE NETEO A     *02322406
//*            SERVIDOR DE BANCA                                       *02323006
//**********************************************************************02324006
//PHFPD714 EXEC PGM=CTMCND,PARM='ADD COND BCJFCD71_OPE_OK WDATE',       00395100
//         COND=(4,LT)                                                  00395200
//*                                                                     00395300
...
//*                                                                     00396500
//**********************************************************************00385100
//* PASO       : PHFPD715.                                             *00385200
//* UTILERIA   : ADUUMAIN                                              *00385300
//* OBJETIVO   : DESCARGA DE OPERA/OPERAVA DE OPERACIONES ESPECIALES DE*00385400
//*              COMPRAS/VENTAS DEL DIA                                *
//**********************************************************************00385500
//PHFPD715 EXEC PGM=ADUUMAIN,COND=(04,LT),                              00385600
//         PARM='MXP1,PHFPD715,NEW,,MSGLEVEL(1)'                        00385700
//*                                                                     00385800
//STEPLIB  DD DSN=BMC.DB2.MXP1.LOAD,DISP=SHR                            00385900
//         DD DSN=LDB2MXP1.DBP1.SDSNEXIT,DISP=SHR                       00386000
//         DD DSN=LDB2MXP1.DBP1.SDSNLOAD,DISP=SHR                       00386100
//*                                                                     00386200
//SYSREC   DD DSN=MXCP.ZM.FIX.ZMJFPD71.OPERA.ESP.DIA,                   00386300
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,                        00386400
//            DCB=(BLKSIZE=0,DSORG=PS,RECFM=FB),                        00386500
//            SPACE=(CYL,(500,250),RLSE)                                00386600
//*                                                                     00386700
...
//*          -- ZM4DHU14 --                                            *02323006
//**********************************************************************02324006
//PHFPD716 EXEC PGM=IKJEFT01,COND=(4,LT)                                02325006
//*                                                                     02327006
//ENTRADA  DD DSN=MXCP.ZM.FIX.ZMJFPD71.OPERA.ESP.DIA,DISP=SHR
//*
//SALIDA   DD DSN=MXCP.ZM.FIX.ZMJFPD71.OPERA.ESP.DIA.REPO,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=131,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            UNIT=3390,SPACE=(CYL,(500,250),RLSE)
//*
...
//SYSABOUT DD DUMMY                                                     02329806
//SYSUDUMP DD DUMMY                                                     02329906
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHFPD716),DISP=SHR                   02330008
//*                                                                     02330106
// IF  PHFPD716.RC EQ 00 THEN                                           00395000
//**********************************************************************02322306
//* OBJETIVO : GENERA REPORTE DE NETEO DE LA OPERACION DEL DíA PARA    *02322406
//*            SER ENVIADO POR CONTROL D                               *02323006
//*          -- ZM4DHU16 --                                            *02323006
//**********************************************************************02324006
//PHFPD717 EXEC PGM=IKJEFT01,COND=(4,LT)                                02325006
//*                                                                     02327006
//REPORTE  DD DSN=MXCP.ZM.FIX.ZMJFPD71.OPERA.ESP.DIA.REPO,DISP=SHR
//*
//ZMD713R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')
//*
//SYSTSPRT DD SYSOUT=*
...
//SYSABOUT DD SYSOUT=*
//SYSUDUMP DD DUMMY
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHFPD717),DISP=SHR
//*                                                                     02330106
//**********************************************************************02322306
//* OBJETIVO : PRENDE CONDICION PARA TRANSMITIR REPORTE DE NETEO A     *02322406
//*            SERVIDOR DE BANCA                                       *02323006
//**********************************************************************02324006
//PHFPD718 EXEC PGM=CTMCND,PARM='ADD COND BCJFCD71_ESP_OK WDATE',       00395100
//         COND=(4,LT)                                                  00395200
//*                                                                     00395300
//STEPLIB  DD DISP=SHR,DSN=SYS3.IOAO.SYSZBBV.TGT.LOAD                   00395400
//DAPARM   DD DISP=SHR,DSN=SYS3.IOAI.SYSZBBV.TGT.PARM                   00395500
...
//*          -- ZM4DHU17 --                                            *02323006
//**********************************************************************02324006
//PHFPD719 EXEC PGM=IKJEFT01,COND=(4,LT)                                02325006
//*                                                                     02327006
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
