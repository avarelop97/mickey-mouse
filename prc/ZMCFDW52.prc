...
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.EBWT.CONSRFC.SUSTITU,
//            DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.FIX.EBWT.CONSRFC.SUSTITU.ORD,
...
//*
//SORTIN   DD DSN=MXCP.ZM.FIX.EBTR.ZMDTCFI.SELLOS,
//            DISP=SHR
//*
//SORTOUT  DD DSN=MXCP.ZM.FIX.EBTR.ZMDTCFI.SELLOS.ORD,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=3390,
...
//*
//ENTRADA1 DD DSN=MXCP.ZM.FIX.EBWT.CONSRFC.SUSTITU.ORD,
//            DISP=SHR
//*
//ENTRADA2 DD DSN=MXCP.ZM.FIX.EBTR.ZMDTCFI.SELLOS.ORD,
//            DISP=SHR
//*
//SALIDA   DD DSN=MXCP.ZM.FIX.EBTR.ZMCFDC52.SUSTITU.FIN,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=3390,
//            DCB=(DSORG=PS,LRECL=200,RECFM=FB,BLKSIZE=0),
//            SPACE=(CYL,(100,50),RLSE)
