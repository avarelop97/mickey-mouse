...
//*                                                                     00001800
//**********************************************************************00001900
//*PHC55P04 : EJECUTA PROGRAMA ZM4DH055: EMISORAS                      *00002000
//**********************************************************************00002100
//PHC55P04 EXEC PGM=IKJEFT01                                            00002200
//ZMH55EN1 DD DSN=MXCP.ZM.FIX.MIG061.ACOEMI,DISP=SHR                    00002300
//ZMH55EN2 DD DSN=MXCP.ZM.FIX.MIG.CNTL.MEMISOR,DISP=SHR                 00002400
//ZMH55SA1 DD DSN=MXCP.ZM.FIX.AS400.EMISORAS,                           00002500
//         DISP=(NEW,CATLG,DELETE),                                     00002600
//         DCB=(DSORG=PS,RECFM=FB,LRECL=100,BLKSIZE=0),                 00002700
//         UNIT=3390,SPACE=(CYL,(10,5),RLSE)                            00002800
//ZMH55SA2 DD DSN=MXCP.ZM.FIX.MUV.EMISORAS,                             00002900
...
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHC55T01),DISP=SHR                   00004000
//*                                                                     00004100
//**********************************************************************00004200
//*  PHC55P03  ORDENA EL ARCHIVO DE MUV                                *00004300
//*  PROGRAMA:     ICEMAN                                              *00004400
//**********************************************************************00004500
//PHC55P03 EXEC PGM=ICEMAN,COND=(4,LT)                                  00004600
//SYSOUT   DD SYSOUT=*                                                  00004700
//SORTIN   DD DSN=MXCP.ZM.FIX.MUV.EMISORAS,DISP=SHR                     00004800
//SORTOUT  DD DSN=MXCP.ZM.FIX.MUV.EMISORAS.ORDXSUC,                     00004900
//         DISP=(NEW,CATLG,DELETE),                                     00005000
//         DCB=(DSORG=PS,RECFM=FB,LRECL=120,BLKSIZE=0),                 00005100
//         UNIT=3390,SPACE=(CYL,(10,5),RLSE)                            00005200
//SYSPRINT DD SYSOUT=*                                                  00005600
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHC55T02),DISP=SHR                   00005700
//*                                                                     00005800
//**********************************************************************00005900
//*  PHC55P02  ORDENA EL ARCHIVO DE AS400                              *00006000
//*  PROGRAMA:     ICEMAN                                              *00006100
//**********************************************************************00006200
//PHC55P02 EXEC PGM=ICEMAN,COND=(4,LT)                                  00006300
//SYSOUT   DD SYSOUT=*                                                  00006400
//SORTIN   DD DSN=MXCP.ZM.FIX.AS400.EMISORAS,DISP=SHR                   00006500
//SORTOUT  DD DSN=MXCP.ZM.FIX.AS400.EMISORAS.ORDXSUC,                   00006600
//         DISP=(NEW,CATLG,DELETE),                                     00006700
//         DCB=(DSORG=PS,RECFM=FB,LRECL=100,BLKSIZE=0),                 00006800
//         UNIT=3390,SPACE=(CYL,(10,5),RLSE)                            00006900
//SYSPRINT DD SYSOUT=*                                                  00007300
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZHC55T03),DISP=SHR                   00007400
//*                                                                     00007500
//**********************************************************************00007600
//*  PHC55P01: TRANSFIERE LOS 2 ARCHIVOS ORDENADOS                     *00007700
//*            HACIA EL SERVIDOR \\SBBV04\PUBLIC\SOCINV\               *00007800
//**********************************************************************00007900
//PHC55P01 EXEC PGM=DMBATCH,PARM=(YYSLYNQ),COND=(4,LT)                  00008000
...
//SYSIN     DD DSN=ZIVA.ZME.CONTROL(ZHC55T04),DISP=SHR                  00008900
//*                                                                     00009000
