...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.GDGD.SIE.EBCM.ACUTENV2.G0063V00,
//            DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.FIX.SIE.SALDOS.SORTTEN.ABRIL,
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.FIX.SIE.SALDOS.SORTTEN.ABRIL,
//            DISP=SHR
...
//*
//**********************************************************************
//*           FINAL DE ZMUFPMRD  MES DE MARZO                          *
//**********************************************************************
