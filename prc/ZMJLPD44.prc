...
//*  PROGRAMA:   SORT                                                  *
//**********************************************************************
//PJD44P04 EXEC PGM=ICEMAN,PARM=('&INT1','&INT2')
//SYSOUT   DD SYSOUT=*
...
//ZMH00DA2 DD DSN=MXCP.ZM.TMP.MIG.M&INT2..SORTED,DISP=SHR
//ZMH00DA3 DD DSN=MXCP.ZM.TMP.MIG.A&INT1..SORTED,DISP=SHR
...
//**********************************************************************
//PJD44P01 EXEC  PGM=CTMCND,PARM='ADD COND  SIVAMG44_IN_SEP_OK WDATE',
//         COND=(4,LT)
