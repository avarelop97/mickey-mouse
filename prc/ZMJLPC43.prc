...
//* PROCESO  : ZMJLPC43.                                               *
//* OBJETIVO : SUBMITIDOR DE OPCION 3 DE REPROCESO FISCAL.             *
//*                                                                    *
...
//*---------------------------------------------------------------------
//ZMPC4302 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..ZMJLPC43,
...
//*           EN ARCHIVO SECUENCIAL.                                   *
//*---------------------------------------------------------------------
//ZMPC4301 EXEC PGM=CTMCND,PARM='ADD COND SIVAXC89_IN_OK WDATE',
//         COND=(4,LT)
