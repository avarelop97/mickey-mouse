...
//*   PROCEDIM. :  ZMLTPD09                                            *
//*                                                                    *
//*   OBJETIVO  :  REALIZA TRANSFERENCIA DEL ARCHIVO  DE PRECIOS DE    *
//*                EMISORAS AL SERVIDOR PLANAS1F1                      *
//*                                                                    *
//*                                                                    *
//*   CORRE ANTES DE  :                                                *
//*                                                                    *
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMLTPD09,
...
//*               SIVA.MDD.FIX.PRECIOS.DIN  AL SERVIDOR PLANAS1F1      *00020000
//*                                                                    *00020000
//*-------------------------------------------------------------------**
//PLT09P01 EXEC PGM=DMBATCH,PARM=(YYSLYNQ),COND=(4,LT)
//*
...
//NDMCMDS   DD SYSOUT=*
//SYSUDUMP  DD DUMMY
//SYSIN     DD DSN=ZIVA.ZME.CONTROL(ZLT09T01),DISP=SHR
//*
//****************************************************************
//*                SE ADICIONA CONDICION                         *
//*                PARA QUE SEA TOMADA POR CTL-D                 *
//****************************************************************
//PLT09P00 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXQZ9_IN_SEP_OK WDATE',
//         COND=(5,LT)
...
//*
//*--------------------------------------------------------------------*00010000
//*                 F I N   Z M L T P D 0 9                            *00020000
//*--------------------------------------------------------------------*00010000
