...
//*---------------------------------------------------------------------
//ZMPCF205 EXEC PGM=ZM3DG001,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..ZMJLPCC2,
...
//*---------------------------------------------------------------------
//ZMPCF204 EXEC PGM=ICEGENER,COND=(4,LT)
//SYSPRINT DD SYSOUT=*
//SYSUT1   DD DSN=MXCP.ZM.TMP.E&EMP..S&SUC..ZMJLPCC2,DISP=SHR
//SYSUT2   DD DSN=MXCP.ZM.FIX.ENTRADA.ZMJLPCC2,
...
//*---------------------------------------------------------------------
//ZMPCF203 EXEC PGM=CTMCND,PARM='ADD COND SIVAXCC2_IN_OK WDATE',
//         COND=(4,LT)
