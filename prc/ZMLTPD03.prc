...
//*   PROCEDIM. :  ZMLTPD03                                            *
//*                                                                    *
//*   OBJETIVO  :  REALIZA TRANSFERENCIA DEL ARCHIVO  DE VECTOR DE     *
//*                PRECIOS AL SERVIDOR  PLANAS1F1                      *
//*                                                                    *
//*                                                                    *
//*   CORRE ANTES DE  :                                                *
//*                                                                    *
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.CON.E&EMP..S&SUC..ZMLTPD03,
...
//*               SIVA.MDD.WKF.OPERMDD                                 *00020000
//*               AL SERVIDOR PLANAS1F1                                *00020000
//*-------------------------------------------------------------------**
//PLT03P01 EXEC PGM=DMBATCH,PARM=(YYSLYNQ),COND=(4,LT)
//*
...
//NDMCMDS   DD SYSOUT=*
//SYSUDUMP  DD DUMMY
//SYSIN     DD DSN=ZIVA.ZME.CONTROL(ZLT03T01),DISP=SHR
//*
//****************************************************************
//*                SE ADICIONA CONDICION                         *
//*                PARA QUE SEA TOMADA POR CTL-D                 *
//****************************************************************
//PLT03P00 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXQZ3_IN_SEP_OK WDATE',
//         COND=(5,LT)
...
//*
//*--------------------------------------------------------------------*00010000
//*                 F I N   Z M L T P D 0 3                            *00020000
//*--------------------------------------------------------------------*00010000
