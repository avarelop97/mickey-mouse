...
//*                                                                    *
//*   CORRE ANTES DE  : ZMLLPE30                                       *
//*                                                                    *
//*   CORRE DESPUES DE: ZMLLPE28                                       *
//*                                                                    *
...
//**********************************************************************00060000
//PLL29P10 EXEC PGM=ZM3DG001,REGION=0M,
//         PARM=('&EMP','&SUC','&INT1','&INT2',)
//PI601765 DD DUMMY
//ZMG001A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE29,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(LRECL=096,RECFM=FB,BLKSIZE=0,DSORG=PS),
//            SPACE=(CYL,(02,01),RLSE),UNIT=3390
//*
...
//*           ESPECIFICA.                                              *00040000
//*--------------------------------------------------------------------*00060000
//PLL29P09 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M                       0007000
//*
//ZMLN12A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE29,DISP=SHR
//*
...
//*--------------------------------------------------------------------*00060000
//PLL29P08 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M                       0007000
//*
//ZMLN22A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE29,DISP=SHR
//*
//SYSTSPRT DD SYSOUT=*,DCB=BLKSIZE=0                                     0023000
//SYSPRINT DD SYSOUT=*                                                   0024000
//SYSOUT   DD SYSOUT=*                                                   0025000
...
//*--------------------------------------------------------------------*00060000
//PLL29P07 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M                       0007000
//*
//ZMLN21A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE29,DISP=SHR
//*
//SYSTSPRT DD SYSOUT=*,DCB=BLKSIZE=0                                     0023000
//SYSPRINT DD SYSOUT=*                                                   0024000
//SYSOUT   DD SYSOUT=*                                                   0025000
...
//*--------------------------------------------------------------------*00060000
//PLL29P06 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M
//*
//ZMLD73A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE29,DISP=SHR
//*
...
//*--------------------------------------------------------------------*00060000
//PLL29P05 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M
//*
//ZMLD74A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE29,DISP=SHR
//*
...
//*--------------------------------------------------------------------*00060000
//PLL29P04 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M
//*
//ZMLD77A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE29,DISP=SHR
//*
...
//*--------------------------------------------------------------------*00060000
//PLL29P03 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M
//*
//ZMLE11A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE29,DISP=SHR
//*
//SYSTSPRT DD SYSOUT=*,DCB=BLKSIZE=0
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
...
//*           ESPECIFICA.                                              *00020000
//*--------------------------------------------------------------------*00060000
//PLL29P02 EXEC PGM=IKJEFT01,COND=(4,LT),REGION=0M                       0007000
//PI601765 DD DUMMY
//*
//ZMLN20A2 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPE29,DISP=SHR
//*
//ZMLN20A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..PONDERA,                 0023000
...
//*--------------------------------------------------------------------*
//* PROGRAMA: CTMCND                                                   *
//* OBJETIVO: ACTIVA LA CONDICION EN CTRL-D                            *
//*--------------------------------------------------------------------*
//PLL29P01 EXEC PGM=CTMCND,PARM='ADD COND SIVAXD7X_IN_SEP_OK WDATE',
//         COND=(0,NE)
...
//*
//*--------------------------------------------------------------------*
//*                    F I N   Z M L L P E 2 9                         *00020000
//*--------------------------------------------------------------------*
