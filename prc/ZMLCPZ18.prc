...
//*                                                                    *
//* NOMBRE DEL PROC  : ZMLCPZ18                                        *
//*                                                                    *
//* NOMBRE DEL JCL   : CBLCCZ18                                        *
//*                                                                    *
//* OBJETIVO         : ADICIONA CONDICION EN CONTROL M PARA EJECUTAR   *
//*                    PROCESO CBLCCD19.                               *
//*                                                                    *
//* FECHA DE CREACION: 08 DE OCTUBRE DE 2012.                          *
//*                                                                    *
//* TIPO             : HJ1 - PROCLIB.                                  *
//*                                                                    *
...
//*--------------------------------------------------------------------*
//*
//PLZ18P02 EXEC PGM=ZM3DG001,PARM=('&EMP','&SUC','&INT1','&INT2')
//*
//SYSTSPRT DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.VAL.EMP.SUC.ZMLCPZ18,
...
//*--------------------------------------------------------------------*
//*
//PLZ18P01 EXEC PGM=CTMCND,PARM='ADD COND SIVAXACG_IN_OK WDATE',
//         COND=(4,LT)
//*
