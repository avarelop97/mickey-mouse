...
//* PROCESO  : ZMJLPF02.                                               *
//* OBJETIVO : SUBMITIDOR PARA GENERAR ARCHIVO DE DATOS FISCALES       *
...
//SYSUDUMP DD DUMMY
//*
//ZMG001A1 DD DSN=MXCP.ZM.TMP.TES.E&EMP..S&SUC..ZMJLPF02,
...
//*---------------------------------------------------------------------
//ZMPF0201 EXEC PGM=CTMCND,PARM='ADD COND SIVAXCF2_IN_OK WDATE',
//         COND=(4,LT)
