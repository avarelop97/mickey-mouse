...
//*====================================================================*
//ZHTR4602 EXEC PGM=ICEMAN
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.FIX.EBTR.CFDI.ADMMEDM.CORR,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.FIX.EBTR.CONSTA.CANCEL.MASV,
...
//* OBJETIVO : GENERA ARCHIVO DE CANCELACION                           *
//*====================================================================*
//ZHTR4601 EXEC PGM=IKJEFT01,COND=(4,LT)                                01151027
//CONSTAN  DD DSN=MXCP.ZM.FIX.EBTR.CONSTA.CANCEL.MASV,DISP=SHR
//*                                                                     01153001
//SALIDA01 DD DSN=MXCP.ZM.FIX.EBTR.CANCELA.CONSTF.PREV.F&FECHA,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(50,10),RLSE),
//            DCB=(DSORG=PS,LRECL=182,RECFM=FB,BLKSIZE=0),
//            UNIT=3390
//*
//CUENTAE  DD DSN=MXCP.ZM.FIX.EBTR.CIFRAS.CONTROL.F&FECHA,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(50,10),RLSE),
...
//*                                                                     01155001
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHTR4601),DISP=SHR                   01230041
//*
//*====================================================================*
//* PASO     : ZHTR4600                                                *
...
//*====================================================================*
//ZHTR4600 EXEC PGM=IKJEFT01,COND=(4,LT)                                01151027
//*
//ENTRADA  DD DSN=MXCP.ZM.FIX.EBTR.CONSTA.CANCEL.MASV,DISP=SHR
//*                                                                     01153001
//SYSTSPRT DD SYSOUT=*                                                  01170038
//SYSPRINT DD SYSOUT=*                                                  01180038
//SYSOUT   DD SYSOUT=*                                                  01190038
...
//SYSUDUMP DD DUMMY                                                     01220000
//*                                                                     01155001
//SYSTSIN  DD DSN=ZIVA.ZME.CONTROL(ZHTR4600),DISP=SHR                   01230041
//*
//*====================================================================*
//* PASO     : ZHTR460A                                                *
//* PROGRAMA : ZM3CAN01                                                *
...
//*====================================================================*
//ZHTR460A EXEC PGM=ZM3CAN01,COND=(4,LT)                                01151027
//*
//ENTRADA  DD DSN=MXCP.ZM.FIX.EBTR.CANCELA.CONSTF.PREV.F&FECHA,
//            DISP=SHR
//*                                                                     01153001
//SALIDA   DD DSN=MXCP.ZM.FIX.EBTR.CANCELA.CONSTF.F&FECHA,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(50,10),RLSE),
