...
//*                                                                    *
//*   PROCEDIM. :  ZMHLBZ01. BCHLPZ01.                                 *
//*   PROC ANT. :  ZMHLPE01.                                           *
//*                                                                    *
//*   OBJETIVO  :  REPORTES DE CONCILIACION BANCO-INDEVAL              *
//*                                                                    *
...
//            DISP=SHR
//ZM4EH4S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.INDEVA1C,
...
//ZM3EH1A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN1,DISP=SHR
//ZM3EH1S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.TCONCIL1,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.INDEVA1C,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.INDEVA1C.MDD,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=170,BLKSIZE=0)
//SYSIN    DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.TCONCIL1,DISP=SHR           00183716
//*                                                                     00183716
//*-------------------------------------------------------------------*
//* PROGRAMA: ZM4EH003                                                *
...
//ZM4EH0A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.INDEVA1C.MDD,
//            DISP=SHR
//ZM4EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN1,
//            DISP=SHR
...
//ZM4EH0A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN1,
//            DISP=SHR
//ZM4EH0S1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONCON,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONCON,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONSIVA,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=90,BLKSIZE=0)
...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONCON,DISP=SHR
//SORTOUT  DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.SINSIV,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=90,BLKSIZE=0)
...
//ZM4EH0A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.CONSIVA,
//            DISP=SHR
//ZM4EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN1,DISP=SHR
//ZM4EH0A3 DD DSN=MXCP.ZM.FIX.VAL.EBCM.ZMHLBZ01.DIFCON.CUS,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
...
//ZM4EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN1,DISP=SHR
//* SIVA2012-I (MSG)
//ZM4EH0A3 DD DSN=MXCP.ZM.FIX.VAL.EBCM.ZMHLBZ01.DIFCON.TER,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=105,BLKSIZE=0)
//* SIVA2012-F (MSG)
...
//ZM4EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN1,DISP=SHR
//* SIVA2012-I (MSG)
//ZM4EH0A3 DD DSN=MXCP.ZM.FIX.VAL.EBCM.ZMHLBZ01.DIFCON.GAR,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=105,BLKSIZE=0)
//* SIVA2012-F (MSG)
...
//ZM4EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN1,DISP=SHR
//* SIVA2012-I (MSG)
//ZM4EH0A3 DD DSN=MXCP.ZM.FIX.VAL.EBCM.ZMHLBZ01.DIFCON.PRO,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=105,BLKSIZE=0)
//* SIVA2012-F (MSG)
...
//ZM4EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN1,DISP=SHR
//* SIVA2012-I (MSG)
//ZM4EH0A3 DD DSN=MXCP.ZM.FIX.VAL.EBCM.ZMHLBZ01.DIFCON.EXT,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=105,BLKSIZE=0)
//* SIVA2012-F (MSG)
...
//ZM4EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN1,DISP=SHR
//* SIVA2012-I (MSG)
//ZM4EH0A3 DD DSN=MXCP.ZM.FIX.VAL.EBCM.ZMHLBZ01.DIFCON.GLO,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=105,BLKSIZE=0)
//* SIVA2012-F (MSG)
...
//ZM4EH0A1 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.SINSIV,
//            DISP=SHR
//ZM4EH0A2 DD DSN=MXCP.ZM.TMP.VAL.EBCM.SCTD.OPCCN1,DISP=SHR
//ZM4EH0A3 DD DSN=MXCP.ZM.FIX.VAL.EBCM.ZMHLBZ01.DIFCON.EMI,
//            DISP=(NEW,CATLG,DELETE),UNIT=3390,
//            SPACE=(CYL,(20,10),RLSE),
//            DCB=(RECFM=FB,DSORG=PS,LRECL=105,BLKSIZE=0)
//ZM4EH0R1 DD SUBSYS=(C600,'SYSOUT=J,PREFIX=CDAMD')
