...
//*                      TABLA CTLPROC A LA TABLA  ZMDTCTL.            *00001500
//*   CORRE ANTES DE  :  EVENTUAL                                      *00001500
...
//* OBJETIVO: DESCARGA DE TABLA CTLPROC                                *00022700
//*--------------------------------------------------------------------*00022800
//ZMLO5250 EXEC PGM=ADUUMAIN,                                           00022900
//         PARM='MXP1,ZMLO5250,NEW,,MSGLEVEL(1)'                        00023000
//*                                                                     00023400
//STEPLIB  DD DISP=SHR,DSN=BMC.DB2.MXP1.LOAD                            00023400
//         DD DISP=SHR,DSN=LDB2MXP1.DBP1.SDSNEXIT
//         DD DISP=SHR,DSN=LDB2MXP1.DBP1.SDSNLOAD                       00023400
//*                                                                     00023400
//SYSREC   DD DSN=MXCP.ZM.FIX.CBP.CBJCLO52.UNLOAD.CTLPROC,              00023800
//            UNIT=3390,                                                00023900
...
//SYSIN    DD DSN=ZIVA.ZME.CONTROL(ZMLO5250),DISP=SHR                   00024800
//*--------------------------------------------------------------------*00075700
//* PROGRAMA: AMUUMAIN                                                 *00022600
//* OBJETIVO: CARGA DE TABLA ZMDTCTL                                   *00022700
//*--------------------------------------------------------------------*00022800
//ZMLO5245 EXEC MBMCLOAD,COND=(4,LT),                                   0920002
//         UID=ZMLO5245.LOCTL,
//         CREATOR=PRODUSVP,
//*        CREATOR=PRUEBSVP,
//         NOMTAB=ZMDTCTL,
//         OPTION=REPLACE,
//         INPPUN=DSN=ZIVA.ZME.CONTROL(ZMLO5245),
//         INPREC=DSN=MXCP.ZM.FIX.CBP.CBJCLO52.UNLOAD.CTLPROC
//*
