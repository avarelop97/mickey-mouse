...
//*                                                                    *00031300
//* DESPUES DE     :  CBLCCD01                                         *00031400
//*                                                                    *00031500
//* REALIZO        :  JFE   GETRONICS                                  *00031600
//* FECHA          :  OCTUBRE    2003.                                 *00031700
//*                                                                    *00031800
//**********************************************************************00032400
//*                                                                     00310000
//PLC05P02 EXEC PGM=ZM3DG001,PARM=('&EMP','&SUC','&INT1','&INT2',)
//PI601765  DD DUMMY
//ZMG001A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLCPD05,
...
//**********************************************************************02560000
//*                         -- CTMCND --                               *02570000
//* OBJETIVO: ACTIVA CONDICION EN CONTROL-M "CBLCCD02_IN" PARA QUE SE  *02580000
...
//         PARM='ADD COND CBLCCD02_&EMP_SIVA_OK WDATE',COND=(4,LT)
