...
//** PROCESO        :  ZMSATP16
//**
//** OBJETIVO       :  FORMATEA KARDEX OTROS MES FEBRERO SAT CB.
//**
...
//ZMG001A1 DD DSN=MXCP.ZM.FIX.EBCM.ZMSATP16,
...
//ARCHIVO   DD DSN=MXCP.ZM.FIX.MIS.CBSMD.FEB,
...
//****************************************************************
//ZMSATP01 EXEC  PGM=CTMCND,PARM='ADD COND SIVAXS16_IN_OK WDATE',
//         COND=(5,LT)
