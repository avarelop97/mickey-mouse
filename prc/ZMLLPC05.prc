//ZMLLPC05 PROC                                                         00001000
//*                                                                     00002000
//**********************************************************************00029600
//*                                                                    *00029700
//* SISTEMA        :  SISTEMA INTEGRAL DE VALORES (S.I.V.A.)           *00029800
//*                                                                    *00029900
//* PROCESO        :  SIVAX743                                         *00030000
//*                   CONCILIACION DE MOVIMIENTOS DE REPORTOS          *00030100
//*                   OPCION 743.                                      *00030100
//*                                                                    *00030200
//* CORRE                                                              *00030900
...
//**********************************************************************00032400
//*                                                                     00310000
//PLC05P02 EXEC PGM=ZM3DG001,PARM=('&EMP','&SUC','&INT1','&INT2',)
//PI601765  DD DUMMY
//ZMG001A1 DD DSN=MXCP.ZM.TMP.MDD.E&EMP..S&SUC..ZMLLPC05,
...
//**********************************************************************02560000
//*                         -- CTMCND --                               *02570000
//* OBJETIVO: ACTIVA CONDICION EN CONTROL-M "BCLLPC06_IN" PARA QUE SE  *02580000
//*           EJECUTE ARCHIVO CONCILIACION DE REPORTOS OPC 743         *02590000
//*                                                                    *02600000
//* PASO REINICIABLE POR RESTART                                       *02610000
//**********************************************************************02620000
//PLC05P01 EXEC  PGM=CTMCND,
//         PARM='ADD COND BCLLPC06_&EMP_SIVA_OK WDATE',COND=(4,LT)
